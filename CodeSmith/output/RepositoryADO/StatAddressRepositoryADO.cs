...
namespace JX.ADO
{
	...
	public partial class StatAddressRepositoryADO : IStatAddressRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatAddress entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatAddress entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatAddress entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatAddress entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatAddress entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatAddress entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatAddress entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatAddress entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatAddress SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatAddress GetEntity(System.String tAddress)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatAddress> GetEntityAsync(System.String tAddress)
		{
			string strCondition = string.Empty;
			strCondition += " and TAddress = @TAddress";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatAddress GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatAddress obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatAddress> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatAddress obj = null;
			string strSQL = "select top 1 * from StatAddress where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatAddress> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatAddress> list = new List<StatAddress>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatAddress>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatAddress> list = new List<StatAddress>();
			string strSQL = "select * from StatAddress where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatAddress> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatAddress> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatAddress> list = new List<StatAddress>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddress> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddress> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatAddress> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatAddress> list = new List<StatAddress>();
		...
		private static void GetParameters(StatAddress entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatAddress GetEntityFromrdr(NullableDataReader rdr)
		{
			StatAddress info = new StatAddress();
