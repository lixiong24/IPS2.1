...
namespace JX.ADO
{
	...
	public partial class PaymentTypeRepositoryADO : IPaymentTypeRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(PaymentType entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentType entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentType entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PaymentType entity)
		{
			if(entity.TypeID <= 0) entity.TypeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PaymentType entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PaymentType entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PaymentType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PaymentType SET "+
		...
		/// </summary>
		/// <returns></returns>
		public PaymentType GetEntity(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentType> GetEntityAsync(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentType GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PaymentType> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PaymentType obj = null;
			string strSQL = "select top 1 * from PaymentType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentType> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PaymentType> list = new List<PaymentType>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentType>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PaymentType> list = new List<PaymentType>();
			string strSQL = "select * from PaymentType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<PaymentType> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PaymentType> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PaymentType> list = new List<PaymentType>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PaymentType> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PaymentType> list = new List<PaymentType>();
		...
		private static void GetParameters(PaymentType entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static PaymentType GetEntityFromrdr(NullableDataReader rdr)
		{
			PaymentType info = new PaymentType();
