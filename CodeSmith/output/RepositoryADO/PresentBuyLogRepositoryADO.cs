...
namespace JX.ADO
{
	...
	public partial class PresentBuyLogRepositoryADO : IPresentBuyLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(PresentBuyLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentBuyLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentBuyLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentBuyLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentBuyLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentBuyLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentBuyLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentBuyLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PresentBuyLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public PresentBuyLog GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentBuyLog> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentBuyLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentBuyLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentBuyLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentBuyLog obj = null;
			string strSQL = "select top 1 * from PresentBuyLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentBuyLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PresentBuyLog> list = new List<PresentBuyLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentBuyLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PresentBuyLog> list = new List<PresentBuyLog>();
			string strSQL = "select * from PresentBuyLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<PresentBuyLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PresentBuyLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PresentBuyLog> list = new List<PresentBuyLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentBuyLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentBuyLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PresentBuyLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PresentBuyLog> list = new List<PresentBuyLog>();
		...
		private static void GetParameters(PresentBuyLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static PresentBuyLog GetEntityFromrdr(NullableDataReader rdr)
		{
			PresentBuyLog info = new PresentBuyLog();
