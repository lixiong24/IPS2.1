...
namespace JX.ADO
{
	...
	public partial class ClientRepositoryADO : IClientRepositoryADO
	{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Client entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Client entity)
		{
			if(entity.ClientID <= 0) entity.ClientID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Client entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Client entity, bool IsSave)
		{
		...
		/// </summary>
		/// <returns></returns>
		public Client GetEntity(System.Int32 clientID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Client> GetEntityAsync(System.Int32 clientID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientID = @ClientID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Client GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Client obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Client> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Client obj = null;
			string strSQL = "select top 1 * from Client where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Client> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Client>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Client> list = new List<Client>();
			string strSQL = "select * from Client where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Client> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Client> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Client> list = new List<Client>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Client> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Client> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Client> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Client> list = new List<Client>();
		...
		private static void GetParameters(Client entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Client GetEntityFromrdr(NullableDataReader rdr)
		{
