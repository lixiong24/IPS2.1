...
namespace JX.ADO
{
	...
	public partial class CorrelativeInfoRepositoryADO : ICorrelativeInfoRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CorrelativeInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CorrelativeInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CorrelativeInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CorrelativeInfo entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CorrelativeInfo entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CorrelativeInfo entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CorrelativeInfo entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CorrelativeInfo entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CorrelativeInfo SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CorrelativeInfo GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CorrelativeInfo> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CorrelativeInfo GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CorrelativeInfo obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CorrelativeInfo> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CorrelativeInfo obj = null;
			string strSQL = "select top 1 * from CorrelativeInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CorrelativeInfo> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CorrelativeInfo> list = new List<CorrelativeInfo>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CorrelativeInfo>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CorrelativeInfo> list = new List<CorrelativeInfo>();
			string strSQL = "select * from CorrelativeInfo where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CorrelativeInfo> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CorrelativeInfo> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CorrelativeInfo> list = new List<CorrelativeInfo>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CorrelativeInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CorrelativeInfo> list = new List<CorrelativeInfo>();
		...
		private static void GetParameters(CorrelativeInfo entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CorrelativeInfo GetEntityFromrdr(NullableDataReader rdr)
		{
			CorrelativeInfo info = new CorrelativeInfo();
