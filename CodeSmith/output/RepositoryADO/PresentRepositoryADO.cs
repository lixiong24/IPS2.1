...
namespace JX.ADO
{
	...
	public partial class PresentRepositoryADO : IPresentRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Present entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Present entity)
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Present entity)
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Present entity)
		{
			if(entity.PresentID <= 0) entity.PresentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Present entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Present entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Present entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Present entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Present SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Present GetEntity(System.Int32 presentID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Present> GetEntityAsync(System.Int32 presentID)
		{
			string strCondition = string.Empty;
			strCondition += " and PresentID = @PresentID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Present GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Present obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Present> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Present obj = null;
			string strSQL = "select top 1 * from Present where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Present> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Present> list = new List<Present>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Present>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Present> list = new List<Present>();
			string strSQL = "select * from Present where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Present> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Present> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Present> list = new List<Present>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Present> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Present> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Present> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Present> list = new List<Present>();
		...
		private static void GetParameters(Present entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Present GetEntityFromrdr(NullableDataReader rdr)
		{
			Present info = new Present();
