...
namespace JX.ADO
{
	...
	public partial class PackageRepositoryADO : IPackageRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Package entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Package entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Package entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Package entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Package entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Package entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Package entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Package entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Package SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Package GetEntity(System.Int32 packageID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Package> GetEntityAsync(System.Int32 packageID)
		{
			string strCondition = string.Empty;
			strCondition += " and PackageID = @PackageID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Package GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Package obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Package> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Package obj = null;
			string strSQL = "select top 1 * from Package where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Package> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Package>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Package> list = new List<Package>();
			string strSQL = "select * from Package where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Package> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Package> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Package> list = new List<Package>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Package> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Package> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Package> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Package> list = new List<Package>();
		...
		private static void GetParameters(Package entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Package GetEntityFromrdr(NullableDataReader rdr)
		{
