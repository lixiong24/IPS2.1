...
namespace JX.ADO
{
	...
	public partial class CollectionExclosionRepositoryADO : ICollectionExclosionRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionExclosion entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionExclosion entity)
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionExclosion entity)
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionExclosion entity)
		{
			if(entity.ExclosionID <= 0) entity.ExclosionID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionExclosion entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionExclosion entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionExclosion entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionExclosion entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionExclosion SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CollectionExclosion GetEntity(System.Int32 exclosionID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionExclosion> GetEntityAsync(System.Int32 exclosionID)
		{
			string strCondition = string.Empty;
			strCondition += " and ExclosionID = @ExclosionID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionExclosion GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionExclosion obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionExclosion> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionExclosion obj = null;
			string strSQL = "select top 1 * from CollectionExclosion where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionExclosion> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionExclosion> list = new List<CollectionExclosion>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionExclosion>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionExclosion> list = new List<CollectionExclosion>();
			string strSQL = "select * from CollectionExclosion where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CollectionExclosion> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionExclosion> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionExclosion> list = new List<CollectionExclosion>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosion> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosion> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionExclosion> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionExclosion> list = new List<CollectionExclosion>();
		...
		private static void GetParameters(CollectionExclosion entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CollectionExclosion GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionExclosion info = new CollectionExclosion();
