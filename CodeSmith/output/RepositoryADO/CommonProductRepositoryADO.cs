...
namespace JX.ADO
{
	...
	public partial class CommonProductRepositoryADO : ICommonProductRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CommonProduct entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommonProduct entity)
		{
			if(entity.ProductID <= 0) entity.ProductID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CommonProduct entity)
		{
			if(entity.ProductID <= 0) entity.ProductID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommonProduct entity)
		{
			if(entity.ProductID <= 0) entity.ProductID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommonProduct entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommonProduct entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CommonProduct entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommonProduct entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CommonProduct SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CommonProduct GetEntity(System.Int32 productID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommonProduct> GetEntityAsync(System.Int32 productID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProductID = @ProductID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommonProduct GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CommonProduct obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommonProduct> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CommonProduct obj = null;
			string strSQL = "select top 1 * from CommonProduct where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommonProduct> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CommonProduct> list = new List<CommonProduct>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommonProduct>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CommonProduct> list = new List<CommonProduct>();
			string strSQL = "select * from CommonProduct where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CommonProduct> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CommonProduct> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CommonProduct> list = new List<CommonProduct>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CommonProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CommonProduct> list = new List<CommonProduct>();
		...
		private static void GetParameters(CommonProduct entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CommonProduct GetEntityFromrdr(NullableDataReader rdr)
		{
			CommonProduct info = new CommonProduct();
