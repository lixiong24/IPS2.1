...
namespace JX.ADO
{
	...
	public partial class DictionaryRepositoryADO : IDictionaryRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Dictionary entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Dictionary entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Dictionary entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Dictionary entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Dictionary entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Dictionary entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Dictionary entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Dictionary entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Dictionary SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Dictionary GetEntity(System.Int32 fieldID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Dictionary> GetEntityAsync(System.Int32 fieldID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldID = @FieldID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Dictionary GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Dictionary obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Dictionary> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Dictionary obj = null;
			string strSQL = "select top 1 * from Dictionary where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Dictionary> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Dictionary> list = new List<Dictionary>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Dictionary>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Dictionary> list = new List<Dictionary>();
			string strSQL = "select * from Dictionary where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Dictionary> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Dictionary> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Dictionary> list = new List<Dictionary>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Dictionary> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Dictionary> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Dictionary> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Dictionary> list = new List<Dictionary>();
		...
		private static void GetParameters(Dictionary entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Dictionary GetEntityFromrdr(NullableDataReader rdr)
		{
