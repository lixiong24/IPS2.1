...
namespace JX.ADO
{
	...
	public partial class RegionRepositoryADO : IRegionRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Region entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Region entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Region entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Region entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Region entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Region entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Region entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Region entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Region SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Region GetEntity(System.Int32 regionID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Region> GetEntityAsync(System.Int32 regionID)
		{
			string strCondition = string.Empty;
			strCondition += " and RegionID = @RegionID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Region GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Region obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Region> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Region obj = null;
			string strSQL = "select top 1 * from Region where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Region> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Region>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Region> list = new List<Region>();
			string strSQL = "select * from Region where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Region> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Region> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Region> list = new List<Region>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Region> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Region> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Region> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Region> list = new List<Region>();
		...
		private static void GetParameters(Region entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Region GetEntityFromrdr(NullableDataReader rdr)
		{
