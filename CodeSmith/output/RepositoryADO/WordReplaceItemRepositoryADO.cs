...
namespace JX.ADO
{
	...
	public partial class WordReplaceItemRepositoryADO : IWordReplaceItemRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(WordReplaceItem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WordReplaceItem entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WordReplaceItem entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WordReplaceItem entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WordReplaceItem entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WordReplaceItem entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WordReplaceItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WordReplaceItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WordReplaceItem SET "+
		...
		/// </summary>
		/// <returns></returns>
		public WordReplaceItem GetEntity(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WordReplaceItem> GetEntityAsync(System.Int32 itemID)
		{
			string strCondition = string.Empty;
			strCondition += " and ItemID = @ItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WordReplaceItem GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WordReplaceItem obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WordReplaceItem> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WordReplaceItem obj = null;
			string strSQL = "select top 1 * from WordReplaceItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WordReplaceItem> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WordReplaceItem> list = new List<WordReplaceItem>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WordReplaceItem>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WordReplaceItem> list = new List<WordReplaceItem>();
			string strSQL = "select * from WordReplaceItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<WordReplaceItem> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WordReplaceItem> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WordReplaceItem> list = new List<WordReplaceItem>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WordReplaceItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WordReplaceItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WordReplaceItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WordReplaceItem> list = new List<WordReplaceItem>();
		...
		private static void GetParameters(WordReplaceItem entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static WordReplaceItem GetEntityFromrdr(NullableDataReader rdr)
		{
			WordReplaceItem info = new WordReplaceItem();
