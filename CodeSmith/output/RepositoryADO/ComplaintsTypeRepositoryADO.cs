...
namespace JX.ADO
{
	...
	public partial class ComplaintsTypeRepositoryADO : IComplaintsTypeRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsType entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsType entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsType entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsType entity)
		{
			if(entity.CID <= 0) entity.CID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsType entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsType entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsType SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsType GetEntity(System.Int32 cid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsType> GetEntityAsync(System.Int32 cid)
		{
			string strCondition = string.Empty;
			strCondition += " and CID = @CID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsType GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsType obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsType> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsType obj = null;
			string strSQL = "select top 1 * from ComplaintsType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsType> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsType> list = new List<ComplaintsType>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsType>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsType> list = new List<ComplaintsType>();
			string strSQL = "select * from ComplaintsType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ComplaintsType> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplaintsType> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplaintsType> list = new List<ComplaintsType>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplaintsType> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplaintsType> list = new List<ComplaintsType>();
		...
		private static void GetParameters(ComplaintsType entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ComplaintsType GetEntityFromrdr(NullableDataReader rdr)
		{
			ComplaintsType info = new ComplaintsType();
