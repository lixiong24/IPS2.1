...
namespace JX.ADO
{
	...
	public partial class InvoiceLogRepositoryADO : IInvoiceLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(InvoiceLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InvoiceLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(InvoiceLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(InvoiceLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(InvoiceLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(InvoiceLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(InvoiceLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(InvoiceLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update InvoiceLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public InvoiceLog GetEntity(System.Int32 invoiceID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InvoiceLog> GetEntityAsync(System.Int32 invoiceID)
		{
			string strCondition = string.Empty;
			strCondition += " and InvoiceID = @InvoiceID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InvoiceLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			InvoiceLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<InvoiceLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			InvoiceLog obj = null;
			string strSQL = "select top 1 * from InvoiceLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InvoiceLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<InvoiceLog> list = new List<InvoiceLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InvoiceLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<InvoiceLog> list = new List<InvoiceLog>();
			string strSQL = "select * from InvoiceLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<InvoiceLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<InvoiceLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<InvoiceLog> list = new List<InvoiceLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<InvoiceLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<InvoiceLog> list = new List<InvoiceLog>();
		...
		private static void GetParameters(InvoiceLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static InvoiceLog GetEntityFromrdr(NullableDataReader rdr)
		{
			InvoiceLog info = new InvoiceLog();
