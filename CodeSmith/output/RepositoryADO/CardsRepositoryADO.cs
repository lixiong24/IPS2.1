...
namespace JX.ADO
{
	...
	public partial class CardsRepositoryADO : ICardsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Cards entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Cards entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Cards entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Cards entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Cards entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Cards entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Cards entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Cards entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Cards SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Cards GetEntity(System.Int32 cardID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Cards> GetEntityAsync(System.Int32 cardID)
		{
			string strCondition = string.Empty;
			strCondition += " and CardID = @CardID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Cards GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Cards obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Cards> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Cards obj = null;
			string strSQL = "select top 1 * from Cards where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Cards> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Cards> list = new List<Cards>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Cards>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Cards> list = new List<Cards>();
			string strSQL = "select * from Cards where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Cards> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Cards> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Cards> list = new List<Cards>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Cards> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Cards> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Cards> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Cards> list = new List<Cards>();
		...
		private static void GetParameters(Cards entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Cards GetEntityFromrdr(NullableDataReader rdr)
		{
