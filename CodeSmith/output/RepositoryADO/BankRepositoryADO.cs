...
namespace JX.ADO
{
	...
	public partial class BankRepositoryADO : IBankRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Bank entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Bank entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Bank entity)
		{
			if(entity.BankID <= 0) entity.BankID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Bank entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Bank entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Bank entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Bank entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Bank SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Bank GetEntity(System.Int32 bankID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Bank> GetEntityAsync(System.Int32 bankID)
		{
			string strCondition = string.Empty;
			strCondition += " and BankID = @BankID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Bank GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Bank obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Bank> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Bank obj = null;
			string strSQL = "select top 1 * from Bank where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Bank> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Bank>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Bank> list = new List<Bank>();
			string strSQL = "select * from Bank where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Bank> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Bank> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Bank> list = new List<Bank>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Bank> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Bank> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Bank> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Bank> list = new List<Bank>();
		...
		private static void GetParameters(Bank entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Bank GetEntityFromrdr(NullableDataReader rdr)
		{
			Bank info = new Bank();
