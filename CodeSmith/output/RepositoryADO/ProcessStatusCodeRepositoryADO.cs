...
namespace JX.ADO
{
	...
	public partial class ProcessStatusCodeRepositoryADO : IProcessStatusCodeRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ProcessStatusCode entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProcessStatusCode entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ProcessStatusCode entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProcessStatusCode entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProcessStatusCode entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProcessStatusCode entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ProcessStatusCode entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProcessStatusCode entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ProcessStatusCode SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ProcessStatusCode GetEntity(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProcessStatusCode> GetEntityAsync(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProcessStatusCode GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ProcessStatusCode obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProcessStatusCode> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ProcessStatusCode obj = null;
			string strSQL = "select top 1 * from ProcessStatusCode where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProcessStatusCode> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ProcessStatusCode> list = new List<ProcessStatusCode>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProcessStatusCode>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ProcessStatusCode> list = new List<ProcessStatusCode>();
			string strSQL = "select * from ProcessStatusCode where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ProcessStatusCode> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ProcessStatusCode> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ProcessStatusCode> list = new List<ProcessStatusCode>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCode> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCode> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ProcessStatusCode> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ProcessStatusCode> list = new List<ProcessStatusCode>();
		...
		private static void GetParameters(ProcessStatusCode entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ProcessStatusCode GetEntityFromrdr(NullableDataReader rdr)
		{
			ProcessStatusCode info = new ProcessStatusCode();
