...
namespace JX.ADO
{
	...
	public partial class HirePurchaseRepositoryADO : IHirePurchaseRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(HirePurchase entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(HirePurchase entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(HirePurchase entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(HirePurchase entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(HirePurchase entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(HirePurchase entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(HirePurchase entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(HirePurchase entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update HirePurchase SET "+
		...
		/// </summary>
		/// <returns></returns>
		public HirePurchase GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<HirePurchase> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual HirePurchase GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			HirePurchase obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<HirePurchase> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			HirePurchase obj = null;
			string strSQL = "select top 1 * from HirePurchase where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<HirePurchase> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<HirePurchase> list = new List<HirePurchase>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<HirePurchase>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<HirePurchase> list = new List<HirePurchase>();
			string strSQL = "select * from HirePurchase where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<HirePurchase> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<HirePurchase> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<HirePurchase> list = new List<HirePurchase>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<HirePurchase> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<HirePurchase> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<HirePurchase> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<HirePurchase> list = new List<HirePurchase>();
		...
		private static void GetParameters(HirePurchase entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static HirePurchase GetEntityFromrdr(NullableDataReader rdr)
		{
			HirePurchase info = new HirePurchase();
