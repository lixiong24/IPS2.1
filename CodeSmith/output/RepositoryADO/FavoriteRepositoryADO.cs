...
namespace JX.ADO
{
	...
	public partial class FavoriteRepositoryADO : IFavoriteRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Favorite entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Favorite entity)
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Favorite entity)
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Favorite entity)
		{
			if(entity.FavoriteID <= 0) entity.FavoriteID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Favorite entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Favorite entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Favorite entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Favorite entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Favorite SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Favorite GetEntity(System.Int32 favoriteID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Favorite> GetEntityAsync(System.Int32 favoriteID)
		{
			string strCondition = string.Empty;
			strCondition += " and FavoriteID = @FavoriteID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Favorite GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Favorite obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Favorite> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Favorite obj = null;
			string strSQL = "select top 1 * from Favorite where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Favorite> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Favorite> list = new List<Favorite>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Favorite>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Favorite> list = new List<Favorite>();
			string strSQL = "select * from Favorite where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Favorite> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Favorite> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Favorite> list = new List<Favorite>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Favorite> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Favorite> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Favorite> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Favorite> list = new List<Favorite>();
		...
		private static void GetParameters(Favorite entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Favorite GetEntityFromrdr(NullableDataReader rdr)
		{
			Favorite info = new Favorite();
