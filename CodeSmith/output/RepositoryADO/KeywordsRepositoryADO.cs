...
namespace JX.ADO
{
	...
	public partial class KeywordsRepositoryADO : IKeywordsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Keywords entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Keywords entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Keywords entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Keywords entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Keywords entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Keywords entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Keywords entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Keywords entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Keywords SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Keywords GetEntity(System.Int32 keywordID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Keywords> GetEntityAsync(System.Int32 keywordID)
		{
			string strCondition = string.Empty;
			strCondition += " and KeywordID = @KeywordID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Keywords GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Keywords obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Keywords> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Keywords obj = null;
			string strSQL = "select top 1 * from Keywords where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Keywords> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Keywords> list = new List<Keywords>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Keywords>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Keywords> list = new List<Keywords>();
			string strSQL = "select * from Keywords where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Keywords> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Keywords> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Keywords> list = new List<Keywords>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Keywords> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Keywords> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Keywords> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Keywords> list = new List<Keywords>();
		...
		private static void GetParameters(Keywords entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Keywords GetEntityFromrdr(NullableDataReader rdr)
		{
