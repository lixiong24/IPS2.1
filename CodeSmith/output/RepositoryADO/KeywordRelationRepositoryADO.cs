...
namespace JX.ADO
{
	...
	public partial class KeywordRelationRepositoryADO : IKeywordRelationRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(KeywordRelation entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(KeywordRelation entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(KeywordRelation entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(KeywordRelation entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(KeywordRelation entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(KeywordRelation entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(KeywordRelation entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(KeywordRelation entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update KeywordRelation SET "+
		...
		/// </summary>
		/// <returns></returns>
		public KeywordRelation GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<KeywordRelation> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual KeywordRelation GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordRelation obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<KeywordRelation> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			KeywordRelation obj = null;
			string strSQL = "select top 1 * from KeywordRelation where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<KeywordRelation> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<KeywordRelation> list = new List<KeywordRelation>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<KeywordRelation>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<KeywordRelation> list = new List<KeywordRelation>();
			string strSQL = "select * from KeywordRelation where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<KeywordRelation> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<KeywordRelation> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<KeywordRelation> list = new List<KeywordRelation>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelation> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelation> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<KeywordRelation> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<KeywordRelation> list = new List<KeywordRelation>();
		...
		private static void GetParameters(KeywordRelation entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static KeywordRelation GetEntityFromrdr(NullableDataReader rdr)
		{
			KeywordRelation info = new KeywordRelation();
