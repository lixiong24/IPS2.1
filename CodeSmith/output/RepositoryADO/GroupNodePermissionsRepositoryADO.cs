...
namespace JX.ADO
{
	...
	public partial class GroupNodePermissionsRepositoryADO : IGroupNodePermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(GroupNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupNodePermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupNodePermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupNodePermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupNodePermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupNodePermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupNodePermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public GroupNodePermissions GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupNodePermissions> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupNodePermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupNodePermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupNodePermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupNodePermissions obj = null;
			string strSQL = "select top 1 * from GroupNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupNodePermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupNodePermissions> list = new List<GroupNodePermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupNodePermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupNodePermissions> list = new List<GroupNodePermissions>();
			string strSQL = "select * from GroupNodePermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<GroupNodePermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupNodePermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupNodePermissions> list = new List<GroupNodePermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupNodePermissions> list = new List<GroupNodePermissions>();
		...
		private static void GetParameters(GroupNodePermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupNodePermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupNodePermissions info = new GroupNodePermissions();
