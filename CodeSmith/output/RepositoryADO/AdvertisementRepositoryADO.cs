...
namespace JX.ADO
{
	...
	public partial class AdvertisementRepositoryADO : IAdvertisementRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Advertisement entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Advertisement entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Advertisement entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Advertisement entity)
		{
			if(entity.ADID <= 0) entity.ADID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Advertisement entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Advertisement entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Advertisement entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Advertisement entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Advertisement SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Advertisement GetEntity(System.Int32 adid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Advertisement> GetEntityAsync(System.Int32 adid)
		{
			string strCondition = string.Empty;
			strCondition += " and ADID = @ADID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Advertisement GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Advertisement> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Advertisement obj = null;
			string strSQL = "select top 1 * from Advertisement where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Advertisement> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Advertisement>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Advertisement> list = new List<Advertisement>();
			string strSQL = "select * from Advertisement where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Advertisement> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Advertisement> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Advertisement> list = new List<Advertisement>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Advertisement> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Advertisement> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Advertisement> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Advertisement> list = new List<Advertisement>();
		...
		private static void GetParameters(Advertisement entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Advertisement GetEntityFromrdr(NullableDataReader rdr)
		{
