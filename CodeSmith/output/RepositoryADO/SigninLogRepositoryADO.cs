...
namespace JX.ADO
{
	...
	public partial class SigninLogRepositoryADO : ISigninLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SigninLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SigninLog GetEntity(System.Int32 generalID, System.String userName)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninLog> GetEntityAsync(System.Int32 generalID, System.String userName)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
			strCondition += " and UserName = @UserName";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninLog obj = null;
			string strSQL = "select top 1 * from SigninLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SigninLog> list = new List<SigninLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SigninLog> list = new List<SigninLog>();
			string strSQL = "select * from SigninLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SigninLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SigninLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SigninLog> list = new List<SigninLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SigninLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SigninLog> list = new List<SigninLog>();
		...
		private static void GetParameters(SigninLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SigninLog GetEntityFromrdr(NullableDataReader rdr)
		{
			SigninLog info = new SigninLog();
