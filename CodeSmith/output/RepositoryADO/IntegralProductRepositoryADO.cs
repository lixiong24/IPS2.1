...
namespace JX.ADO
{
	...
	public partial class IntegralProductRepositoryADO : IIntegralProductRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(IntegralProduct entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IntegralProduct entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(IntegralProduct entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IntegralProduct entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IntegralProduct entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IntegralProduct entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(IntegralProduct entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IntegralProduct entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IntegralProduct SET "+
		...
		/// </summary>
		/// <returns></returns>
		public IntegralProduct GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IntegralProduct> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IntegralProduct GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProduct obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IntegralProduct> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProduct obj = null;
			string strSQL = "select top 1 * from IntegralProduct where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IntegralProduct> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<IntegralProduct> list = new List<IntegralProduct>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IntegralProduct>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<IntegralProduct> list = new List<IntegralProduct>();
			string strSQL = "select * from IntegralProduct where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<IntegralProduct> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<IntegralProduct> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<IntegralProduct> list = new List<IntegralProduct>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<IntegralProduct> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<IntegralProduct> list = new List<IntegralProduct>();
		...
		private static void GetParameters(IntegralProduct entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static IntegralProduct GetEntityFromrdr(NullableDataReader rdr)
		{
			IntegralProduct info = new IntegralProduct();
