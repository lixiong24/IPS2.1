...
namespace JX.ADO
{
	...
	public partial class SigninContentRepositoryADO : ISigninContentRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SigninContent entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninContent entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninContent entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninContent entity)
		{
			if(entity.GeneralID <= 0) entity.GeneralID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninContent entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninContent entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninContent entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninContent entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SigninContent SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SigninContent GetEntity(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninContent> GetEntityAsync(System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninContent GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninContent obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninContent> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SigninContent obj = null;
			string strSQL = "select top 1 * from SigninContent where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninContent> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SigninContent> list = new List<SigninContent>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninContent>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SigninContent> list = new List<SigninContent>();
			string strSQL = "select * from SigninContent where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SigninContent> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SigninContent> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SigninContent> list = new List<SigninContent>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContent> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContent> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SigninContent> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SigninContent> list = new List<SigninContent>();
		...
		private static void GetParameters(SigninContent entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SigninContent GetEntityFromrdr(NullableDataReader rdr)
		{
			SigninContent info = new SigninContent();
