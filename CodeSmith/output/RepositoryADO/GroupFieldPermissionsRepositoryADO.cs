...
namespace JX.ADO
{
	...
	public partial class GroupFieldPermissionsRepositoryADO : IGroupFieldPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(GroupFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupFieldPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupFieldPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupFieldPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupFieldPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupFieldPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupFieldPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public GroupFieldPermissions GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupFieldPermissions> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupFieldPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupFieldPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupFieldPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupFieldPermissions obj = null;
			string strSQL = "select top 1 * from GroupFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupFieldPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupFieldPermissions> list = new List<GroupFieldPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupFieldPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupFieldPermissions> list = new List<GroupFieldPermissions>();
			string strSQL = "select * from GroupFieldPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<GroupFieldPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupFieldPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupFieldPermissions> list = new List<GroupFieldPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupFieldPermissions> list = new List<GroupFieldPermissions>();
		...
		private static void GetParameters(GroupFieldPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupFieldPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupFieldPermissions info = new GroupFieldPermissions();
