...
namespace JX.ADO
{
	...
	public partial class FileRelationInfoRepositoryADO : IFileRelationInfoRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(FileRelationInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FileRelationInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(FileRelationInfo entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FileRelationInfo entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FileRelationInfo entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FileRelationInfo entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(FileRelationInfo entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FileRelationInfo entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update FileRelationInfo SET "+
		...
		/// </summary>
		/// <returns></returns>
		public FileRelationInfo GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FileRelationInfo> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FileRelationInfo GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			FileRelationInfo obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FileRelationInfo> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			FileRelationInfo obj = null;
			string strSQL = "select top 1 * from FileRelationInfo where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FileRelationInfo> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<FileRelationInfo> list = new List<FileRelationInfo>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FileRelationInfo>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<FileRelationInfo> list = new List<FileRelationInfo>();
			string strSQL = "select * from FileRelationInfo where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<FileRelationInfo> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<FileRelationInfo> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<FileRelationInfo> list = new List<FileRelationInfo>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<FileRelationInfo> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<FileRelationInfo> list = new List<FileRelationInfo>();
		...
		private static void GetParameters(FileRelationInfo entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static FileRelationInfo GetEntityFromrdr(NullableDataReader rdr)
		{
			FileRelationInfo info = new FileRelationInfo();
