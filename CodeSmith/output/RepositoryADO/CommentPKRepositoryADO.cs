...
namespace JX.ADO
{
	...
	public partial class CommentPKRepositoryADO : ICommentPKRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CommentPK entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommentPK entity)
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CommentPK entity)
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommentPK entity)
		{
			if(entity.PKID <= 0) entity.PKID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommentPK entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommentPK entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CommentPK entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommentPK entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CommentPK SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CommentPK GetEntity(System.Int32 pkid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommentPK> GetEntityAsync(System.Int32 pkid)
		{
			string strCondition = string.Empty;
			strCondition += " and PKID = @PKID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommentPK GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CommentPK obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommentPK> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CommentPK obj = null;
			string strSQL = "select top 1 * from CommentPK where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommentPK> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CommentPK> list = new List<CommentPK>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommentPK>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CommentPK> list = new List<CommentPK>();
			string strSQL = "select * from CommentPK where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CommentPK> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CommentPK> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CommentPK> list = new List<CommentPK>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPK> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPK> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CommentPK> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CommentPK> list = new List<CommentPK>();
		...
		private static void GetParameters(CommentPK entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CommentPK GetEntityFromrdr(NullableDataReader rdr)
		{
			CommentPK info = new CommentPK();
