...
namespace JX.ADO
{
	...
	public partial class StatSystemRepositoryADO : IStatSystemRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatSystem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatSystem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatSystem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatSystem entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatSystem entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatSystem entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatSystem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatSystem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatSystem SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatSystem GetEntity(System.String tSystem)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatSystem> GetEntityAsync(System.String tSystem)
		{
			string strCondition = string.Empty;
			strCondition += " and TSystem = @TSystem";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatSystem GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatSystem obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatSystem> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatSystem obj = null;
			string strSQL = "select top 1 * from StatSystem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatSystem> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatSystem> list = new List<StatSystem>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatSystem>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatSystem> list = new List<StatSystem>();
			string strSQL = "select * from StatSystem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatSystem> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatSystem> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatSystem> list = new List<StatSystem>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatSystem> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatSystem> list = new List<StatSystem>();
		...
		private static void GetParameters(StatSystem entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatSystem GetEntityFromrdr(NullableDataReader rdr)
		{
			StatSystem info = new StatSystem();
