...
namespace JX.ADO
{
	...
	public partial class ProductPriceRepositoryADO : IProductPriceRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ProductPrice entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProductPrice entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ProductPrice entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProductPrice entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProductPrice entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProductPrice entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ProductPrice entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProductPrice entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ProductPrice SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ProductPrice GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProductPrice> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProductPrice GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProductPrice> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ProductPrice obj = null;
			string strSQL = "select top 1 * from ProductPrice where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProductPrice> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ProductPrice> list = new List<ProductPrice>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProductPrice>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ProductPrice> list = new List<ProductPrice>();
			string strSQL = "select * from ProductPrice where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ProductPrice> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ProductPrice> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ProductPrice> list = new List<ProductPrice>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProductPrice> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProductPrice> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ProductPrice> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ProductPrice> list = new List<ProductPrice>();
		...
		private static void GetParameters(ProductPrice entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ProductPrice GetEntityFromrdr(NullableDataReader rdr)
		{
			ProductPrice info = new ProductPrice();
