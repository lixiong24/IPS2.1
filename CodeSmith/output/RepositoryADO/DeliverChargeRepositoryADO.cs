...
namespace JX.ADO
{
	...
	public partial class DeliverChargeRepositoryADO : IDeliverChargeRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverCharge entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverCharge entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverCharge entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverCharge entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverCharge entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverCharge entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverCharge entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverCharge entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverCharge SET "+
		...
		/// </summary>
		/// <returns></returns>
		public DeliverCharge GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverCharge> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverCharge GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverCharge obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverCharge> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverCharge obj = null;
			string strSQL = "select top 1 * from DeliverCharge where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverCharge> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DeliverCharge> list = new List<DeliverCharge>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverCharge>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DeliverCharge> list = new List<DeliverCharge>();
			string strSQL = "select * from DeliverCharge where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<DeliverCharge> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DeliverCharge> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DeliverCharge> list = new List<DeliverCharge>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverCharge> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverCharge> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DeliverCharge> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DeliverCharge> list = new List<DeliverCharge>();
		...
		private static void GetParameters(DeliverCharge entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static DeliverCharge GetEntityFromrdr(NullableDataReader rdr)
		{
			DeliverCharge info = new DeliverCharge();
