...
namespace JX.ADO
{
	...
	public partial class StatColorRepositoryADO : IStatColorRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatColor entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatColor entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatColor entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatColor entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatColor entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatColor entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatColor entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatColor entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatColor SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatColor GetEntity(System.String tColor)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatColor> GetEntityAsync(System.String tColor)
		{
			string strCondition = string.Empty;
			strCondition += " and TColor = @TColor";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatColor GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatColor obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatColor> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatColor obj = null;
			string strSQL = "select top 1 * from StatColor where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatColor> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatColor> list = new List<StatColor>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatColor>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatColor> list = new List<StatColor>();
			string strSQL = "select * from StatColor where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatColor> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatColor> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatColor> list = new List<StatColor>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColor> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColor> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatColor> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatColor> list = new List<StatColor>();
		...
		private static void GetParameters(StatColor entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatColor GetEntityFromrdr(NullableDataReader rdr)
		{
			StatColor info = new StatColor();
