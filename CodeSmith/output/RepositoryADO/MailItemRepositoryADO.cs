...
namespace JX.ADO
{
	...
	public partial class MailItemRepositoryADO : IMailItemRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(MailItem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(MailItem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(MailItem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(MailItem entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(MailItem entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(MailItem entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(MailItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(MailItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update MailItem SET "+
		...
		/// </summary>
		/// <returns></returns>
		public MailItem GetEntity(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<MailItem> GetEntityAsync(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			string strCondition = string.Empty;
			strCondition += " and MailListId = @MailListId";
			strCondition += " and SubscriptionItemId = @SubscriptionItemId";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual MailItem GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			MailItem obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<MailItem> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			MailItem obj = null;
			string strSQL = "select top 1 * from MailItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<MailItem> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<MailItem> list = new List<MailItem>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<MailItem>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<MailItem> list = new List<MailItem>();
			string strSQL = "select * from MailItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<MailItem> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<MailItem> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<MailItem> list = new List<MailItem>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<MailItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<MailItem> list = new List<MailItem>();
		...
		private static void GetParameters(MailItem entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static MailItem GetEntityFromrdr(NullableDataReader rdr)
		{
			MailItem info = new MailItem();
