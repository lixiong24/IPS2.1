...
namespace JX.ADO
{
	...
	public partial class Region_CRepositoryADO : IRegion_CRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Region_C entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Region_C entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Region_C entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Region_C entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Region_C entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Region_C entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Region_C entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Region_C entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Region_C SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Region_C GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Region_C> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Region_C GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Region_C obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Region_C> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Region_C obj = null;
			string strSQL = "select top 1 * from Region_C where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Region_C> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Region_C> list = new List<Region_C>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Region_C>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Region_C> list = new List<Region_C>();
			string strSQL = "select * from Region_C where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Region_C> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Region_C> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Region_C> list = new List<Region_C>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Region_C> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Region_C> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Region_C> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Region_C> list = new List<Region_C>();
		...
		private static void GetParameters(Region_C entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Region_C GetEntityFromrdr(NullableDataReader rdr)
		{
			Region_C info = new Region_C();
