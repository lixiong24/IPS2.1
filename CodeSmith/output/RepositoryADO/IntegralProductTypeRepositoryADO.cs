...
namespace JX.ADO
{
	...
	public partial class IntegralProductTypeRepositoryADO : IIntegralProductTypeRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(IntegralProductType entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IntegralProductType entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(IntegralProductType entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IntegralProductType entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IntegralProductType entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IntegralProductType entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(IntegralProductType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IntegralProductType entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update IntegralProductType SET "+
		...
		/// </summary>
		/// <returns></returns>
		public IntegralProductType GetEntity(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IntegralProductType> GetEntityAsync(System.Int32 typeID)
		{
			string strCondition = string.Empty;
			strCondition += " and TypeID = @TypeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IntegralProductType GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProductType obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IntegralProductType> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			IntegralProductType obj = null;
			string strSQL = "select top 1 * from IntegralProductType where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IntegralProductType> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<IntegralProductType> list = new List<IntegralProductType>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IntegralProductType>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<IntegralProductType> list = new List<IntegralProductType>();
			string strSQL = "select * from IntegralProductType where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<IntegralProductType> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<IntegralProductType> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<IntegralProductType> list = new List<IntegralProductType>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductType> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<IntegralProductType> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<IntegralProductType> list = new List<IntegralProductType>();
		...
		private static void GetParameters(IntegralProductType entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static IntegralProductType GetEntityFromrdr(NullableDataReader rdr)
		{
			IntegralProductType info = new IntegralProductType();
