...
namespace JX.ADO
{
	...
	public partial class SubscriptionItemsRepositoryADO : ISubscriptionItemsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SubscriptionItems entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SubscriptionItems entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SubscriptionItems entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SubscriptionItems entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SubscriptionItems entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SubscriptionItems entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SubscriptionItems entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SubscriptionItems entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SubscriptionItems SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SubscriptionItems GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SubscriptionItems> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and Id = @Id";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SubscriptionItems GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SubscriptionItems obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SubscriptionItems> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SubscriptionItems obj = null;
			string strSQL = "select top 1 * from SubscriptionItems where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SubscriptionItems> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SubscriptionItems> list = new List<SubscriptionItems>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SubscriptionItems>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SubscriptionItems> list = new List<SubscriptionItems>();
			string strSQL = "select * from SubscriptionItems where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SubscriptionItems> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SubscriptionItems> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SubscriptionItems> list = new List<SubscriptionItems>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItems> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItems> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SubscriptionItems> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SubscriptionItems> list = new List<SubscriptionItems>();
		...
		private static void GetParameters(SubscriptionItems entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SubscriptionItems GetEntityFromrdr(NullableDataReader rdr)
		{
			SubscriptionItems info = new SubscriptionItems();
