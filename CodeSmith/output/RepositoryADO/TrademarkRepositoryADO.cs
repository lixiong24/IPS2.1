...
namespace JX.ADO
{
	...
	public partial class TrademarkRepositoryADO : ITrademarkRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Trademark entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Trademark entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Trademark entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Trademark entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Trademark entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Trademark entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Trademark entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Trademark entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Trademark SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Trademark GetEntity(System.Int32 trademarkID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Trademark> GetEntityAsync(System.Int32 trademarkID)
		{
			string strCondition = string.Empty;
			strCondition += " and TrademarkID = @TrademarkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Trademark GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Trademark obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Trademark> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Trademark obj = null;
			string strSQL = "select top 1 * from Trademark where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Trademark> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Trademark> list = new List<Trademark>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Trademark>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Trademark> list = new List<Trademark>();
			string strSQL = "select * from Trademark where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Trademark> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Trademark> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Trademark> list = new List<Trademark>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Trademark> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Trademark> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Trademark> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Trademark> list = new List<Trademark>();
		...
		private static void GetParameters(Trademark entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Trademark GetEntityFromrdr(NullableDataReader rdr)
		{
			Trademark info = new Trademark();
