...
namespace JX.ADO
{
	...
	public partial class DownloadErrorLogRepositoryADO : IDownloadErrorLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(DownloadErrorLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownloadErrorLog entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DownloadErrorLog entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DownloadErrorLog entity)
		{
			if(entity.ErrorID <= 0) entity.ErrorID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownloadErrorLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownloadErrorLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DownloadErrorLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownloadErrorLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DownloadErrorLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public DownloadErrorLog GetEntity(System.Int32 errorID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DownloadErrorLog> GetEntityAsync(System.Int32 errorID)
		{
			string strCondition = string.Empty;
			strCondition += " and ErrorID = @ErrorID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DownloadErrorLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DownloadErrorLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DownloadErrorLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DownloadErrorLog obj = null;
			string strSQL = "select top 1 * from DownloadErrorLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DownloadErrorLog> list = new List<DownloadErrorLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DownloadErrorLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DownloadErrorLog> list = new List<DownloadErrorLog>();
			string strSQL = "select * from DownloadErrorLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<DownloadErrorLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DownloadErrorLog> list = new List<DownloadErrorLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DownloadErrorLog> list = new List<DownloadErrorLog>();
		...
		private static void GetParameters(DownloadErrorLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static DownloadErrorLog GetEntityFromrdr(NullableDataReader rdr)
		{
			DownloadErrorLog info = new DownloadErrorLog();
