...
namespace JX.ADO
{
	...
	public partial class CollectionFilterRulesRepositoryADO : ICollectionFilterRulesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFilterRules entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFilterRules entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFilterRules entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFilterRules entity)
		{
			if(entity.FilterRuleID <= 0) entity.FilterRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFilterRules entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFilterRules entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFilterRules entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFilterRules entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFilterRules SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFilterRules GetEntity(System.Int32 filterRuleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFilterRules> GetEntityAsync(System.Int32 filterRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FilterRuleID = @FilterRuleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFilterRules GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFilterRules obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFilterRules> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFilterRules obj = null;
			string strSQL = "select top 1 * from CollectionFilterRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFilterRules> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionFilterRules> list = new List<CollectionFilterRules>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFilterRules>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionFilterRules> list = new List<CollectionFilterRules>();
			string strSQL = "select * from CollectionFilterRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CollectionFilterRules> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionFilterRules> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionFilterRules> list = new List<CollectionFilterRules>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionFilterRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionFilterRules> list = new List<CollectionFilterRules>();
		...
		private static void GetParameters(CollectionFilterRules entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CollectionFilterRules GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionFilterRules info = new CollectionFilterRules();
