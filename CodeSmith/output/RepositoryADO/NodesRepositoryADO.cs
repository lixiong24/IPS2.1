...
namespace JX.ADO
{
	...
	public partial class NodesRepositoryADO : INodesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Nodes entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Nodes entity)
		{
			if(entity.NodeID <= 0) entity.NodeID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Nodes entity)
		{
			if(entity.NodeID <= 0) entity.NodeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Nodes entity)
		{
			if(entity.NodeID <= 0) entity.NodeID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Nodes entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Nodes entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Nodes entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Nodes entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Nodes SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Nodes GetEntity(System.Int32 nodeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Nodes> GetEntityAsync(System.Int32 nodeID)
		{
			string strCondition = string.Empty;
			strCondition += " and NodeID = @NodeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Nodes GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Nodes obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Nodes> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Nodes obj = null;
			string strSQL = "select top 1 * from Nodes where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Nodes> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Nodes> list = new List<Nodes>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Nodes>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Nodes> list = new List<Nodes>();
			string strSQL = "select * from Nodes where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Nodes> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Nodes> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Nodes> list = new List<Nodes>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Nodes> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Nodes> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Nodes> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Nodes> list = new List<Nodes>();
		...
		private static void GetParameters(Nodes entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Nodes GetEntityFromrdr(NullableDataReader rdr)
		{
			Nodes info = new Nodes();
