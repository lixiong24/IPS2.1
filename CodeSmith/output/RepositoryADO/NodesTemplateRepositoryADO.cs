...
namespace JX.ADO
{
	...
	public partial class NodesTemplateRepositoryADO : INodesTemplateRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(NodesTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesTemplate entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesTemplate entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesTemplate entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesTemplate entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesTemplate entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesTemplate SET "+
		...
		/// </summary>
		/// <returns></returns>
		public NodesTemplate GetEntity(System.Int32 nodeID, System.Int32 templateID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesTemplate> GetEntityAsync(System.Int32 nodeID, System.Int32 templateID)
		{
			string strCondition = string.Empty;
			strCondition += " and NodeID = @NodeID";
			strCondition += " and TemplateID = @TemplateID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesTemplate GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesTemplate obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesTemplate> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesTemplate obj = null;
			string strSQL = "select top 1 * from NodesTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesTemplate> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<NodesTemplate> list = new List<NodesTemplate>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesTemplate>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<NodesTemplate> list = new List<NodesTemplate>();
			string strSQL = "select * from NodesTemplate where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<NodesTemplate> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<NodesTemplate> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<NodesTemplate> list = new List<NodesTemplate>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<NodesTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<NodesTemplate> list = new List<NodesTemplate>();
		...
		private static void GetParameters(NodesTemplate entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static NodesTemplate GetEntityFromrdr(NullableDataReader rdr)
		{
			NodesTemplate info = new NodesTemplate();
