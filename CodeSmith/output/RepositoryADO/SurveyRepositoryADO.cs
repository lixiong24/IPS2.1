...
namespace JX.ADO
{
	...
	public partial class SurveyRepositoryADO : ISurveyRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Survey entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Survey entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Survey entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Survey entity)
		{
			if(entity.SurveyID <= 0) entity.SurveyID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Survey entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Survey entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Survey entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Survey entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Survey SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Survey GetEntity(System.Int32 surveyID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Survey> GetEntityAsync(System.Int32 surveyID)
		{
			string strCondition = string.Empty;
			strCondition += " and SurveyID = @SurveyID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Survey GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Survey obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Survey> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Survey obj = null;
			string strSQL = "select top 1 * from Survey where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Survey> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Survey>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Survey> list = new List<Survey>();
			string strSQL = "select * from Survey where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Survey> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Survey> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Survey> list = new List<Survey>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Survey> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Survey> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Survey> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Survey> list = new List<Survey>();
		...
		private static void GetParameters(Survey entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Survey GetEntityFromrdr(NullableDataReader rdr)
		{
