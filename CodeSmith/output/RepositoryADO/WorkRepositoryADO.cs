...
namespace JX.ADO
{
	...
	public partial class WorkRepositoryADO : IWorkRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Work entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Work entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Work entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Work entity)
		{
			if(entity.WorkID <= 0) entity.WorkID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Work entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Work entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Work entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Work entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Work SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Work GetEntity(System.Int32 workID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Work> GetEntityAsync(System.Int32 workID)
		{
			string strCondition = string.Empty;
			strCondition += " and WorkID = @WorkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Work GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Work obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Work> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Work obj = null;
			string strSQL = "select top 1 * from Work where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Work> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Work> list = new List<Work>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Work>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Work> list = new List<Work>();
			string strSQL = "select * from Work where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Work> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Work> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Work> list = new List<Work>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Work> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Work> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Work> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Work> list = new List<Work>();
		...
		private static void GetParameters(Work entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Work GetEntityFromrdr(NullableDataReader rdr)
		{
			Work info = new Work();
