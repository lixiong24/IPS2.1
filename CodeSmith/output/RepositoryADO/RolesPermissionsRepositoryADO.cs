...
namespace JX.ADO
{
	...
	public partial class RolesPermissionsRepositoryADO : IRolesPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RolesPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RolesPermissions GetEntity(System.Int32 roleID, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesPermissions> GetEntityAsync(System.Int32 roleID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesPermissions obj = null;
			string strSQL = "select top 1 * from RolesPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RolesPermissions> list = new List<RolesPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RolesPermissions> list = new List<RolesPermissions>();
			string strSQL = "select * from RolesPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RolesPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RolesPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RolesPermissions> list = new List<RolesPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RolesPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RolesPermissions> list = new List<RolesPermissions>();
		...
		private static void GetParameters(RolesPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RolesPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			RolesPermissions info = new RolesPermissions();
