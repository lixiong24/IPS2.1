...
namespace JX.ADO
{
	...
	public partial class ModelsRepositoryADO : IModelsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Models entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Models entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Models entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Models entity)
		{
			if(entity.ModelID <= 0) entity.ModelID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Models entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Models entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Models entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Models entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Models SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Models GetEntity(System.Int32 modelID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Models> GetEntityAsync(System.Int32 modelID)
		{
			string strCondition = string.Empty;
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Models GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Models obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Models> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Models obj = null;
			string strSQL = "select top 1 * from Models where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Models> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Models> list = new List<Models>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Models>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Models> list = new List<Models>();
			string strSQL = "select * from Models where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Models> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Models> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Models> list = new List<Models>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Models> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Models> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Models> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Models> list = new List<Models>();
		...
		private static void GetParameters(Models entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Models GetEntityFromrdr(NullableDataReader rdr)
		{
