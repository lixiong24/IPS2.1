...
namespace JX.ADO
{
	...
	public partial class ContacterRepositoryADO : IContacterRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Contacter entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Contacter entity)
		{
			if(entity.ContacterID <= 0) entity.ContacterID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Contacter entity)
		{
			if(entity.ContacterID <= 0) entity.ContacterID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Contacter entity)
		{
			if(entity.ContacterID <= 0) entity.ContacterID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Contacter entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Contacter entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Contacter entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Contacter entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Contacter SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Contacter GetEntity(System.Int32 contacterID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Contacter> GetEntityAsync(System.Int32 contacterID)
		{
			string strCondition = string.Empty;
			strCondition += " and ContacterID = @ContacterID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Contacter GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Contacter obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Contacter> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Contacter obj = null;
			string strSQL = "select top 1 * from Contacter where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Contacter> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Contacter> list = new List<Contacter>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Contacter>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Contacter> list = new List<Contacter>();
			string strSQL = "select * from Contacter where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Contacter> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Contacter> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Contacter> list = new List<Contacter>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Contacter> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Contacter> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Contacter> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Contacter> list = new List<Contacter>();
		...
		private static void GetParameters(Contacter entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Contacter GetEntityFromrdr(NullableDataReader rdr)
		{
			Contacter info = new Contacter();
