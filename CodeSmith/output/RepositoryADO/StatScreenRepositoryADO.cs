...
namespace JX.ADO
{
	...
	public partial class StatScreenRepositoryADO : IStatScreenRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatScreen entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatScreen entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatScreen entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatScreen entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatScreen entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatScreen entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatScreen entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatScreen entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatScreen SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatScreen GetEntity(System.String tScreen)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatScreen> GetEntityAsync(System.String tScreen)
		{
			string strCondition = string.Empty;
			strCondition += " and TScreen = @TScreen";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatScreen GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatScreen obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatScreen> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatScreen obj = null;
			string strSQL = "select top 1 * from StatScreen where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatScreen> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatScreen> list = new List<StatScreen>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatScreen>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatScreen> list = new List<StatScreen>();
			string strSQL = "select * from StatScreen where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatScreen> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatScreen> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatScreen> list = new List<StatScreen>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreen> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreen> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatScreen> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatScreen> list = new List<StatScreen>();
		...
		private static void GetParameters(StatScreen entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatScreen GetEntityFromrdr(NullableDataReader rdr)
		{
			StatScreen info = new StatScreen();
