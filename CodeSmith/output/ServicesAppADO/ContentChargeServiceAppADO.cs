...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ContentChargeServiceAppADO : IContentChargeServiceAppADO
	{
		#region 仓储接口
		private readonly IContentChargeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ContentChargeServiceAppADO(IContentChargeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ContentChargeDTO dto)
		{
			return _repository.Add(Mapper.Map<ContentCharge>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ContentChargeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ContentCharge>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ContentChargeDTO dto)
		{
			return _repository.Insert(Mapper.Map<ContentCharge>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ContentChargeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ContentCharge>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ContentChargeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ContentChargeDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ContentChargeDTO dto)
		{
			return _repository.Update(Mapper.Map<ContentCharge>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ContentChargeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ContentCharge>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ContentChargeDTO GetDTO(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ContentChargeDTO> GetDTOAsync(System.Int32 generalID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ContentChargeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ContentChargeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ContentChargeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ContentChargeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ContentChargeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentChargeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentChargeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
