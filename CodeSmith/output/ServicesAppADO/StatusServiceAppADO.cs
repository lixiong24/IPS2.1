...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatusServiceAppADO : IStatusServiceAppADO
	{
		#region 仓储接口
		private readonly IStatusRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatusServiceAppADO(IStatusRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatusDTO dto)
		{
			return _repository.Add(Mapper.Map<Status>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatusDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Status>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatusDTO dto)
		{
			return _repository.Insert(Mapper.Map<Status>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatusDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Status>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatusDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatusDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(statusID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatusDTO dto)
		{
			return _repository.Update(Mapper.Map<Status>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatusDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Status>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatusDTO GetDTO(System.Int32 statusID)
		{
			var entity = _repository.GetEntity(statusID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatusDTO> GetDTOAsync(System.Int32 statusID)
		{
			var entity = await _repository.GetEntityAsync(statusID );
			return Mapper.Map<StatusDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatusDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatusDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatusDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatusDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatusDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatusDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatusDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
