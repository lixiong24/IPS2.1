...
namespace JX.Application
{
	...
	/// </summary>
	public partial class GroupSpecialPermissionsServiceAppADO : IGroupSpecialPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IGroupSpecialPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public GroupSpecialPermissionsServiceAppADO(IGroupSpecialPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupSpecialPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupSpecialPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(groupID,operateCode,specialID,iDType );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(groupID,operateCode,specialID,iDType );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<GroupSpecialPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public GroupSpecialPermissionsDTO GetDTO(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			var entity = _repository.GetEntity(groupID,operateCode,specialID,iDType );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupSpecialPermissionsDTO> GetDTOAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			var entity = await _repository.GetEntityAsync(groupID,operateCode,specialID,iDType );
			return Mapper.Map<GroupSpecialPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupSpecialPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupSpecialPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<GroupSpecialPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
