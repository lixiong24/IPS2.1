...
namespace JX.Application
{
	...
	/// </summary>
	public partial class InfoNextProcessRolesServiceAppADO : IInfoNextProcessRolesServiceAppADO
	{
		#region 仓储接口
		private readonly IInfoNextProcessRolesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public InfoNextProcessRolesServiceAppADO(IInfoNextProcessRolesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(InfoNextProcessRolesDTO dto)
		{
			return _repository.Add(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InfoNextProcessRolesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(InfoNextProcessRolesDTO dto)
		{
			return _repository.Insert(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(InfoNextProcessRolesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(InfoNextProcessRolesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(InfoNextProcessRolesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(generalID,roleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(generalID,roleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(InfoNextProcessRolesDTO dto)
		{
			return _repository.Update(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(InfoNextProcessRolesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<InfoNextProcessRoles>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public InfoNextProcessRolesDTO GetDTO(System.Int32 generalID, System.Int32 roleID)
		{
			var entity = _repository.GetEntity(generalID,roleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InfoNextProcessRolesDTO> GetDTOAsync(System.Int32 generalID, System.Int32 roleID)
		{
			var entity = await _repository.GetEntityAsync(generalID,roleID );
			return Mapper.Map<InfoNextProcessRolesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InfoNextProcessRolesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<InfoNextProcessRolesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InfoNextProcessRolesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InfoNextProcessRolesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<InfoNextProcessRolesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
