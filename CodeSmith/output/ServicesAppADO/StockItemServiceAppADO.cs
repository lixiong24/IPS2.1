...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StockItemServiceAppADO : IStockItemServiceAppADO
	{
		#region 仓储接口
		private readonly IStockItemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StockItemServiceAppADO(IStockItemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StockItemDTO dto)
		{
			return _repository.Add(Mapper.Map<StockItem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockItemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StockItem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StockItemDTO dto)
		{
			return _repository.Insert(Mapper.Map<StockItem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockItemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StockItem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockItemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockItemDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StockItemDTO dto)
		{
			return _repository.Update(Mapper.Map<StockItem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockItemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StockItem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StockItemDTO GetDTO(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockItemDTO> GetDTOAsync(System.Int32 itemID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockItemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockItemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockItemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockItemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StockItemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
