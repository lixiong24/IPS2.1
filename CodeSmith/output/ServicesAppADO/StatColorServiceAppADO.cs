...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatColorServiceAppADO : IStatColorServiceAppADO
	{
		#region 仓储接口
		private readonly IStatColorRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatColorServiceAppADO(IStatColorRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatColorDTO dto)
		{
			return _repository.Add(Mapper.Map<StatColor>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatColorDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatColor>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatColorDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatColor>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatColorDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatColor>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatColorDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatColorDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tColor );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tColor );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatColorDTO dto)
		{
			return _repository.Update(Mapper.Map<StatColor>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatColorDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatColor>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatColorDTO GetDTO(System.String tColor)
		{
			var entity = _repository.GetEntity(tColor );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatColorDTO> GetDTOAsync(System.String tColor)
		{
			var entity = await _repository.GetEntityAsync(tColor );
			return Mapper.Map<StatColorDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatColorDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatColorDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatColorDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatColorDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatColorDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColorDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatColorDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
