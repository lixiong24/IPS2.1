...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PointLogServiceAppADO : IPointLogServiceAppADO
	{
		#region 仓储接口
		private readonly IPointLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PointLogServiceAppADO(IPointLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PointLogDTO dto)
		{
			return _repository.Add(Mapper.Map<PointLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PointLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PointLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PointLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<PointLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PointLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PointLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PointLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PointLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PointLogDTO dto)
		{
			return _repository.Update(Mapper.Map<PointLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PointLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PointLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PointLogDTO GetDTO(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PointLogDTO> GetDTOAsync(System.Int32 logID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PointLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PointLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PointLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PointLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PointLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PointLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PointLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
