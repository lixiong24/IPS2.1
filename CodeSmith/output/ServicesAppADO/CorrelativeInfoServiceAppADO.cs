...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CorrelativeInfoServiceAppADO : ICorrelativeInfoServiceAppADO
	{
		#region 仓储接口
		private readonly ICorrelativeInfoRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CorrelativeInfoServiceAppADO(ICorrelativeInfoRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CorrelativeInfoDTO dto)
		{
			return _repository.Add(Mapper.Map<CorrelativeInfo>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CorrelativeInfoDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CorrelativeInfo>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CorrelativeInfoDTO dto)
		{
			return _repository.Insert(Mapper.Map<CorrelativeInfo>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CorrelativeInfoDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CorrelativeInfo>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CorrelativeInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CorrelativeInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CorrelativeInfoDTO dto)
		{
			return _repository.Update(Mapper.Map<CorrelativeInfo>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CorrelativeInfoDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CorrelativeInfo>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CorrelativeInfoDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CorrelativeInfoDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CorrelativeInfoDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CorrelativeInfoDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CorrelativeInfoDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CorrelativeInfoDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CorrelativeInfoDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CorrelativeInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
