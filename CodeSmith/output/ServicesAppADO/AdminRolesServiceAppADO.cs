...
namespace JX.Application
{
	...
	/// </summary>
	public partial class AdminRolesServiceAppADO : IAdminRolesServiceAppADO
	{
		#region 仓储接口
		private readonly IAdminRolesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public AdminRolesServiceAppADO(IAdminRolesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(AdminRolesDTO dto)
		{
			return _repository.Add(Mapper.Map<AdminRoles>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdminRolesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<AdminRoles>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AdminRolesDTO dto)
		{
			return _repository.Insert(Mapper.Map<AdminRoles>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdminRolesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<AdminRoles>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdminRolesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdminRolesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(adminID,roleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(adminID,roleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AdminRolesDTO dto)
		{
			return _repository.Update(Mapper.Map<AdminRoles>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdminRolesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<AdminRoles>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AdminRolesDTO GetDTO(System.Int32 adminID, System.Int32 roleID)
		{
			var entity = _repository.GetEntity(adminID,roleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdminRolesDTO> GetDTOAsync(System.Int32 adminID, System.Int32 roleID)
		{
			var entity = await _repository.GetEntityAsync(adminID,roleID );
			return Mapper.Map<AdminRolesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdminRolesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdminRolesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdminRolesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdminRolesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AdminRolesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
