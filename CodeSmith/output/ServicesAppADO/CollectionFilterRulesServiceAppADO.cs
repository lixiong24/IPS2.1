...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionFilterRulesServiceAppADO : ICollectionFilterRulesServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionFilterRulesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionFilterRulesServiceAppADO(ICollectionFilterRulesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFilterRulesDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionFilterRules>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFilterRulesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionFilterRules>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFilterRulesDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionFilterRules>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFilterRulesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionFilterRules>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFilterRulesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFilterRulesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(filterRuleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(filterRuleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFilterRulesDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionFilterRules>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFilterRulesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionFilterRules>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFilterRulesDTO GetDTO(System.Int32 filterRuleID)
		{
			var entity = _repository.GetEntity(filterRuleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFilterRulesDTO> GetDTOAsync(System.Int32 filterRuleID)
		{
			var entity = await _repository.GetEntityAsync(filterRuleID );
			return Mapper.Map<CollectionFilterRulesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFilterRulesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFilterRulesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFilterRulesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFilterRulesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionFilterRulesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFilterRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
