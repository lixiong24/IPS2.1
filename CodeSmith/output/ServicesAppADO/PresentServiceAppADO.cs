...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PresentServiceAppADO : IPresentServiceAppADO
	{
		#region 仓储接口
		private readonly IPresentRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PresentServiceAppADO(IPresentRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PresentDTO dto)
		{
			return _repository.Add(Mapper.Map<Present>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Present>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentDTO dto)
		{
			return _repository.Insert(Mapper.Map<Present>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Present>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(presentID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(presentID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentDTO dto)
		{
			return _repository.Update(Mapper.Map<Present>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Present>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PresentDTO GetDTO(System.Int32 presentID)
		{
			var entity = _repository.GetEntity(presentID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentDTO> GetDTOAsync(System.Int32 presentID)
		{
			var entity = await _repository.GetEntityAsync(presentID );
			return Mapper.Map<PresentDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PresentDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
