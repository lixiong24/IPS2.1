...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CompanyServiceAppADO : ICompanyServiceAppADO
	{
		#region 仓储接口
		private readonly ICompanyRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CompanyServiceAppADO(ICompanyRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CompanyDTO dto)
		{
			return _repository.Add(Mapper.Map<Company>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CompanyDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Company>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CompanyDTO dto)
		{
			return _repository.Insert(Mapper.Map<Company>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CompanyDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Company>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CompanyDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CompanyDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CompanyDTO dto)
		{
			return _repository.Update(Mapper.Map<Company>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CompanyDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Company>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CompanyDTO GetDTO(System.Int32 companyID)
		{
			var entity = _repository.GetEntity(companyID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CompanyDTO> GetDTOAsync(System.Int32 companyID)
		{
			var entity = await _repository.GetEntityAsync(companyID );
			return Mapper.Map<CompanyDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CompanyDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CompanyDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CompanyDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CompanyDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CompanyDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CompanyDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CompanyDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
