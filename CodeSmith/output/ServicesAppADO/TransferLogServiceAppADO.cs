...
namespace JX.Application
{
	...
	/// </summary>
	public partial class TransferLogServiceAppADO : ITransferLogServiceAppADO
	{
		#region 仓储接口
		private readonly ITransferLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public TransferLogServiceAppADO(ITransferLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(TransferLogDTO dto)
		{
			return _repository.Add(Mapper.Map<TransferLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(TransferLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<TransferLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(TransferLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<TransferLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(TransferLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<TransferLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(TransferLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(TransferLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(transferLogID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(transferLogID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(TransferLogDTO dto)
		{
			return _repository.Update(Mapper.Map<TransferLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(TransferLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<TransferLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public TransferLogDTO GetDTO(System.Int32 transferLogID)
		{
			var entity = _repository.GetEntity(transferLogID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<TransferLogDTO> GetDTOAsync(System.Int32 transferLogID)
		{
			var entity = await _repository.GetEntityAsync(transferLogID );
			return Mapper.Map<TransferLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual TransferLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<TransferLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<TransferLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<TransferLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<TransferLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
