...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RolesProcessServiceAppADO : IRolesProcessServiceAppADO
	{
		#region 仓储接口
		private readonly IRolesProcessRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RolesProcessServiceAppADO(IRolesProcessRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RolesProcessDTO dto)
		{
			return _repository.Add(Mapper.Map<RolesProcess>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesProcessDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RolesProcess>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesProcessDTO dto)
		{
			return _repository.Insert(Mapper.Map<RolesProcess>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesProcessDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RolesProcess>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesProcessDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesProcessDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(flowID,processID,roleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(flowID,processID,roleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesProcessDTO dto)
		{
			return _repository.Update(Mapper.Map<RolesProcess>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesProcessDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RolesProcess>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RolesProcessDTO GetDTO(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			var entity = _repository.GetEntity(flowID,processID,roleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesProcessDTO> GetDTOAsync(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			var entity = await _repository.GetEntityAsync(flowID,processID,roleID );
			return Mapper.Map<RolesProcessDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesProcessDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesProcessDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesProcessDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesProcessDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RolesProcessDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcessDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcessDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
