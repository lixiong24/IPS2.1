...
namespace JX.Application
{
	...
	/// </summary>
	public partial class BankrollLogServiceAppADO : IBankrollLogServiceAppADO
	{
		#region 仓储接口
		private readonly IBankrollLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public BankrollLogServiceAppADO(IBankrollLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(BankrollLogDTO dto)
		{
			return _repository.Add(Mapper.Map<BankrollLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(BankrollLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<BankrollLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(BankrollLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<BankrollLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(BankrollLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<BankrollLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(BankrollLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(BankrollLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(BankrollLogDTO dto)
		{
			return _repository.Update(Mapper.Map<BankrollLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(BankrollLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<BankrollLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public BankrollLogDTO GetDTO(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<BankrollLogDTO> GetDTOAsync(System.Int32 itemID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual BankrollLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<BankrollLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<BankrollLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<BankrollLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<BankrollLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankrollLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankrollLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
