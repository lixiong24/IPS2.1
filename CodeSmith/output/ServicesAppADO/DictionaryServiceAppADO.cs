...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DictionaryServiceAppADO : IDictionaryServiceAppADO
	{
		#region 仓储接口
		private readonly IDictionaryRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DictionaryServiceAppADO(IDictionaryRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DictionaryDTO dto)
		{
			return _repository.Add(Mapper.Map<Dictionary>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DictionaryDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Dictionary>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DictionaryDTO dto)
		{
			return _repository.Insert(Mapper.Map<Dictionary>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DictionaryDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Dictionary>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DictionaryDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DictionaryDTO dto, bool IsSave)
		{
		...
		{
			return await _repository.DeleteAsync(fieldID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DictionaryDTO dto)
		{
			return _repository.Update(Mapper.Map<Dictionary>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DictionaryDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Dictionary>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DictionaryDTO GetDTO(System.Int32 fieldID)
		{
			var entity = _repository.GetEntity(fieldID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DictionaryDTO> GetDTOAsync(System.Int32 fieldID)
		{
			var entity = await _repository.GetEntityAsync(fieldID );
			return Mapper.Map<DictionaryDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DictionaryDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DictionaryDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DictionaryDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DictionaryDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DictionaryDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DictionaryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DictionaryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
