...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionExclosionServiceAppADO : ICollectionExclosionServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionExclosionRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionExclosionServiceAppADO(ICollectionExclosionRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionExclosionDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionExclosion>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionExclosionDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionExclosion>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionExclosionDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionExclosion>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionExclosionDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionExclosion>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionExclosionDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionExclosionDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(exclosionID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(exclosionID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionExclosionDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionExclosion>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionExclosionDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionExclosion>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionExclosionDTO GetDTO(System.Int32 exclosionID)
		{
			var entity = _repository.GetEntity(exclosionID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionExclosionDTO> GetDTOAsync(System.Int32 exclosionID)
		{
			var entity = await _repository.GetEntityAsync(exclosionID );
			return Mapper.Map<CollectionExclosionDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionExclosionDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionExclosionDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionExclosionDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionExclosionDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionExclosionDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionExclosionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
