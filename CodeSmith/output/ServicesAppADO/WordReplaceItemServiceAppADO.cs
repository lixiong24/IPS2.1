...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WordReplaceItemServiceAppADO : IWordReplaceItemServiceAppADO
	{
		#region 仓储接口
		private readonly IWordReplaceItemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WordReplaceItemServiceAppADO(IWordReplaceItemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WordReplaceItemDTO dto)
		{
			return _repository.Add(Mapper.Map<WordReplaceItem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WordReplaceItemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<WordReplaceItem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WordReplaceItemDTO dto)
		{
			return _repository.Insert(Mapper.Map<WordReplaceItem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WordReplaceItemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<WordReplaceItem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WordReplaceItemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WordReplaceItemDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WordReplaceItemDTO dto)
		{
			return _repository.Update(Mapper.Map<WordReplaceItem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WordReplaceItemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<WordReplaceItem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WordReplaceItemDTO GetDTO(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WordReplaceItemDTO> GetDTOAsync(System.Int32 itemID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WordReplaceItemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WordReplaceItemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WordReplaceItemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WordReplaceItemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WordReplaceItemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WordReplaceItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WordReplaceItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
