...
namespace JX.Application
{
	...
	/// </summary>
	public partial class IncludeFileServiceAppADO : IIncludeFileServiceAppADO
	{
		#region 仓储接口
		private readonly IIncludeFileRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public IncludeFileServiceAppADO(IIncludeFileRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(IncludeFileDTO dto)
		{
			return _repository.Add(Mapper.Map<IncludeFile>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IncludeFileDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<IncludeFile>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(IncludeFileDTO dto)
		{
			return _repository.Insert(Mapper.Map<IncludeFile>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IncludeFileDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<IncludeFile>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IncludeFileDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IncludeFileDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(IncludeFileDTO dto)
		{
			return _repository.Update(Mapper.Map<IncludeFile>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IncludeFileDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<IncludeFile>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public IncludeFileDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IncludeFileDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IncludeFileDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IncludeFileDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IncludeFileDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IncludeFileDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<IncludeFileDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IncludeFileDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IncludeFileDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
