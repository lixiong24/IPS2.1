...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ExpLogServiceAppADO : IExpLogServiceAppADO
	{
		#region 仓储接口
		private readonly IExpLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ExpLogServiceAppADO(IExpLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ExpLogDTO dto)
		{
			return _repository.Add(Mapper.Map<ExpLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ExpLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ExpLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ExpLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<ExpLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ExpLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ExpLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ExpLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ExpLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ExpLogDTO dto)
		{
			return _repository.Update(Mapper.Map<ExpLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ExpLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ExpLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ExpLogDTO GetDTO(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ExpLogDTO> GetDTOAsync(System.Int32 logID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ExpLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ExpLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ExpLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ExpLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ExpLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ExpLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ExpLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
