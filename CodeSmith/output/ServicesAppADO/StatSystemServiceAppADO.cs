...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatSystemServiceAppADO : IStatSystemServiceAppADO
	{
		#region 仓储接口
		private readonly IStatSystemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatSystemServiceAppADO(IStatSystemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatSystemDTO dto)
		{
			return _repository.Add(Mapper.Map<StatSystem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatSystemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatSystem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatSystemDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatSystem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatSystemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatSystem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatSystemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatSystemDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tSystem );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tSystem );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatSystemDTO dto)
		{
			return _repository.Update(Mapper.Map<StatSystem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatSystemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatSystem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatSystemDTO GetDTO(System.String tSystem)
		{
			var entity = _repository.GetEntity(tSystem );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatSystemDTO> GetDTOAsync(System.String tSystem)
		{
			var entity = await _repository.GetEntityAsync(tSystem );
			return Mapper.Map<StatSystemDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatSystemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatSystemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatSystemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatSystemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatSystemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatSystemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
