...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionPagingRulesServiceAppADO : ICollectionPagingRulesServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionPagingRulesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionPagingRulesServiceAppADO(ICollectionPagingRulesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionPagingRulesDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionPagingRules>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionPagingRulesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionPagingRules>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionPagingRulesDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionPagingRules>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionPagingRulesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionPagingRules>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionPagingRulesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionPagingRulesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(pagingRuleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(pagingRuleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionPagingRulesDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionPagingRules>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionPagingRulesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionPagingRules>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionPagingRulesDTO GetDTO(System.Int32 pagingRuleID)
		{
			var entity = _repository.GetEntity(pagingRuleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionPagingRulesDTO> GetDTOAsync(System.Int32 pagingRuleID)
		{
			var entity = await _repository.GetEntityAsync(pagingRuleID );
			return Mapper.Map<CollectionPagingRulesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionPagingRulesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionPagingRulesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionPagingRulesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionPagingRulesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionPagingRulesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionPagingRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionPagingRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
