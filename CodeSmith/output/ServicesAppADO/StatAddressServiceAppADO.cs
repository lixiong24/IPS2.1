...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatAddressServiceAppADO : IStatAddressServiceAppADO
	{
		#region 仓储接口
		private readonly IStatAddressRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatAddressServiceAppADO(IStatAddressRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatAddressDTO dto)
		{
			return _repository.Add(Mapper.Map<StatAddress>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatAddressDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatAddress>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatAddressDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatAddress>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatAddressDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatAddress>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatAddressDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatAddressDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tAddress );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tAddress );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatAddressDTO dto)
		{
			return _repository.Update(Mapper.Map<StatAddress>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatAddressDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatAddress>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatAddressDTO GetDTO(System.String tAddress)
		{
			var entity = _repository.GetEntity(tAddress );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatAddressDTO> GetDTOAsync(System.String tAddress)
		{
			var entity = await _repository.GetEntityAsync(tAddress );
			return Mapper.Map<StatAddressDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatAddressDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatAddressDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatAddressDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatAddressDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatAddressDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddressDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatAddressDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
