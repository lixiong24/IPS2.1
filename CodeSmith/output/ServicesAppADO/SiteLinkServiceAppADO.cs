...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SiteLinkServiceAppADO : ISiteLinkServiceAppADO
	{
		#region 仓储接口
		private readonly ISiteLinkRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SiteLinkServiceAppADO(ISiteLinkRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SiteLinkDTO dto)
		{
			return _repository.Add(Mapper.Map<SiteLink>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SiteLinkDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SiteLink>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SiteLinkDTO dto)
		{
			return _repository.Insert(Mapper.Map<SiteLink>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SiteLinkDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SiteLink>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SiteLinkDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SiteLinkDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(insideLinkID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(insideLinkID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SiteLinkDTO dto)
		{
			return _repository.Update(Mapper.Map<SiteLink>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SiteLinkDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SiteLink>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SiteLinkDTO GetDTO(System.Int32 insideLinkID)
		{
			var entity = _repository.GetEntity(insideLinkID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SiteLinkDTO> GetDTOAsync(System.Int32 insideLinkID)
		{
			var entity = await _repository.GetEntityAsync(insideLinkID );
			return Mapper.Map<SiteLinkDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SiteLinkDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SiteLinkDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SiteLinkDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SiteLinkDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SiteLinkDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLinkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLinkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
