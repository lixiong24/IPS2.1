...
namespace JX.Application
{
	...
	/// </summary>
	public partial class MailItemServiceAppADO : IMailItemServiceAppADO
	{
		#region 仓储接口
		private readonly IMailItemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public MailItemServiceAppADO(IMailItemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(MailItemDTO dto)
		{
			return _repository.Add(Mapper.Map<MailItem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(MailItemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<MailItem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(MailItemDTO dto)
		{
			return _repository.Insert(Mapper.Map<MailItem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(MailItemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<MailItem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(MailItemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(MailItemDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(mailListId,subscriptionItemId );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(mailListId,subscriptionItemId );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(MailItemDTO dto)
		{
			return _repository.Update(Mapper.Map<MailItem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(MailItemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<MailItem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public MailItemDTO GetDTO(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			var entity = _repository.GetEntity(mailListId,subscriptionItemId );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<MailItemDTO> GetDTOAsync(System.Int32 mailListId, System.Int32 subscriptionItemId)
		{
			var entity = await _repository.GetEntityAsync(mailListId,subscriptionItemId );
			return Mapper.Map<MailItemDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual MailItemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<MailItemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<MailItemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<MailItemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<MailItemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<MailItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
