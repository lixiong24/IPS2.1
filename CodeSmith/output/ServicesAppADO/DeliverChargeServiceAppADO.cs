...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DeliverChargeServiceAppADO : IDeliverChargeServiceAppADO
	{
		#region 仓储接口
		private readonly IDeliverChargeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DeliverChargeServiceAppADO(IDeliverChargeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverChargeDTO dto)
		{
			return _repository.Add(Mapper.Map<DeliverCharge>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverChargeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<DeliverCharge>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverChargeDTO dto)
		{
			return _repository.Insert(Mapper.Map<DeliverCharge>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverChargeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<DeliverCharge>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverChargeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverChargeDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverChargeDTO dto)
		{
			return _repository.Update(Mapper.Map<DeliverCharge>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverChargeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<DeliverCharge>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DeliverChargeDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverChargeDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverChargeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverChargeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverChargeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverChargeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DeliverChargeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverChargeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverChargeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
