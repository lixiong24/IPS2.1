...
namespace JX.Application
{
	...
	/// </summary>
	public partial class NodesModelTemplateServiceAppADO : INodesModelTemplateServiceAppADO
	{
		#region 仓储接口
		private readonly INodesModelTemplateRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public NodesModelTemplateServiceAppADO(INodesModelTemplateRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(NodesModelTemplateDTO dto)
		{
			return _repository.Add(Mapper.Map<NodesModelTemplate>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesModelTemplateDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<NodesModelTemplate>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesModelTemplateDTO dto)
		{
			return _repository.Insert(Mapper.Map<NodesModelTemplate>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesModelTemplateDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<NodesModelTemplate>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesModelTemplateDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesModelTemplateDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(nodeID,modelID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(nodeID,modelID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesModelTemplateDTO dto)
		{
			return _repository.Update(Mapper.Map<NodesModelTemplate>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesModelTemplateDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<NodesModelTemplate>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public NodesModelTemplateDTO GetDTO(System.Int32 nodeID, System.Int32 modelID)
		{
			var entity = _repository.GetEntity(nodeID,modelID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesModelTemplateDTO> GetDTOAsync(System.Int32 nodeID, System.Int32 modelID)
		{
			var entity = await _repository.GetEntityAsync(nodeID,modelID );
			return Mapper.Map<NodesModelTemplateDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesModelTemplateDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesModelTemplateDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesModelTemplateDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesModelTemplateDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<NodesModelTemplateDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplateDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplateDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
