...
namespace JX.Application
{
	...
	/// </summary>
	public partial class AdZoneServiceAppADO : IAdZoneServiceAppADO
	{
		#region 仓储接口
		private readonly IAdZoneRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public AdZoneServiceAppADO(IAdZoneRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(AdZoneDTO dto)
		{
			return _repository.Add(Mapper.Map<AdZone>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdZoneDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<AdZone>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AdZoneDTO dto)
		{
			return _repository.Insert(Mapper.Map<AdZone>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdZoneDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<AdZone>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdZoneDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdZoneDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(zoneID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(zoneID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AdZoneDTO dto)
		{
			return _repository.Update(Mapper.Map<AdZone>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdZoneDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<AdZone>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AdZoneDTO GetDTO(System.Int32 zoneID)
		{
			var entity = _repository.GetEntity(zoneID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdZoneDTO> GetDTOAsync(System.Int32 zoneID)
		{
			var entity = await _repository.GetEntityAsync(zoneID );
			return Mapper.Map<AdZoneDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdZoneDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdZoneDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdZoneDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdZoneDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AdZoneDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZoneDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZoneDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
