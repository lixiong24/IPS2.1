...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WorkCategorySettingServiceAppADO : IWorkCategorySettingServiceAppADO
	{
		#region 仓储接口
		private readonly IWorkCategorySettingRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WorkCategorySettingServiceAppADO(IWorkCategorySettingRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WorkCategorySettingDTO dto)
		{
			return _repository.Add(Mapper.Map<WorkCategorySetting>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkCategorySettingDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<WorkCategorySetting>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkCategorySettingDTO dto)
		{
			return _repository.Insert(Mapper.Map<WorkCategorySetting>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkCategorySettingDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<WorkCategorySetting>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkCategorySettingDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkCategorySettingDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkCategorySettingDTO dto)
		{
			return _repository.Update(Mapper.Map<WorkCategorySetting>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkCategorySettingDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<WorkCategorySetting>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WorkCategorySettingDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkCategorySettingDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkCategorySettingDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkCategorySettingDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkCategorySettingDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkCategorySettingDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WorkCategorySettingDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategorySettingDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategorySettingDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
