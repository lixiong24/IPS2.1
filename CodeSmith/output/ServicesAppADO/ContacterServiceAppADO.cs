...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ContacterServiceAppADO : IContacterServiceAppADO
	{
		#region 仓储接口
		private readonly IContacterRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ContacterServiceAppADO(IContacterRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ContacterDTO dto)
		{
			return _repository.Add(Mapper.Map<Contacter>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ContacterDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Contacter>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ContacterDTO dto)
		{
			return _repository.Insert(Mapper.Map<Contacter>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ContacterDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Contacter>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ContacterDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ContacterDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(contacterID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(contacterID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ContacterDTO dto)
		{
			return _repository.Update(Mapper.Map<Contacter>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ContacterDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Contacter>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ContacterDTO GetDTO(System.Int32 contacterID)
		{
			var entity = _repository.GetEntity(contacterID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ContacterDTO> GetDTOAsync(System.Int32 contacterID)
		{
			var entity = await _repository.GetEntityAsync(contacterID );
			return Mapper.Map<ContacterDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ContacterDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ContacterDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ContacterDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ContacterDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ContacterDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContacterDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContacterDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
