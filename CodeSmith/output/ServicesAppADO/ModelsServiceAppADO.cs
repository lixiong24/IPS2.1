...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ModelsServiceAppADO : IModelsServiceAppADO
	{
		#region 仓储接口
		private readonly IModelsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ModelsServiceAppADO(IModelsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ModelsDTO dto)
		{
			return _repository.Add(Mapper.Map<Models>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ModelsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Models>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ModelsDTO dto)
		{
			return _repository.Insert(Mapper.Map<Models>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ModelsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Models>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ModelsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ModelsDTO dto, bool IsSave)
		{
		...
		{
			return await _repository.DeleteAsync(modelID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ModelsDTO dto)
		{
			return _repository.Update(Mapper.Map<Models>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ModelsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Models>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ModelsDTO GetDTO(System.Int32 modelID)
		{
			var entity = _repository.GetEntity(modelID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ModelsDTO> GetDTOAsync(System.Int32 modelID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ModelsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ModelsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ModelsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ModelsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ModelsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
