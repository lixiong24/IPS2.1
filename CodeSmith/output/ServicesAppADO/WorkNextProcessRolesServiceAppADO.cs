...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WorkNextProcessRolesServiceAppADO : IWorkNextProcessRolesServiceAppADO
	{
		#region 仓储接口
		private readonly IWorkNextProcessRolesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WorkNextProcessRolesServiceAppADO(IWorkNextProcessRolesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WorkNextProcessRolesDTO dto)
		{
			return _repository.Add(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkNextProcessRolesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkNextProcessRolesDTO dto)
		{
			return _repository.Insert(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkNextProcessRolesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkNextProcessRolesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkNextProcessRolesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(workID,roleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(workID,roleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkNextProcessRolesDTO dto)
		{
			return _repository.Update(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkNextProcessRolesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<WorkNextProcessRoles>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WorkNextProcessRolesDTO GetDTO(System.Int32 workID, System.Int32 roleID)
		{
			var entity = _repository.GetEntity(workID,roleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkNextProcessRolesDTO> GetDTOAsync(System.Int32 workID, System.Int32 roleID)
		{
			var entity = await _repository.GetEntityAsync(workID,roleID );
			return Mapper.Map<WorkNextProcessRolesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkNextProcessRolesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkNextProcessRolesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkNextProcessRolesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkNextProcessRolesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WorkNextProcessRolesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
