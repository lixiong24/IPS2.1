...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ModelTemplatesServiceAppADO : IModelTemplatesServiceAppADO
	{
		#region 仓储接口
		private readonly IModelTemplatesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ModelTemplatesServiceAppADO(IModelTemplatesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ModelTemplatesDTO dto)
		{
			return _repository.Add(Mapper.Map<ModelTemplates>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ModelTemplatesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ModelTemplates>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ModelTemplatesDTO dto)
		{
			return _repository.Insert(Mapper.Map<ModelTemplates>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ModelTemplatesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ModelTemplates>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ModelTemplatesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ModelTemplatesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(templateID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ModelTemplatesDTO dto)
		{
			return _repository.Update(Mapper.Map<ModelTemplates>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ModelTemplatesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ModelTemplates>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ModelTemplatesDTO GetDTO(System.Int32 templateID)
		{
			var entity = _repository.GetEntity(templateID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ModelTemplatesDTO> GetDTOAsync(System.Int32 templateID)
		{
			var entity = await _repository.GetEntityAsync(templateID );
			return Mapper.Map<ModelTemplatesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ModelTemplatesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ModelTemplatesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ModelTemplatesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ModelTemplatesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ModelTemplatesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplatesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplatesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
