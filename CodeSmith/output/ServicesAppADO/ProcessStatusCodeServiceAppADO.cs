...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ProcessStatusCodeServiceAppADO : IProcessStatusCodeServiceAppADO
	{
		#region 仓储接口
		private readonly IProcessStatusCodeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ProcessStatusCodeServiceAppADO(IProcessStatusCodeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ProcessStatusCodeDTO dto)
		{
			return _repository.Add(Mapper.Map<ProcessStatusCode>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProcessStatusCodeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ProcessStatusCode>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ProcessStatusCodeDTO dto)
		{
			return _repository.Insert(Mapper.Map<ProcessStatusCode>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProcessStatusCodeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ProcessStatusCode>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProcessStatusCodeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProcessStatusCodeDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(flowID,processID,statusCode );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(flowID,processID,statusCode );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ProcessStatusCodeDTO dto)
		{
			return _repository.Update(Mapper.Map<ProcessStatusCode>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProcessStatusCodeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ProcessStatusCode>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ProcessStatusCodeDTO GetDTO(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			var entity = _repository.GetEntity(flowID,processID,statusCode );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProcessStatusCodeDTO> GetDTOAsync(System.Int32 flowID, System.Int32 processID, System.Int32 statusCode)
		{
			var entity = await _repository.GetEntityAsync(flowID,processID,statusCode );
			return Mapper.Map<ProcessStatusCodeDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProcessStatusCodeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProcessStatusCodeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProcessStatusCodeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProcessStatusCodeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ProcessStatusCodeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCodeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProcessStatusCodeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
