...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ShoppingCartsServiceAppADO : IShoppingCartsServiceAppADO
	{
		#region 仓储接口
		private readonly IShoppingCartsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ShoppingCartsServiceAppADO(IShoppingCartsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ShoppingCartsDTO dto)
		{
			return _repository.Add(Mapper.Map<ShoppingCarts>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ShoppingCartsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ShoppingCarts>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ShoppingCartsDTO dto)
		{
			return _repository.Insert(Mapper.Map<ShoppingCarts>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ShoppingCartsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ShoppingCarts>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ShoppingCartsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ShoppingCartsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(cartItemID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ShoppingCartsDTO dto)
		{
			return _repository.Update(Mapper.Map<ShoppingCarts>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ShoppingCartsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ShoppingCarts>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ShoppingCartsDTO GetDTO(System.Int32 cartItemID)
		{
			var entity = _repository.GetEntity(cartItemID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ShoppingCartsDTO> GetDTOAsync(System.Int32 cartItemID)
		{
			var entity = await _repository.GetEntityAsync(cartItemID );
			return Mapper.Map<ShoppingCartsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ShoppingCartsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ShoppingCartsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ShoppingCartsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ShoppingCartsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ShoppingCartsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCartsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCartsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
