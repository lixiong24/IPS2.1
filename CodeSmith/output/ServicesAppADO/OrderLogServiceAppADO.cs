...
namespace JX.Application
{
	...
	/// </summary>
	public partial class OrderLogServiceAppADO : IOrderLogServiceAppADO
	{
		#region 仓储接口
		private readonly IOrderLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public OrderLogServiceAppADO(IOrderLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(OrderLogDTO dto)
		{
			return _repository.Add(Mapper.Map<OrderLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<OrderLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<OrderLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<OrderLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(orderLogID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(orderLogID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderLogDTO dto)
		{
			return _repository.Update(Mapper.Map<OrderLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<OrderLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public OrderLogDTO GetDTO(System.Int32 orderLogID)
		{
			var entity = _repository.GetEntity(orderLogID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderLogDTO> GetDTOAsync(System.Int32 orderLogID)
		{
			var entity = await _repository.GetEntityAsync(orderLogID );
			return Mapper.Map<OrderLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<OrderLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
