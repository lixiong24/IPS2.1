...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatWeekServiceAppADO : IStatWeekServiceAppADO
	{
		#region 仓储接口
		private readonly IStatWeekRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatWeekServiceAppADO(IStatWeekRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatWeekDTO dto)
		{
			return _repository.Add(Mapper.Map<StatWeek>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeekDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatWeek>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeekDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatWeek>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeekDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatWeek>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeekDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeekDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tWeek );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tWeek );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeekDTO dto)
		{
			return _repository.Update(Mapper.Map<StatWeek>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeekDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatWeek>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatWeekDTO GetDTO(System.String tWeek)
		{
			var entity = _repository.GetEntity(tWeek );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeekDTO> GetDTOAsync(System.String tWeek)
		{
			var entity = await _repository.GetEntityAsync(tWeek );
			return Mapper.Map<StatWeekDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeekDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeekDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeekDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeekDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatWeekDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeekDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeekDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
