...
namespace JX.Application
{
	...
	/// </summary>
	public partial class InvoiceLogServiceAppADO : IInvoiceLogServiceAppADO
	{
		#region 仓储接口
		private readonly IInvoiceLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public InvoiceLogServiceAppADO(IInvoiceLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(InvoiceLogDTO dto)
		{
			return _repository.Add(Mapper.Map<InvoiceLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InvoiceLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<InvoiceLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(InvoiceLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<InvoiceLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(InvoiceLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<InvoiceLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(InvoiceLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(InvoiceLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(invoiceID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(invoiceID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(InvoiceLogDTO dto)
		{
			return _repository.Update(Mapper.Map<InvoiceLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(InvoiceLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<InvoiceLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public InvoiceLogDTO GetDTO(System.Int32 invoiceID)
		{
			var entity = _repository.GetEntity(invoiceID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InvoiceLogDTO> GetDTOAsync(System.Int32 invoiceID)
		{
			var entity = await _repository.GetEntityAsync(invoiceID );
			return Mapper.Map<InvoiceLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InvoiceLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<InvoiceLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InvoiceLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InvoiceLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<InvoiceLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InvoiceLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
