...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RegionServiceAppADO : IRegionServiceAppADO
	{
		#region 仓储接口
		private readonly IRegionRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RegionServiceAppADO(IRegionRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RegionDTO dto)
		{
			return _repository.Add(Mapper.Map<Region>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RegionDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Region>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RegionDTO dto)
		{
			return _repository.Insert(Mapper.Map<Region>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RegionDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Region>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RegionDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RegionDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(regionID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(regionID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RegionDTO dto)
		{
			return _repository.Update(Mapper.Map<Region>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RegionDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Region>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RegionDTO GetDTO(System.Int32 regionID)
		{
			var entity = _repository.GetEntity(regionID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RegionDTO> GetDTOAsync(System.Int32 regionID)
		{
			var entity = await _repository.GetEntityAsync(regionID );
			return Mapper.Map<RegionDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RegionDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RegionDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RegionDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RegionDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RegionDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RegionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RegionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
