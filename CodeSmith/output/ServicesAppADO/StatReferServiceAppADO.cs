...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatReferServiceAppADO : IStatReferServiceAppADO
	{
		#region 仓储接口
		private readonly IStatReferRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatReferServiceAppADO(IStatReferRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatReferDTO dto)
		{
			return _repository.Add(Mapper.Map<StatRefer>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatReferDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatRefer>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatReferDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatRefer>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatReferDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatRefer>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatReferDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatReferDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tRefer );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tRefer );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatReferDTO dto)
		{
			return _repository.Update(Mapper.Map<StatRefer>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatReferDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatRefer>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatReferDTO GetDTO(System.String tRefer)
		{
			var entity = _repository.GetEntity(tRefer );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatReferDTO> GetDTOAsync(System.String tRefer)
		{
			var entity = await _repository.GetEntityAsync(tRefer );
			return Mapper.Map<StatReferDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatReferDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatReferDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatReferDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatReferDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatReferDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatReferDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatReferDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
