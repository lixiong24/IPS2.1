...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StockServiceAppADO : IStockServiceAppADO
	{
		#region 仓储接口
		private readonly IStockRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StockServiceAppADO(IStockRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StockDTO dto)
		{
			return _repository.Add(Mapper.Map<Stock>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Stock>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StockDTO dto)
		{
			return _repository.Insert(Mapper.Map<Stock>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Stock>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(stockID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(stockID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StockDTO dto)
		{
			return _repository.Update(Mapper.Map<Stock>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Stock>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StockDTO GetDTO(System.Int32 stockID)
		{
			var entity = _repository.GetEntity(stockID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockDTO> GetDTOAsync(System.Int32 stockID)
		{
			var entity = await _repository.GetEntityAsync(stockID );
			return Mapper.Map<StockDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StockDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
