...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SpecialCategoryServiceAppADO : ISpecialCategoryServiceAppADO
	{
		#region 仓储接口
		private readonly ISpecialCategoryRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SpecialCategoryServiceAppADO(ISpecialCategoryRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SpecialCategoryDTO dto)
		{
			return _repository.Add(Mapper.Map<SpecialCategory>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialCategoryDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SpecialCategory>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialCategoryDTO dto)
		{
			return _repository.Insert(Mapper.Map<SpecialCategory>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialCategoryDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SpecialCategory>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialCategoryDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialCategoryDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(specialCategoryID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(specialCategoryID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialCategoryDTO dto)
		{
			return _repository.Update(Mapper.Map<SpecialCategory>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialCategoryDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SpecialCategory>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SpecialCategoryDTO GetDTO(System.Int32 specialCategoryID)
		{
			var entity = _repository.GetEntity(specialCategoryID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialCategoryDTO> GetDTOAsync(System.Int32 specialCategoryID)
		{
			var entity = await _repository.GetEntityAsync(specialCategoryID );
			return Mapper.Map<SpecialCategoryDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialCategoryDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialCategoryDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialCategoryDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialCategoryDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SpecialCategoryDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
