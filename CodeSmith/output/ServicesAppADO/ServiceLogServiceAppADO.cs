...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ServiceLogServiceAppADO : IServiceLogServiceAppADO
	{
		#region 仓储接口
		private readonly IServiceLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ServiceLogServiceAppADO(IServiceLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ServiceLogDTO dto)
		{
			return _repository.Add(Mapper.Map<ServiceLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ServiceLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ServiceLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ServiceLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<ServiceLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ServiceLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ServiceLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ServiceLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ServiceLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ServiceLogDTO dto)
		{
			return _repository.Update(Mapper.Map<ServiceLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ServiceLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ServiceLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ServiceLogDTO GetDTO(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ServiceLogDTO> GetDTOAsync(System.Int32 itemID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ServiceLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ServiceLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ServiceLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ServiceLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ServiceLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ServiceLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ServiceLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
