...
namespace JX.Application
{
	...
	/// </summary>
	public partial class U_AwardLogServiceAppADO : IU_AwardLogServiceAppADO
	{
		#region 仓储接口
		private readonly IU_AwardLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public U_AwardLogServiceAppADO(IU_AwardLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(U_AwardLogDTO dto)
		{
			return _repository.Add(Mapper.Map<U_AwardLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_AwardLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<U_AwardLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(U_AwardLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<U_AwardLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_AwardLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<U_AwardLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_AwardLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_AwardLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(U_AwardLogDTO dto)
		{
			return _repository.Update(Mapper.Map<U_AwardLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_AwardLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<U_AwardLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public U_AwardLogDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_AwardLogDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_AwardLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_AwardLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_AwardLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_AwardLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<U_AwardLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_AwardLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_AwardLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
