...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionListRulesServiceAppADO : ICollectionListRulesServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionListRulesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionListRulesServiceAppADO(ICollectionListRulesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionListRulesDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionListRules>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionListRulesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionListRules>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionListRulesDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionListRules>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionListRulesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionListRules>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionListRulesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionListRulesDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionListRulesDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionListRules>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionListRulesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionListRules>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionListRulesDTO GetDTO(System.Int32 itemID)
		{
			var entity = _repository.GetEntity(itemID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionListRulesDTO> GetDTOAsync(System.Int32 itemID)
		{
			var entity = await _repository.GetEntityAsync(itemID );
			return Mapper.Map<CollectionListRulesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionListRulesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionListRulesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionListRulesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionListRulesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionListRulesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionListRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionListRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
