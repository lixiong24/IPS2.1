...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ContentPermissionServiceAppADO : IContentPermissionServiceAppADO
	{
		#region 仓储接口
		private readonly IContentPermissionRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ContentPermissionServiceAppADO(IContentPermissionRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ContentPermissionDTO dto)
		{
			return _repository.Add(Mapper.Map<ContentPermission>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ContentPermissionDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ContentPermission>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ContentPermissionDTO dto)
		{
			return _repository.Insert(Mapper.Map<ContentPermission>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ContentPermissionDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ContentPermission>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ContentPermissionDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ContentPermissionDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(generalID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(generalID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ContentPermissionDTO dto)
		{
			return _repository.Update(Mapper.Map<ContentPermission>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ContentPermissionDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ContentPermission>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ContentPermissionDTO GetDTO(System.Int32 generalID)
		{
			var entity = _repository.GetEntity(generalID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ContentPermissionDTO> GetDTOAsync(System.Int32 generalID)
		{
			var entity = await _repository.GetEntityAsync(generalID );
			return Mapper.Map<ContentPermissionDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ContentPermissionDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ContentPermissionDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ContentPermissionDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ContentPermissionDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ContentPermissionDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentPermissionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ContentPermissionDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
