...
namespace JX.Application
{
	...
	/// </summary>
	public partial class LogServiceAppADO : ILogServiceAppADO
	{
		#region 仓储接口
		private readonly ILogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public LogServiceAppADO(ILogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(LogDTO dto)
		{
			return _repository.Add(Mapper.Map<Log>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(LogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Log>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(LogDTO dto)
		{
			return _repository.Insert(Mapper.Map<Log>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(LogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Log>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(LogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(LogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(LogDTO dto)
		{
			return _repository.Update(Mapper.Map<Log>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(LogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Log>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public LogDTO GetDTO(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<LogDTO> GetDTOAsync(System.Int32 logID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual LogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<LogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<LogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<LogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<LogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<LogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<LogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
