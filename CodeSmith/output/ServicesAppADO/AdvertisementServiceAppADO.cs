...
namespace JX.Application
{
	...
	/// </summary>
	public partial class AdvertisementServiceAppADO : IAdvertisementServiceAppADO
	{
		#region 仓储接口
		private readonly IAdvertisementRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public AdvertisementServiceAppADO(IAdvertisementRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(AdvertisementDTO dto)
		{
			return _repository.Add(Mapper.Map<Advertisement>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdvertisementDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Advertisement>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AdvertisementDTO dto)
		{
			return _repository.Insert(Mapper.Map<Advertisement>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdvertisementDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Advertisement>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdvertisementDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdvertisementDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(adid );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AdvertisementDTO dto)
		{
			return _repository.Update(Mapper.Map<Advertisement>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdvertisementDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Advertisement>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AdvertisementDTO GetDTO(System.Int32 adid)
		{
			var entity = _repository.GetEntity(adid );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdvertisementDTO> GetDTOAsync(System.Int32 adid)
		{
			var entity = await _repository.GetEntityAsync(adid );
			return Mapper.Map<AdvertisementDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdvertisementDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdvertisementDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdvertisementDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdvertisementDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AdvertisementDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
