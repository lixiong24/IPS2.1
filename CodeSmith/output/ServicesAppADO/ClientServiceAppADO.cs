...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ClientServiceAppADO : IClientServiceAppADO
	{
		#region 仓储接口
		private readonly IClientRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ClientServiceAppADO(IClientRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ClientDTO dto)
		{
			return _repository.Add(Mapper.Map<Client>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClientDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Client>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ClientDTO dto)
		{
			return _repository.Insert(Mapper.Map<Client>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ClientDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Client>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ClientDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ClientDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(clientID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ClientDTO dto)
		{
			return _repository.Update(Mapper.Map<Client>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ClientDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Client>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ClientDTO GetDTO(System.Int32 clientID)
		{
			var entity = _repository.GetEntity(clientID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClientDTO> GetDTOAsync(System.Int32 clientID)
		{
			var entity = await _repository.GetEntityAsync(clientID );
			return Mapper.Map<ClientDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClientDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ClientDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClientDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClientDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ClientDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
