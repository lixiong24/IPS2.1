...
namespace JX.Application
{
	...
	/// </summary>
	public partial class AddressServiceAppADO : IAddressServiceAppADO
	{
		#region 仓储接口
		private readonly IAddressRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public AddressServiceAppADO(IAddressRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(AddressDTO dto)
		{
			return _repository.Add(Mapper.Map<Address>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AddressDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Address>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AddressDTO dto)
		{
			return _repository.Insert(Mapper.Map<Address>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AddressDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Address>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AddressDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AddressDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(addressID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AddressDTO dto)
		{
			return _repository.Update(Mapper.Map<Address>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AddressDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Address>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AddressDTO GetDTO(System.Int32 addressID)
		{
			var entity = _repository.GetEntity(addressID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AddressDTO> GetDTOAsync(System.Int32 addressID)
		{
			var entity = await _repository.GetEntityAsync(addressID );
			return Mapper.Map<AddressDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AddressDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AddressDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AddressDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AddressDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AddressDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AddressDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AddressDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
