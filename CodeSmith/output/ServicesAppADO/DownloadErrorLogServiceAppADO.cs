...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DownloadErrorLogServiceAppADO : IDownloadErrorLogServiceAppADO
	{
		#region 仓储接口
		private readonly IDownloadErrorLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DownloadErrorLogServiceAppADO(IDownloadErrorLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DownloadErrorLogDTO dto)
		{
			return _repository.Add(Mapper.Map<DownloadErrorLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownloadErrorLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<DownloadErrorLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DownloadErrorLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<DownloadErrorLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DownloadErrorLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<DownloadErrorLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownloadErrorLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownloadErrorLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(errorID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(errorID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DownloadErrorLogDTO dto)
		{
			return _repository.Update(Mapper.Map<DownloadErrorLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownloadErrorLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<DownloadErrorLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DownloadErrorLogDTO GetDTO(System.Int32 errorID)
		{
			var entity = _repository.GetEntity(errorID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DownloadErrorLogDTO> GetDTOAsync(System.Int32 errorID)
		{
			var entity = await _repository.GetEntityAsync(errorID );
			return Mapper.Map<DownloadErrorLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DownloadErrorLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DownloadErrorLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DownloadErrorLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DownloadErrorLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DownloadErrorLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownloadErrorLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
