...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatYearServiceAppADO : IStatYearServiceAppADO
	{
		#region 仓储接口
		private readonly IStatYearRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatYearServiceAppADO(IStatYearRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatYearDTO dto)
		{
			return _repository.Add(Mapper.Map<StatYear>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatYearDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatYear>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatYearDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatYear>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatYearDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatYear>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatYearDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatYearDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tYear );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tYear );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatYearDTO dto)
		{
			return _repository.Update(Mapper.Map<StatYear>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatYearDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatYear>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatYearDTO GetDTO(System.String tYear)
		{
			var entity = _repository.GetEntity(tYear );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatYearDTO> GetDTOAsync(System.String tYear)
		{
			var entity = await _repository.GetEntityAsync(tYear );
			return Mapper.Map<StatYearDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatYearDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatYearDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatYearDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatYearDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatYearDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYearDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYearDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
