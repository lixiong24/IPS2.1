...
namespace JX.Application
{
	...
	/// </summary>
	public partial class GroupNodePermissionsServiceAppADO : IGroupNodePermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IGroupNodePermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public GroupNodePermissionsServiceAppADO(IGroupNodePermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(GroupNodePermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<GroupNodePermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupNodePermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<GroupNodePermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupNodePermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<GroupNodePermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupNodePermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<GroupNodePermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupNodePermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupNodePermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(groupID,operateCode,nodeID,idType );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(groupID,operateCode,nodeID,idType );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupNodePermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<GroupNodePermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupNodePermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<GroupNodePermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public GroupNodePermissionsDTO GetDTO(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			var entity = _repository.GetEntity(groupID,operateCode,nodeID,idType );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupNodePermissionsDTO> GetDTOAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 nodeID, System.Int32 idType)
		{
			var entity = await _repository.GetEntityAsync(groupID,operateCode,nodeID,idType );
			return Mapper.Map<GroupNodePermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupNodePermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupNodePermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupNodePermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupNodePermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<GroupNodePermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupNodePermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
