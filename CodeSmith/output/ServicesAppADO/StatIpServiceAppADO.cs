...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatIpServiceAppADO : IStatIpServiceAppADO
	{
		#region 仓储接口
		private readonly IStatIpRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatIpServiceAppADO(IStatIpRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatIpDTO dto)
		{
			return _repository.Add(Mapper.Map<StatIp>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatIpDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatIp>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatIpDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatIp>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatIpDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatIp>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatIpDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatIpDTO dto, bool IsSave)
		{
		...
		{
			return await _repository.DeleteAsync(tIp );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatIpDTO dto)
		{
			return _repository.Update(Mapper.Map<StatIp>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatIpDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatIp>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatIpDTO GetDTO(System.String tIp)
		{
			var entity = _repository.GetEntity(tIp );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatIpDTO> GetDTOAsync(System.String tIp)
		{
			var entity = await _repository.GetEntityAsync(tIp );
			return Mapper.Map<StatIpDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatIpDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatIpDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatIpDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatIpDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatIpDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
