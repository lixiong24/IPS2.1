...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionFieldRulesServiceAppADO : ICollectionFieldRulesServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionFieldRulesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionFieldRulesServiceAppADO(ICollectionFieldRulesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFieldRulesDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionFieldRules>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFieldRulesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionFieldRules>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFieldRulesDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionFieldRules>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFieldRulesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionFieldRules>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFieldRulesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFieldRulesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(fieldRuleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(fieldRuleID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFieldRulesDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionFieldRules>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFieldRulesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionFieldRules>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFieldRulesDTO GetDTO(System.Int32 fieldRuleID)
		{
			var entity = _repository.GetEntity(fieldRuleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFieldRulesDTO> GetDTOAsync(System.Int32 fieldRuleID)
		{
			var entity = await _repository.GetEntityAsync(fieldRuleID );
			return Mapper.Map<CollectionFieldRulesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFieldRulesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFieldRulesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFieldRulesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFieldRulesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionFieldRulesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRulesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
