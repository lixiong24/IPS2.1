...
namespace JX.Application
{
	...
	/// </summary>
	public partial class KeywordsServiceAppADO : IKeywordsServiceAppADO
	{
		#region 仓储接口
		private readonly IKeywordsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public KeywordsServiceAppADO(IKeywordsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(KeywordsDTO dto)
		{
			return _repository.Add(Mapper.Map<Keywords>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(KeywordsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Keywords>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(KeywordsDTO dto)
		{
			return _repository.Insert(Mapper.Map<Keywords>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(KeywordsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Keywords>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(KeywordsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(KeywordsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(keywordID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(keywordID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(KeywordsDTO dto)
		{
			return _repository.Update(Mapper.Map<Keywords>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(KeywordsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Keywords>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public KeywordsDTO GetDTO(System.Int32 keywordID)
		{
			var entity = _repository.GetEntity(keywordID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<KeywordsDTO> GetDTOAsync(System.Int32 keywordID)
		{
			var entity = await _repository.GetEntityAsync(keywordID );
			return Mapper.Map<KeywordsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual KeywordsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<KeywordsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<KeywordsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<KeywordsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<KeywordsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
