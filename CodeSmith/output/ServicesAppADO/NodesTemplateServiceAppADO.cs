...
namespace JX.Application
{
	...
	/// </summary>
	public partial class NodesTemplateServiceAppADO : INodesTemplateServiceAppADO
	{
		#region 仓储接口
		private readonly INodesTemplateRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public NodesTemplateServiceAppADO(INodesTemplateRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(NodesTemplateDTO dto)
		{
			return _repository.Add(Mapper.Map<NodesTemplate>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesTemplateDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<NodesTemplate>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesTemplateDTO dto)
		{
			return _repository.Insert(Mapper.Map<NodesTemplate>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesTemplateDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<NodesTemplate>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesTemplateDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesTemplateDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(nodeID,templateID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(nodeID,templateID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesTemplateDTO dto)
		{
			return _repository.Update(Mapper.Map<NodesTemplate>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesTemplateDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<NodesTemplate>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public NodesTemplateDTO GetDTO(System.Int32 nodeID, System.Int32 templateID)
		{
			var entity = _repository.GetEntity(nodeID,templateID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesTemplateDTO> GetDTOAsync(System.Int32 nodeID, System.Int32 templateID)
		{
			var entity = await _repository.GetEntityAsync(nodeID,templateID );
			return Mapper.Map<NodesTemplateDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesTemplateDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesTemplateDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesTemplateDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesTemplateDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<NodesTemplateDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplateDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesTemplateDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
