...
namespace JX.Application
{
	...
	/// </summary>
	public partial class U_IntegralProductLogServiceAppADO : IU_IntegralProductLogServiceAppADO
	{
		#region 仓储接口
		private readonly IU_IntegralProductLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public U_IntegralProductLogServiceAppADO(IU_IntegralProductLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(U_IntegralProductLogDTO dto)
		{
			return _repository.Add(Mapper.Map<U_IntegralProductLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_IntegralProductLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<U_IntegralProductLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(U_IntegralProductLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<U_IntegralProductLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(U_IntegralProductLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<U_IntegralProductLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_IntegralProductLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_IntegralProductLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(U_IntegralProductLogDTO dto)
		{
			return _repository.Update(Mapper.Map<U_IntegralProductLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_IntegralProductLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<U_IntegralProductLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public U_IntegralProductLogDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<U_IntegralProductLogDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual U_IntegralProductLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<U_IntegralProductLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<U_IntegralProductLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<U_IntegralProductLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<U_IntegralProductLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<U_IntegralProductLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
