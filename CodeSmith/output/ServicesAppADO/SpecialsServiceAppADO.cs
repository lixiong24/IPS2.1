...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SpecialsServiceAppADO : ISpecialsServiceAppADO
	{
		#region 仓储接口
		private readonly ISpecialsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SpecialsServiceAppADO(ISpecialsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SpecialsDTO dto)
		{
			return _repository.Add(Mapper.Map<Specials>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Specials>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialsDTO dto)
		{
			return _repository.Insert(Mapper.Map<Specials>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Specials>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(specialID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(specialID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialsDTO dto)
		{
			return _repository.Update(Mapper.Map<Specials>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Specials>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SpecialsDTO GetDTO(System.Int32 specialID)
		{
			var entity = _repository.GetEntity(specialID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialsDTO> GetDTOAsync(System.Int32 specialID)
		{
			var entity = await _repository.GetEntityAsync(specialID );
			return Mapper.Map<SpecialsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SpecialsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
