...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ComplaintsTypeServiceAppADO : IComplaintsTypeServiceAppADO
	{
		#region 仓储接口
		private readonly IComplaintsTypeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ComplaintsTypeServiceAppADO(IComplaintsTypeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsTypeDTO dto)
		{
			return _repository.Add(Mapper.Map<ComplaintsType>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsTypeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ComplaintsType>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsTypeDTO dto)
		{
			return _repository.Insert(Mapper.Map<ComplaintsType>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsTypeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ComplaintsType>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsTypeDTO dto, bool IsSave)
		{
		...
		{
			return await _repository.DeleteAsync(cid );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsTypeDTO dto)
		{
			return _repository.Update(Mapper.Map<ComplaintsType>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsTypeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ComplaintsType>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsTypeDTO GetDTO(System.Int32 cid)
		{
			var entity = _repository.GetEntity(cid );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsTypeDTO> GetDTOAsync(System.Int32 cid)
		{
			var entity = await _repository.GetEntityAsync(cid );
			return Mapper.Map<ComplaintsTypeDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsTypeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsTypeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsTypeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsTypeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ComplaintsTypeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
