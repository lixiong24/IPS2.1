...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SurveyVoteServiceAppADO : ISurveyVoteServiceAppADO
	{
		#region 仓储接口
		private readonly ISurveyVoteRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SurveyVoteServiceAppADO(ISurveyVoteRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SurveyVoteDTO dto)
		{
			return _repository.Add(Mapper.Map<SurveyVote>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SurveyVoteDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SurveyVote>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SurveyVoteDTO dto)
		{
			return _repository.Insert(Mapper.Map<SurveyVote>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SurveyVoteDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SurveyVote>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SurveyVoteDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SurveyVoteDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SurveyVoteDTO dto)
		{
			return _repository.Update(Mapper.Map<SurveyVote>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SurveyVoteDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SurveyVote>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SurveyVoteDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SurveyVoteDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SurveyVoteDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SurveyVoteDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SurveyVoteDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SurveyVoteDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SurveyVoteDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVoteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVoteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
