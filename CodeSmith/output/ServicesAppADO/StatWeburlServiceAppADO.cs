...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatWeburlServiceAppADO : IStatWeburlServiceAppADO
	{
		#region 仓储接口
		private readonly IStatWeburlRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatWeburlServiceAppADO(IStatWeburlRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatWeburlDTO dto)
		{
			return _repository.Add(Mapper.Map<StatWeburl>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeburlDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatWeburl>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeburlDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatWeburl>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeburlDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatWeburl>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeburlDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeburlDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tWeburl );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tWeburl );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeburlDTO dto)
		{
			return _repository.Update(Mapper.Map<StatWeburl>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeburlDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatWeburl>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatWeburlDTO GetDTO(System.String tWeburl)
		{
			var entity = _repository.GetEntity(tWeburl );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeburlDTO> GetDTOAsync(System.String tWeburl)
		{
			var entity = await _repository.GetEntityAsync(tWeburl );
			return Mapper.Map<StatWeburlDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeburlDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeburlDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeburlDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeburlDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatWeburlDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburlDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburlDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
