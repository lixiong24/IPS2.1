...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ClientLogServiceAppADO : IClientLogServiceAppADO
	{
		#region 仓储接口
		private readonly IClientLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ClientLogServiceAppADO(IClientLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ClientLogDTO dto)
		{
			return _repository.Add(Mapper.Map<ClientLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClientLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ClientLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ClientLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<ClientLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ClientLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ClientLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ClientLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ClientLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(clientLogID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(clientLogID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ClientLogDTO dto)
		{
			return _repository.Update(Mapper.Map<ClientLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ClientLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ClientLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ClientLogDTO GetDTO(System.Int32 clientLogID)
		{
			var entity = _repository.GetEntity(clientLogID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClientLogDTO> GetDTOAsync(System.Int32 clientLogID)
		{
			var entity = await _repository.GetEntityAsync(clientLogID );
			return Mapper.Map<ClientLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClientLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ClientLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClientLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClientLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ClientLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
