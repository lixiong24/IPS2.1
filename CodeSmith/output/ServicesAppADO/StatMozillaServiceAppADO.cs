...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatMozillaServiceAppADO : IStatMozillaServiceAppADO
	{
		#region 仓储接口
		private readonly IStatMozillaRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatMozillaServiceAppADO(IStatMozillaRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatMozillaDTO dto)
		{
			return _repository.Add(Mapper.Map<StatMozilla>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatMozillaDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatMozilla>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatMozillaDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatMozilla>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatMozillaDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatMozilla>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatMozillaDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatMozillaDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tMozilla );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tMozilla );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatMozillaDTO dto)
		{
			return _repository.Update(Mapper.Map<StatMozilla>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatMozillaDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatMozilla>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatMozillaDTO GetDTO(System.String tMozilla)
		{
			var entity = _repository.GetEntity(tMozilla );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatMozillaDTO> GetDTOAsync(System.String tMozilla)
		{
			var entity = await _repository.GetEntityAsync(tMozilla );
			return Mapper.Map<StatMozillaDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatMozillaDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatMozillaDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatMozillaDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatMozillaDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatMozillaDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozillaDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozillaDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
