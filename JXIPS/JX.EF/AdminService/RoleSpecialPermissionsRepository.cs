...
namespace JX.EF.Repository
{
	...
	/// </summary>
	public partial class RoleSpecialPermissionsRepository : Repository<RoleSpecialPermissions>, IRoleSpecialPermissionsRepository
	{
		/// <summary>
		/// 移除指定角色的指定专题的权限
		/// </summary>
		...
		{
			Expression<Func<RoleSpecialPermissions, bool>> predicate = p => 1 == 1;
			if (roleID > 0)
			{
