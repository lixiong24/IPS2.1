...
namespace JX.EF.Repository
{
	...
	/// </summary>
	public partial class RoleNodePermissionsRepository : Repository<RoleNodePermissions>, IRoleNodePermissionsRepository
	{
		/// <summary>
		/// 移除指定角色的指定节点的权限
		/// </summary>
		...
		{
			Expression<Func<RoleNodePermissions, bool>> predicate = p => 1 == 1;
			if (roleID >= 0)
			{
