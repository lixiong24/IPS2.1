...
namespace JX.EF.Repository
{
	...
	/// </summary>
	public partial class RoleFieldPermissionsRepository : Repository<RoleFieldPermissions>, IRoleFieldPermissionsRepository
	{
		/// <summary>
		/// 移除指定角色的指定模型字段的权限
		/// </summary>
		...
		{
			Expression<Func<RoleFieldPermissions, bool>> predicate = p=>1==1;
			if (roleId >= 0)
			{
