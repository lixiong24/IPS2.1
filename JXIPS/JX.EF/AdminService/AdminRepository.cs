...
namespace JX.EF.Repository
{
	...
	/// 数据库表：Admin 的仓储实现类.
	/// </summary>
	public partial class AdminRepository : Repository<Admin>, IAdminRepository
	{
		#region 是否存在
		/// <summary>
		/// 检查用户名是否存在
		...
		/// <param name="adminName"></param>
		/// <returns></returns>
		public async Task<Admin> GetEntityByAdminNameAsync(string adminName)
		{
		...
		/// <returns></returns>
		public async Task<Admin> GetEntityAsync(string adminName, string adminPassword)
		{
		...
		/// </summary>
		/// <returns></returns>
		public Admin GetEntityFull(System.Int32 adminID)
		{
			if (adminID <= 0)
				return null;
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Admin> GetEntityFullAsync(System.Int32 adminID)
		{
			if (adminID <= 0)
				return null;
		...
		/// <returns></returns>
		public virtual Admin GetEntityFull(Expression<Func<Admin, bool>> predicate)
		{
		...
		/// <param name="predicate"></param>
		/// <returns></returns>
		public virtual async Task<Admin> GetEntityFullAsync(Expression<Func<Admin, bool>> predicate)
		{
		...
		/// <returns></returns>
		public Admin GetAdminFull(Admin admin)
		{
			if (admin == null)
				return admin;
			...
			var queryResult = SqlQuery<Roles>(strSQL, new SqlParameter("AdminID", admin.AdminID));
		...
		/// <param name="predicate"></param>
		/// <returns></returns>
		public virtual IList<Admin> GetEntityFullList(Expression<Func<Admin, bool>> predicate)
		{
			IList<Admin> list = LoadListAll(predicate);
		...
		/// <param name="predicate"></param>
		/// <returns></returns>
		public virtual async Task<IList<Admin>> GetEntityFullListAsync(Expression<Func<Admin, bool>> predicate)
		{
			IList<Admin> list = await LoadListAllAsync(predicate);
			list.ToList().ForEach(item => {
				GetAdminFull(item);
			});
			return list;
		...
		{
			Admin admin = await GetEntityByAdminNameAsync(adminName);
