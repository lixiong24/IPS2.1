...
namespace JX.Application.CommonService
{
	...
	public static class AdminStatusValidator
    {
		...
		public static async Task ValidateAsync(CookieValidatePrincipalContext context)
		{
			...
			//var appAdminService = context.HttpContext.RequestServices.GetRequiredService<IAdminServiceAppADO>();
			...
			var RndPassword = (from c in userPrincipal.Claims
								...
								select c.Value).FirstOrDefault();
			//var adminDTO = appAdminService.GetDTO(DataConverter.CLng(adminID));
