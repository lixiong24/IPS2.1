...
namespace JX.Application
{
	...
	public partial class GroupSpecialCategoryPermissionsServiceApp : IGroupSpecialCategoryPermissionsServiceApp
	{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> scalar, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null, Expression<Func<GroupSpecialCategoryPermissionsDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> scalar, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null, Expression<Func<GroupSpecialCategoryPermissionsDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> max, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> max, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> min, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> min, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<GroupSpecialCategoryPermissionsDTO, decimal>> avg, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, decimal>> avg, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<GroupSpecialCategoryPermissionsDTO, decimal>> sum, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, decimal>> sum, Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			
			return _repository.Add(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		/// <summary>
		/// 增加一条记录(异步方式)
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			
			return await _repository.AddAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialCategoryPermissionsDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialCategoryPermissionsDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			if (dto == null) return false;
			return _repository.Delete(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		/// <summary>
		/// 删除一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			if (dto == null) return await Task.Run(() => false);

			return await _repository.DeleteAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.DeleteList(Mapper.Map<IList<GroupSpecialCategoryPermissions>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 删除多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.DeleteListAsync(Mapper.Map<IList<GroupSpecialCategoryPermissions>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			return _repository.Update(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialCategoryPermissionsDTO dto, bool IsCommit = true)
		{
			return await _repository.UpdateAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.UpdateList(Mapper.Map<IList<GroupSpecialCategoryPermissions>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 更新多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<GroupSpecialCategoryPermissionsDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.UpdateListAsync(Mapper.Map<IList<GroupSpecialCategoryPermissions>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual GroupSpecialCategoryPermissionsDTO Get(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate)
		{
			var entity = _repository.Get(GetEntityLamada(predicate));
			return Mapper.Map<GroupSpecialCategoryPermissionsDTO>(entity);
		}
		/// <summary>
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialCategoryPermissionsDTO> GetAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<GroupSpecialCategoryPermissionsDTO> LoadAll(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<IQueryable<GroupSpecialCategoryPermissionsDTO>>(entity);
		}
		/// <summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<GroupSpecialCategoryPermissionsDTO>> LoadAllAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<GroupSpecialCategoryPermissionsDTO> LoadListAll(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadListAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<List<GroupSpecialCategoryPermissionsDTO>>(entity);
		}
		/// <summary>
		/// 返回集合,不采用延时加载（异步方式）
		/// </summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<GroupSpecialCategoryPermissionsDTO>> LoadListAllAsync(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<GroupSpecialCategoryPermissionsDTO> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<GroupSpecialCategoryPermissionsDTO>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<GroupSpecialCategoryPermissionsDTO> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<GroupSpecialCategoryPermissionsDTO>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> scalar, params DbParameter[] para)
		{
			return await _repository.GetBySQLAsync<TResult>(sql, GetEntityLamada(scalar),para);
		}
		#endregion
		
		private Expression<Func<GroupSpecialCategoryPermissions, bool>> GetEntityLamada(Expression<Func<GroupSpecialCategoryPermissionsDTO, bool>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<GroupSpecialCategoryPermissions, bool>> lamada = predicate.Cast<GroupSpecialCategoryPermissionsDTO, GroupSpecialCategoryPermissions>();
			return lamada;
		}
		private Expression<Func<GroupSpecialCategoryPermissions, TResult>> GetEntityLamada<TResult>(Expression<Func<GroupSpecialCategoryPermissionsDTO, TResult>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<GroupSpecialCategoryPermissions, TResult>> lamada = predicate.Cast<GroupSpecialCategoryPermissionsDTO, GroupSpecialCategoryPermissions,TResult>();
			return lamada;
		}
	}
}