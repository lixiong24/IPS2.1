...
namespace JX.Application
{
	...
	public partial class StatKeywordServiceApp : IStatKeywordServiceApp
	{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<StatKeywordDTO, TResult>> scalar, Expression<Func<StatKeywordDTO, bool>> predicate = null, Expression<Func<StatKeywordDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<StatKeywordDTO, TResult>> scalar, Expression<Func<StatKeywordDTO, bool>> predicate = null, Expression<Func<StatKeywordDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<StatKeywordDTO, TResult>> max, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<StatKeywordDTO, TResult>> max, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<StatKeywordDTO, TResult>> min, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<StatKeywordDTO, TResult>> min, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<StatKeywordDTO, decimal>> avg, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<StatKeywordDTO, decimal>> avg, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<StatKeywordDTO, decimal>> sum, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<StatKeywordDTO, decimal>> sum, Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<StatKeywordDTO, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<StatKeywordDTO, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<StatKeywordDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatKeywordDTO dto, bool IsCommit = true)
		{
			
			return _repository.Add(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		/// <summary>
		/// 增加一条记录(异步方式)
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatKeywordDTO dto, bool IsCommit = true)
		{
			
			return await _repository.AddAsync(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatKeywordDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatKeywordDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(StatKeywordDTO dto, bool IsCommit = true)
		{
			if (dto == null) return false;
			return _repository.Delete(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		/// <summary>
		/// 删除一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(StatKeywordDTO dto, bool IsCommit = true)
		{
			if (dto == null) return await Task.Run(() => false);

			return await _repository.DeleteAsync(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.DeleteList(Mapper.Map<IList<StatKeyword>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 删除多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.DeleteListAsync(Mapper.Map<IList<StatKeyword>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<StatKeywordDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<StatKeywordDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(StatKeywordDTO dto, bool IsCommit = true)
		{
			return _repository.Update(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatKeywordDTO dto, bool IsCommit = true)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatKeyword>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.UpdateList(Mapper.Map<IList<StatKeyword>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 更新多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<StatKeywordDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.UpdateListAsync(Mapper.Map<IList<StatKeyword>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual StatKeywordDTO Get(Expression<Func<StatKeywordDTO, bool>> predicate)
		{
			var entity = _repository.Get(GetEntityLamada(predicate));
			return Mapper.Map<StatKeywordDTO>(entity);
		}
		/// <summary>
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<StatKeywordDTO> GetAsync(Expression<Func<StatKeywordDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<StatKeywordDTO> LoadAll(Expression<Func<StatKeywordDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<IQueryable<StatKeywordDTO>>(entity);
		}
		/// <summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<StatKeywordDTO>> LoadAllAsync(Expression<Func<StatKeywordDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<StatKeywordDTO> LoadListAll(Expression<Func<StatKeywordDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadListAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<List<StatKeywordDTO>>(entity);
		}
		/// <summary>
		/// 返回集合,不采用延时加载（异步方式）
		/// </summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<StatKeywordDTO>> LoadListAllAsync(Expression<Func<StatKeywordDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<StatKeywordDTO> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<StatKeywordDTO>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<StatKeywordDTO> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<StatKeywordDTO>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<StatKeywordDTO> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatKeywordDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<StatKeywordDTO, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<StatKeywordDTO, TResult>> scalar, params DbParameter[] para)
		{
			return await _repository.GetBySQLAsync<TResult>(sql, GetEntityLamada(scalar),para);
		}
		#endregion
		
		private Expression<Func<StatKeyword, bool>> GetEntityLamada(Expression<Func<StatKeywordDTO, bool>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<StatKeyword, bool>> lamada = predicate.Cast<StatKeywordDTO, StatKeyword>();
			return lamada;
		}
		private Expression<Func<StatKeyword, TResult>> GetEntityLamada<TResult>(Expression<Func<StatKeywordDTO, TResult>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<StatKeyword, TResult>> lamada = predicate.Cast<StatKeywordDTO, StatKeyword,TResult>();
			return lamada;
		}
	}
}