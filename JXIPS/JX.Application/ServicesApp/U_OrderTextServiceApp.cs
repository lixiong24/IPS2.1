...
namespace JX.Application
{
	...
	public partial class U_OrderTextServiceApp : IU_OrderTextServiceApp
	{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<U_OrderTextDTO, TResult>> scalar, Expression<Func<U_OrderTextDTO, bool>> predicate = null, Expression<Func<U_OrderTextDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<U_OrderTextDTO, TResult>> scalar, Expression<Func<U_OrderTextDTO, bool>> predicate = null, Expression<Func<U_OrderTextDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<U_OrderTextDTO, TResult>> max, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<U_OrderTextDTO, TResult>> max, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<U_OrderTextDTO, TResult>> min, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<U_OrderTextDTO, TResult>> min, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<U_OrderTextDTO, decimal>> avg, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<U_OrderTextDTO, decimal>> avg, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<U_OrderTextDTO, decimal>> sum, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<U_OrderTextDTO, decimal>> sum, Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<U_OrderTextDTO, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<U_OrderTextDTO, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<U_OrderTextDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(U_OrderTextDTO dto, bool IsCommit = true)
		{
			if(dto.ID <= 0) dto.ID=GetMax<int>(p=>p.ID)+1;
			return _repository.Add(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		/// <summary>
		/// 增加一条记录(异步方式)
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(U_OrderTextDTO dto, bool IsCommit = true)
		{
			if(dto.ID <= 0) dto.ID=GetMax<int>(p=>p.ID)+1;
			return await _repository.AddAsync(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(U_OrderTextDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(U_OrderTextDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(U_OrderTextDTO dto, bool IsCommit = true)
		{
			if (dto == null) return false;
			return _repository.Delete(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		/// <summary>
		/// 删除一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(U_OrderTextDTO dto, bool IsCommit = true)
		{
			if (dto == null) return await Task.Run(() => false);

			return await _repository.DeleteAsync(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.DeleteList(Mapper.Map<IList<U_OrderText>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 删除多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.DeleteListAsync(Mapper.Map<IList<U_OrderText>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<U_OrderTextDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<U_OrderTextDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(U_OrderTextDTO dto, bool IsCommit = true)
		{
			return _repository.Update(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(U_OrderTextDTO dto, bool IsCommit = true)
		{
			return await _repository.UpdateAsync(Mapper.Map<U_OrderText>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.UpdateList(Mapper.Map<IList<U_OrderText>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 更新多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<U_OrderTextDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.UpdateListAsync(Mapper.Map<IList<U_OrderText>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual U_OrderTextDTO Get(Expression<Func<U_OrderTextDTO, bool>> predicate)
		{
			var entity = _repository.Get(GetEntityLamada(predicate));
			return Mapper.Map<U_OrderTextDTO>(entity);
		}
		/// <summary>
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<U_OrderTextDTO> GetAsync(Expression<Func<U_OrderTextDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<U_OrderTextDTO> LoadAll(Expression<Func<U_OrderTextDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<IQueryable<U_OrderTextDTO>>(entity);
		}
		/// <summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<U_OrderTextDTO>> LoadAllAsync(Expression<Func<U_OrderTextDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<U_OrderTextDTO> LoadListAll(Expression<Func<U_OrderTextDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadListAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<List<U_OrderTextDTO>>(entity);
		}
		/// <summary>
		/// 返回集合,不采用延时加载（异步方式）
		/// </summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<U_OrderTextDTO>> LoadListAllAsync(Expression<Func<U_OrderTextDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<U_OrderTextDTO> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<U_OrderTextDTO>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<U_OrderTextDTO> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<U_OrderTextDTO>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<U_OrderTextDTO> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<U_OrderTextDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<U_OrderTextDTO, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<U_OrderTextDTO, TResult>> scalar, params DbParameter[] para)
		{
			return await _repository.GetBySQLAsync<TResult>(sql, GetEntityLamada(scalar),para);
		}
		#endregion
		
		private Expression<Func<U_OrderText, bool>> GetEntityLamada(Expression<Func<U_OrderTextDTO, bool>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<U_OrderText, bool>> lamada = predicate.Cast<U_OrderTextDTO, U_OrderText>();
			return lamada;
		}
		private Expression<Func<U_OrderText, TResult>> GetEntityLamada<TResult>(Expression<Func<U_OrderTextDTO, TResult>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<U_OrderText, TResult>> lamada = predicate.Cast<U_OrderTextDTO, U_OrderText,TResult>();
			return lamada;
		}
	}
}