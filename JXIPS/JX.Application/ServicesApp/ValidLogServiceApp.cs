...
namespace JX.Application
{
	...
	public partial class ValidLogServiceApp : IValidLogServiceApp
	{
		...
		/// <returns></returns>
		public virtual TResult GetScalar<TResult, TOrderBy>(Expression<Func<ValidLogDTO, TResult>> scalar, Expression<Func<ValidLogDTO, bool>> predicate = null, Expression<Func<ValidLogDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="IsAsc">排序方向，true为正序false为倒序</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetScalarAsync<TResult, TOrderBy>(Expression<Func<ValidLogDTO, TResult>> scalar, Expression<Func<ValidLogDTO, bool>> predicate = null, Expression<Func<ValidLogDTO, TOrderBy>> orderby = null, bool IsAsc = true)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMax<TResult>(Expression<Func<ValidLogDTO, TResult>> max, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMaxAsync<TResult>(Expression<Func<ValidLogDTO, TResult>> max, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual TResult GetMin<TResult>(Expression<Func<ValidLogDTO, TResult>> min, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<TResult> GetMinAsync<TResult>(Expression<Func<ValidLogDTO, TResult>> min, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetAvg(Expression<Func<ValidLogDTO, decimal>> avg, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetAvgAsync(Expression<Func<ValidLogDTO, decimal>> avg, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual decimal GetSum(Expression<Func<ValidLogDTO, decimal>> sum, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<decimal> GetSumAsync(Expression<Func<ValidLogDTO, decimal>> sum, Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual int GetCount(Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// <param name="predicate">查询条件，Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<int> GetCountAsync(Expression<Func<ValidLogDTO, bool>> predicate = null)
		{
		...
		/// 验证当前条件是否存在相同项
		/// </summary>
		public virtual bool IsExist(Expression<Func<ValidLogDTO, bool>> predicate)
		{
		...
		/// 验证当前条件是否存在相同项（异步方式）
		/// </summary>
		public virtual async Task<bool> IsExistAsync(Expression<Func<ValidLogDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ValidLogDTO dto, bool IsCommit = true)
		{
			
			return _repository.Add(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		/// <summary>
		/// 增加一条记录(异步方式)
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ValidLogDTO dto, bool IsCommit = true)
		{
			
			return await _repository.AddAsync(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddList(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddListAsync(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool AddOrUpdate(ValidLogDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ValidLogDTO dto, bool IsSave, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Delete(ValidLogDTO dto, bool IsCommit = true)
		{
			if (dto == null) return false;
			return _repository.Delete(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		/// <summary>
		/// 删除一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(ValidLogDTO dto, bool IsCommit = true)
		{
			if (dto == null) return await Task.Run(() => false);

			return await _repository.DeleteAsync(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool DeleteList(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.DeleteList(Mapper.Map<IList<ValidLog>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 删除多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteListAsync(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.DeleteListAsync(Mapper.Map<IList<ValidLog>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual bool Delete(Expression<Func<ValidLogDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit"></param>
		/// <returns></returns>
		public virtual async Task<bool> DeleteAsync(Expression<Func<ValidLogDTO, bool>> predicate, bool IsCommit = true)
		{
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool Update(ValidLogDTO dto, bool IsCommit = true)
		{
			return _repository.Update(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ValidLogDTO dto, bool IsCommit = true)
		{
			return await _repository.UpdateAsync(Mapper.Map<ValidLog>(dto), IsCommit);
		}
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual bool UpdateList(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return false;

			return _repository.UpdateList(Mapper.Map<IList<ValidLog>>(dtoList), IsCommit);
		}
		/// <summary>
		/// 更新多条记录，同一模型（异步方式）
		/// </summary>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateListAsync(IList<ValidLogDTO> dtoList, bool IsCommit = true)
		{
			if (dtoList == null || dtoList.Count == 0) return await Task.Run(() => false);

			return await _repository.UpdateListAsync(Mapper.Map<IList<ValidLog>>(dtoList), IsCommit);
		}
		...
		/// <returns></returns>
		public virtual ValidLogDTO Get(Expression<Func<ValidLogDTO, bool>> predicate)
		{
			var entity = _repository.Get(GetEntityLamada(predicate));
			return Mapper.Map<ValidLogDTO>(entity);
		}
		/// <summary>
		...
		/// <param name="predicate">Lamda表达式（p=>p.Id==Id）</param>
		/// <returns></returns>
		public virtual async Task<ValidLogDTO> GetAsync(Expression<Func<ValidLogDTO, bool>> predicate)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<ValidLogDTO> LoadAll(Expression<Func<ValidLogDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<IQueryable<ValidLogDTO>>(entity);
		}
		/// <summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<ValidLogDTO>> LoadAllAsync(Expression<Func<ValidLogDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual List<ValidLogDTO> LoadListAll(Expression<Func<ValidLogDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
			var entity = _repository.LoadListAll(GetEntityLamada(predicate),orderByExpression);
			return Mapper.Map<List<ValidLogDTO>>(entity);
		}
		/// <summary>
		/// 返回集合,不采用延时加载（异步方式）
		/// </summary>
		...
		/// <param name="orderByExpression">多字段排序</param>
		/// <returns></returns>
		public virtual async Task<List<ValidLogDTO>> LoadListAllAsync(Expression<Func<ValidLogDTO, bool>> predicate, params SortModelField[] orderByExpression)
		{
		...
		/// <returns></returns>
		public virtual IQueryable<ValidLogDTO> LoadAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<IQueryable<ValidLogDTO>> LoadAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual List<ValidLogDTO> LoadListAllBySql(string sql, params DbParameter[] para)
		{
		...
		/// <param name="para">Parameters参数</param>
		/// <returns></returns>
		public virtual async Task<List<ValidLogDTO>> LoadListAllBySqlAsync(string sql, params DbParameter[] para)
		{
		...
		/// <returns></returns>
		public virtual IList<ValidLogDTO> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ValidLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			Total=0;
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual TResult GetBySQL<TResult>(string sql, Expression<Func<ValidLogDTO, TResult>> scalar, params DbParameter[] para)
		{
		...
		/// <param name="para"></param>
		/// <returns></returns>
		public virtual async Task<TResult> GetBySQLAsync<TResult>(string sql, Expression<Func<ValidLogDTO, TResult>> scalar, params DbParameter[] para)
		{
			return await _repository.GetBySQLAsync<TResult>(sql, GetEntityLamada(scalar),para);
		}
		#endregion
		
		private Expression<Func<ValidLog, bool>> GetEntityLamada(Expression<Func<ValidLogDTO, bool>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<ValidLog, bool>> lamada = predicate.Cast<ValidLogDTO, ValidLog>();
			return lamada;
		}
		private Expression<Func<ValidLog, TResult>> GetEntityLamada<TResult>(Expression<Func<ValidLogDTO, TResult>> predicate)
		{
			//得到领域Model相关的lamada
			if (predicate == null) return null;
			Expression<Func<ValidLog, TResult>> lamada = predicate.Cast<ValidLogDTO, ValidLog,TResult>();
			return lamada;
		}
	}
}