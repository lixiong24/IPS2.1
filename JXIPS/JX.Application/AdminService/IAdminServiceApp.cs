...
namespace JX.Application
{
	...
	/// 数据库表：Admin 的应用层服务接口.
	/// </summary>
	public partial interface IAdminServiceApp : IServiceApp<AdminDTO>
	{
		#region 得到实体，包括扩展属性
		/// <summary>
		...
		/// <returns></returns>
		AdminDTO GetDTOFull(Expression<Func<AdminDTO, bool>> predicate);
		/// <summary>
		/// 获取实体，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="predicate"></param>
		/// <returns></returns>
		Task<AdminDTO> GetDTOFullAsync(Expression<Func<AdminDTO, bool>> predicate);
		/// <summary>
		...
		/// <param name="predicate"></param>
		/// <returns></returns>
		IList<AdminDTO> GetDTOFullList(Expression<Func<AdminDTO, bool>> predicate);
		/// <summary>
		/// 得到实体列表，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="predicate"></param>
		/// <returns></returns>
		Task<IList<AdminDTO>> GetDTOFullListAsync(Expression<Func<AdminDTO, bool>> predicate);
		#endregion
