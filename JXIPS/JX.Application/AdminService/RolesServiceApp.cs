...
namespace JX.Application
{
	...
	public partial class RolesServiceApp : IRolesServiceApp
	{
		...
		/// <returns></returns>
		public async Task<IList<RoleNodePermissionsDTO>> GetNodePermissionsById(int roleId = -1, int nodeId = -3)
		{
			Expression<Func<RoleNodePermissions, bool>> predicate = p => true;
			if (roleId >= 0)
			{
			...
			return Mapper.Map<List<RoleNodePermissionsDTO>>(entityList);
		}
		#endregion
	}
}