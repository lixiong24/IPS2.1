...
namespace JX.Application
{
	...
	/// </summary>
	public partial class TrademarkServiceAppADO : ITrademarkServiceAppADO
	{
		#region 仓储接口
		private readonly ITrademarkRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public TrademarkServiceAppADO(ITrademarkRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(TrademarkDTO dto)
		{
			return _repository.Add(Mapper.Map<Trademark>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(TrademarkDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Trademark>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(TrademarkDTO dto)
		{
			return _repository.Insert(Mapper.Map<Trademark>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(TrademarkDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Trademark>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(TrademarkDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(TrademarkDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(trademarkID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(trademarkID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(TrademarkDTO dto)
		{
			return _repository.Update(Mapper.Map<Trademark>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(TrademarkDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Trademark>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public TrademarkDTO GetDTO(System.Int32 trademarkID)
		{
			var entity = _repository.GetEntity(trademarkID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<TrademarkDTO> GetDTOAsync(System.Int32 trademarkID)
		{
			var entity = await _repository.GetEntityAsync(trademarkID );
			return Mapper.Map<TrademarkDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual TrademarkDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<TrademarkDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<TrademarkDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<TrademarkDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<TrademarkDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TrademarkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TrademarkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
