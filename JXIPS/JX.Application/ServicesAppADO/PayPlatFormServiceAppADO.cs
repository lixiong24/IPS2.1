...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PayPlatFormServiceAppADO : IPayPlatFormServiceAppADO
	{
		#region 仓储接口
		private readonly IPayPlatFormRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PayPlatFormServiceAppADO(IPayPlatFormRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PayPlatFormDTO dto)
		{
			return _repository.Add(Mapper.Map<PayPlatForm>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PayPlatFormDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PayPlatForm>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PayPlatFormDTO dto)
		{
			return _repository.Insert(Mapper.Map<PayPlatForm>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PayPlatFormDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PayPlatForm>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PayPlatFormDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PayPlatFormDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(payPlatformID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(payPlatformID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PayPlatFormDTO dto)
		{
			return _repository.Update(Mapper.Map<PayPlatForm>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PayPlatFormDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PayPlatForm>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PayPlatFormDTO GetDTO(System.Int32 payPlatformID)
		{
			var entity = _repository.GetEntity(payPlatformID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PayPlatFormDTO> GetDTOAsync(System.Int32 payPlatformID)
		{
			var entity = await _repository.GetEntityAsync(payPlatformID );
			return Mapper.Map<PayPlatFormDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PayPlatFormDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PayPlatFormDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PayPlatFormDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PayPlatFormDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PayPlatFormDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatFormDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatFormDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
