...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WorkServiceAppADO : IWorkServiceAppADO
	{
		#region 仓储接口
		private readonly IWorkRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WorkServiceAppADO(IWorkRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WorkDTO dto)
		{
			return _repository.Add(Mapper.Map<Work>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Work>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkDTO dto)
		{
			return _repository.Insert(Mapper.Map<Work>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Work>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(workID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(workID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkDTO dto)
		{
			return _repository.Update(Mapper.Map<Work>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Work>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WorkDTO GetDTO(System.Int32 workID)
		{
			var entity = _repository.GetEntity(workID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkDTO> GetDTOAsync(System.Int32 workID)
		{
			var entity = await _repository.GetEntityAsync(workID );
			return Mapper.Map<WorkDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WorkDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
