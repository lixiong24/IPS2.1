...
namespace JX.Application
{
	...
	/// </summary>
	public partial class KeywordRelationServiceAppADO : IKeywordRelationServiceAppADO
	{
		#region 仓储接口
		private readonly IKeywordRelationRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public KeywordRelationServiceAppADO(IKeywordRelationRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(KeywordRelationDTO dto)
		{
			return _repository.Add(Mapper.Map<KeywordRelation>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(KeywordRelationDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<KeywordRelation>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(KeywordRelationDTO dto)
		{
			return _repository.Insert(Mapper.Map<KeywordRelation>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(KeywordRelationDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<KeywordRelation>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(KeywordRelationDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(KeywordRelationDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(KeywordRelationDTO dto)
		{
			return _repository.Update(Mapper.Map<KeywordRelation>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(KeywordRelationDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<KeywordRelation>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public KeywordRelationDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<KeywordRelationDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual KeywordRelationDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<KeywordRelationDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<KeywordRelationDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<KeywordRelationDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<KeywordRelationDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelationDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<KeywordRelationDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
