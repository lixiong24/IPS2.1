...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SubscriptionItemsServiceAppADO : ISubscriptionItemsServiceAppADO
	{
		#region 仓储接口
		private readonly ISubscriptionItemsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SubscriptionItemsServiceAppADO(ISubscriptionItemsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SubscriptionItemsDTO dto)
		{
			return _repository.Add(Mapper.Map<SubscriptionItems>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SubscriptionItemsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SubscriptionItems>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SubscriptionItemsDTO dto)
		{
			return _repository.Insert(Mapper.Map<SubscriptionItems>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SubscriptionItemsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SubscriptionItems>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SubscriptionItemsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SubscriptionItemsDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SubscriptionItemsDTO dto)
		{
			return _repository.Update(Mapper.Map<SubscriptionItems>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SubscriptionItemsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SubscriptionItems>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SubscriptionItemsDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SubscriptionItemsDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SubscriptionItemsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SubscriptionItemsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SubscriptionItemsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SubscriptionItemsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SubscriptionItemsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItemsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SubscriptionItemsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
