...
namespace JX.Application
{
	...
	/// </summary>
	public partial class VoteServiceAppADO : IVoteServiceAppADO
	{
		#region 仓储接口
		private readonly IVoteRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public VoteServiceAppADO(IVoteRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(VoteDTO dto)
		{
			return _repository.Add(Mapper.Map<Vote>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(VoteDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Vote>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(VoteDTO dto)
		{
			return _repository.Insert(Mapper.Map<Vote>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(VoteDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Vote>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(VoteDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(VoteDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(VoteDTO dto)
		{
			return _repository.Update(Mapper.Map<Vote>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(VoteDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Vote>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public VoteDTO GetDTO(System.Int32 generalId)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<VoteDTO> GetDTOAsync(System.Int32 generalId)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual VoteDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<VoteDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<VoteDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<VoteDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<VoteDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<VoteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<VoteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
