...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CouponServiceAppADO : ICouponServiceAppADO
	{
		#region 仓储接口
		private readonly ICouponRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CouponServiceAppADO(ICouponRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CouponDTO dto)
		{
			return _repository.Add(Mapper.Map<Coupon>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CouponDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Coupon>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CouponDTO dto)
		{
			return _repository.Insert(Mapper.Map<Coupon>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CouponDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Coupon>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CouponDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CouponDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(couponID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(couponID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CouponDTO dto)
		{
			return _repository.Update(Mapper.Map<Coupon>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CouponDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Coupon>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CouponDTO GetDTO(System.Int32 couponID)
		{
			var entity = _repository.GetEntity(couponID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CouponDTO> GetDTOAsync(System.Int32 couponID)
		{
			var entity = await _repository.GetEntityAsync(couponID );
			return Mapper.Map<CouponDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CouponDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CouponDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CouponDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CouponDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CouponDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CouponDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
