...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ComplaintsResultsServiceAppADO : IComplaintsResultsServiceAppADO
	{
		#region 仓储接口
		private readonly IComplaintsResultsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ComplaintsResultsServiceAppADO(IComplaintsResultsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsResultsDTO dto)
		{
			return _repository.Add(Mapper.Map<ComplaintsResults>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsResultsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ComplaintsResults>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsResultsDTO dto)
		{
			return _repository.Insert(Mapper.Map<ComplaintsResults>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsResultsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ComplaintsResults>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsResultsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsResultsDTO dto, bool IsSave)
		{
		...
		{
			return await _repository.DeleteAsync(rid );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsResultsDTO dto)
		{
			return _repository.Update(Mapper.Map<ComplaintsResults>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsResultsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ComplaintsResults>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsResultsDTO GetDTO(System.Int32 rid)
		{
			var entity = _repository.GetEntity(rid );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsResultsDTO> GetDTOAsync(System.Int32 rid)
		{
			var entity = await _repository.GetEntityAsync(rid );
			return Mapper.Map<ComplaintsResultsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsResultsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsResultsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsResultsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsResultsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ComplaintsResultsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResultsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResultsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
