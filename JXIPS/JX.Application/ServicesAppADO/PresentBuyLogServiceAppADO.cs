...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PresentBuyLogServiceAppADO : IPresentBuyLogServiceAppADO
	{
		#region 仓储接口
		private readonly IPresentBuyLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PresentBuyLogServiceAppADO(IPresentBuyLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PresentBuyLogDTO dto)
		{
			return _repository.Add(Mapper.Map<PresentBuyLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentBuyLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PresentBuyLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentBuyLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<PresentBuyLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentBuyLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PresentBuyLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentBuyLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentBuyLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentBuyLogDTO dto)
		{
			return _repository.Update(Mapper.Map<PresentBuyLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentBuyLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PresentBuyLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PresentBuyLogDTO GetDTO(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentBuyLogDTO> GetDTOAsync(System.Int32 logID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentBuyLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentBuyLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentBuyLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentBuyLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PresentBuyLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentBuyLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentBuyLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
