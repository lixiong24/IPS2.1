...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CreditLinesLogServiceAppADO : ICreditLinesLogServiceAppADO
	{
		#region 仓储接口
		private readonly ICreditLinesLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CreditLinesLogServiceAppADO(ICreditLinesLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CreditLinesLogDTO dto)
		{
			return _repository.Add(Mapper.Map<CreditLinesLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CreditLinesLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CreditLinesLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CreditLinesLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<CreditLinesLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CreditLinesLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CreditLinesLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CreditLinesLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CreditLinesLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(logID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(logID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CreditLinesLogDTO dto)
		{
			return _repository.Update(Mapper.Map<CreditLinesLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CreditLinesLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CreditLinesLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CreditLinesLogDTO GetDTO(System.Int32 logID)
		{
			var entity = _repository.GetEntity(logID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CreditLinesLogDTO> GetDTOAsync(System.Int32 logID)
		{
			var entity = await _repository.GetEntityAsync(logID );
			return Mapper.Map<CreditLinesLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CreditLinesLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CreditLinesLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CreditLinesLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CreditLinesLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CreditLinesLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
