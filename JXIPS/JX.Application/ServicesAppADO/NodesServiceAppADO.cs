...
namespace JX.Application
{
	...
	/// </summary>
	public partial class NodesServiceAppADO : INodesServiceAppADO
	{
		#region 仓储接口
		private readonly INodesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public NodesServiceAppADO(INodesRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(NodesDTO dto)
		{
			return _repository.Add(Mapper.Map<Nodes>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Nodes>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesDTO dto)
		{
			return _repository.Insert(Mapper.Map<Nodes>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Nodes>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(nodeID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(nodeID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesDTO dto)
		{
			return _repository.Update(Mapper.Map<Nodes>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Nodes>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public NodesDTO GetDTO(System.Int32 nodeID)
		{
			var entity = _repository.GetEntity(nodeID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesDTO> GetDTOAsync(System.Int32 nodeID)
		{
			var entity = await _repository.GetEntityAsync(nodeID );
			return Mapper.Map<NodesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<NodesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
