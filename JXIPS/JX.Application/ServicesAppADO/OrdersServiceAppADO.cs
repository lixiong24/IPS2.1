...
namespace JX.Application
{
	...
	/// </summary>
	public partial class OrdersServiceAppADO : IOrdersServiceAppADO
	{
		#region 仓储接口
		private readonly IOrdersRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public OrdersServiceAppADO(IOrdersRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(OrdersDTO dto)
		{
			return _repository.Add(Mapper.Map<Orders>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrdersDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Orders>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(OrdersDTO dto)
		{
			return _repository.Insert(Mapper.Map<Orders>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrdersDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Orders>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrdersDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrdersDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(OrdersDTO dto)
		{
			return _repository.Update(Mapper.Map<Orders>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrdersDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Orders>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public OrdersDTO GetDTO(System.Int32 orderID)
		{
			var entity = _repository.GetEntity(orderID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrdersDTO> GetDTOAsync(System.Int32 orderID)
		{
			var entity = await _repository.GetEntityAsync(orderID );
			return Mapper.Map<OrdersDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrdersDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrdersDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrdersDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrdersDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<OrdersDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrdersDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrdersDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
