...
namespace JX.Application
{
	...
	/// </summary>
	public partial class FavoriteServiceAppADO : IFavoriteServiceAppADO
	{
		#region 仓储接口
		private readonly IFavoriteRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public FavoriteServiceAppADO(IFavoriteRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(FavoriteDTO dto)
		{
			return _repository.Add(Mapper.Map<Favorite>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FavoriteDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Favorite>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(FavoriteDTO dto)
		{
			return _repository.Insert(Mapper.Map<Favorite>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FavoriteDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Favorite>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FavoriteDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FavoriteDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(favoriteID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(favoriteID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(FavoriteDTO dto)
		{
			return _repository.Update(Mapper.Map<Favorite>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FavoriteDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Favorite>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public FavoriteDTO GetDTO(System.Int32 favoriteID)
		{
			var entity = _repository.GetEntity(favoriteID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FavoriteDTO> GetDTOAsync(System.Int32 favoriteID)
		{
			var entity = await _repository.GetEntityAsync(favoriteID );
			return Mapper.Map<FavoriteDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FavoriteDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FavoriteDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FavoriteDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FavoriteDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<FavoriteDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FavoriteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FavoriteDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
