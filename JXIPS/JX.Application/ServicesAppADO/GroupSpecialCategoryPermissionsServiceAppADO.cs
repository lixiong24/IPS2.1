...
namespace JX.Application
{
	...
	/// </summary>
	public partial class GroupSpecialCategoryPermissionsServiceAppADO : IGroupSpecialCategoryPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IGroupSpecialCategoryPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public GroupSpecialCategoryPermissionsServiceAppADO(IGroupSpecialCategoryPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialCategoryPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialCategoryPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupSpecialCategoryPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupSpecialCategoryPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialCategoryPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialCategoryPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(groupID,operateCode,specialCategoryID,iDType );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(groupID,operateCode,specialCategoryID,iDType );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialCategoryPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialCategoryPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<GroupSpecialCategoryPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public GroupSpecialCategoryPermissionsDTO GetDTO(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialCategoryID, System.Int32 iDType)
		{
			var entity = _repository.GetEntity(groupID,operateCode,specialCategoryID,iDType );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupSpecialCategoryPermissionsDTO> GetDTOAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialCategoryID, System.Int32 iDType)
		{
			var entity = await _repository.GetEntityAsync(groupID,operateCode,specialCategoryID,iDType );
			return Mapper.Map<GroupSpecialCategoryPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupSpecialCategoryPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialCategoryPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupSpecialCategoryPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
