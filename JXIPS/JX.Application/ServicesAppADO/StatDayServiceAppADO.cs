...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatDayServiceAppADO : IStatDayServiceAppADO
	{
		#region 仓储接口
		private readonly IStatDayRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatDayServiceAppADO(IStatDayRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatDayDTO dto)
		{
			return _repository.Add(Mapper.Map<StatDay>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatDayDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatDay>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatDayDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatDay>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatDayDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatDay>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatDayDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatDayDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tDay );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tDay );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatDayDTO dto)
		{
			return _repository.Update(Mapper.Map<StatDay>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatDayDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatDay>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatDayDTO GetDTO(System.String tDay)
		{
			var entity = _repository.GetEntity(tDay );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatDayDTO> GetDTOAsync(System.String tDay)
		{
			var entity = await _repository.GetEntityAsync(tDay );
			return Mapper.Map<StatDayDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatDayDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatDayDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatDayDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatDayDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatDayDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatDayDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatDayDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
