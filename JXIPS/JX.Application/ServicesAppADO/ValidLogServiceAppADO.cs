...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ValidLogServiceAppADO : IValidLogServiceAppADO
	{
		#region 仓储接口
		private readonly IValidLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ValidLogServiceAppADO(IValidLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ValidLogDTO dto)
		{
			return _repository.Add(Mapper.Map<ValidLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ValidLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ValidLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ValidLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<ValidLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ValidLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ValidLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ValidLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ValidLogDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ValidLogDTO dto)
		{
			return _repository.Update(Mapper.Map<ValidLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ValidLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ValidLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ValidLogDTO GetDTO(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ValidLogDTO> GetDTOAsync(System.Int32 logID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ValidLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ValidLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ValidLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ValidLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ValidLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ValidLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ValidLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
