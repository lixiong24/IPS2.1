...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SigninLogServiceAppADO : ISigninLogServiceAppADO
	{
		#region 仓储接口
		private readonly ISigninLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SigninLogServiceAppADO(ISigninLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SigninLogDTO dto)
		{
			return _repository.Add(Mapper.Map<SigninLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SigninLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<SigninLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SigninLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(generalID,userName );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(generalID,userName );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninLogDTO dto)
		{
			return _repository.Update(Mapper.Map<SigninLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SigninLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SigninLogDTO GetDTO(System.Int32 generalID, System.String userName)
		{
			var entity = _repository.GetEntity(generalID,userName );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninLogDTO> GetDTOAsync(System.Int32 generalID, System.String userName)
		{
			var entity = await _repository.GetEntityAsync(generalID,userName );
			return Mapper.Map<SigninLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SigninLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
