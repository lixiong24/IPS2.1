...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatBrowserServiceAppADO : IStatBrowserServiceAppADO
	{
		#region 仓储接口
		private readonly IStatBrowserRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatBrowserServiceAppADO(IStatBrowserRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatBrowserDTO dto)
		{
			return _repository.Add(Mapper.Map<StatBrowser>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatBrowserDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatBrowser>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatBrowserDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatBrowser>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatBrowserDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatBrowser>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatBrowserDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatBrowserDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tBrowser );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tBrowser );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatBrowserDTO dto)
		{
			return _repository.Update(Mapper.Map<StatBrowser>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatBrowserDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatBrowser>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatBrowserDTO GetDTO(System.String tBrowser)
		{
			var entity = _repository.GetEntity(tBrowser );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatBrowserDTO> GetDTOAsync(System.String tBrowser)
		{
			var entity = await _repository.GetEntityAsync(tBrowser );
			return Mapper.Map<StatBrowserDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatBrowserDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatBrowserDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatBrowserDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatBrowserDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatBrowserDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowserDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowserDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
