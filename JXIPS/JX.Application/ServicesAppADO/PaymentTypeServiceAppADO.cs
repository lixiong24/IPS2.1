...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PaymentTypeServiceAppADO : IPaymentTypeServiceAppADO
	{
		#region 仓储接口
		private readonly IPaymentTypeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PaymentTypeServiceAppADO(IPaymentTypeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PaymentTypeDTO dto)
		{
			return _repository.Add(Mapper.Map<PaymentType>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentTypeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PaymentType>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentTypeDTO dto)
		{
			return _repository.Insert(Mapper.Map<PaymentType>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PaymentTypeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PaymentType>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PaymentTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PaymentTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentTypeDTO dto)
		{
			return _repository.Update(Mapper.Map<PaymentType>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PaymentTypeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PaymentType>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PaymentTypeDTO GetDTO(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentTypeDTO> GetDTOAsync(System.Int32 typeID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentTypeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PaymentTypeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentTypeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentTypeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PaymentTypeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
