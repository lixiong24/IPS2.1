...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DeliverTypeServiceAppADO : IDeliverTypeServiceAppADO
	{
		#region 仓储接口
		private readonly IDeliverTypeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DeliverTypeServiceAppADO(IDeliverTypeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverTypeDTO dto)
		{
			return _repository.Add(Mapper.Map<DeliverType>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverTypeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<DeliverType>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverTypeDTO dto)
		{
			return _repository.Insert(Mapper.Map<DeliverType>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverTypeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<DeliverType>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverTypeDTO dto)
		{
			return _repository.Update(Mapper.Map<DeliverType>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverTypeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<DeliverType>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DeliverTypeDTO GetDTO(System.Int32 typeID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverTypeDTO> GetDTOAsync(System.Int32 typeID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverTypeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverTypeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverTypeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverTypeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DeliverTypeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
