...
namespace JX.Application
{
	...
	/// </summary>
	public partial class UserMessageServiceAppADO : IUserMessageServiceAppADO
	{
		#region 仓储接口
		private readonly IUserMessageRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public UserMessageServiceAppADO(IUserMessageRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(UserMessageDTO dto)
		{
			return _repository.Add(Mapper.Map<UserMessage>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserMessageDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<UserMessage>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(UserMessageDTO dto)
		{
			return _repository.Insert(Mapper.Map<UserMessage>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UserMessageDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<UserMessage>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UserMessageDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UserMessageDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(messageID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(messageID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(UserMessageDTO dto)
		{
			return _repository.Update(Mapper.Map<UserMessage>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UserMessageDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<UserMessage>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public UserMessageDTO GetDTO(System.Int32 messageID)
		{
			var entity = _repository.GetEntity(messageID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserMessageDTO> GetDTOAsync(System.Int32 messageID)
		{
			var entity = await _repository.GetEntityAsync(messageID );
			return Mapper.Map<UserMessageDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserMessageDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UserMessageDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserMessageDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserMessageDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<UserMessageDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessageDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessageDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
