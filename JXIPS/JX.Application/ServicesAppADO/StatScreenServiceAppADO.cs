...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatScreenServiceAppADO : IStatScreenServiceAppADO
	{
		#region 仓储接口
		private readonly IStatScreenRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatScreenServiceAppADO(IStatScreenRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatScreenDTO dto)
		{
			return _repository.Add(Mapper.Map<StatScreen>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatScreenDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatScreen>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatScreenDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatScreen>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatScreenDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatScreen>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatScreenDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatScreenDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tScreen );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tScreen );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatScreenDTO dto)
		{
			return _repository.Update(Mapper.Map<StatScreen>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatScreenDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatScreen>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatScreenDTO GetDTO(System.String tScreen)
		{
			var entity = _repository.GetEntity(tScreen );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatScreenDTO> GetDTOAsync(System.String tScreen)
		{
			var entity = await _repository.GetEntityAsync(tScreen );
			return Mapper.Map<StatScreenDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatScreenDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatScreenDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatScreenDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatScreenDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatScreenDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreenDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatScreenDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
