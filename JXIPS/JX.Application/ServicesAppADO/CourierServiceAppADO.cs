...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CourierServiceAppADO : ICourierServiceAppADO
	{
		#region 仓储接口
		private readonly ICourierRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CourierServiceAppADO(ICourierRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CourierDTO dto)
		{
			return _repository.Add(Mapper.Map<Courier>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CourierDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Courier>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CourierDTO dto)
		{
			return _repository.Insert(Mapper.Map<Courier>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CourierDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Courier>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CourierDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CourierDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(courierID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(courierID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CourierDTO dto)
		{
			return _repository.Update(Mapper.Map<Courier>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CourierDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Courier>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CourierDTO GetDTO(System.Int32 courierID)
		{
			var entity = _repository.GetEntity(courierID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CourierDTO> GetDTOAsync(System.Int32 courierID)
		{
			var entity = await _repository.GetEntityAsync(courierID );
			return Mapper.Map<CourierDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CourierDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CourierDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CourierDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CourierDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CourierDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CourierDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CourierDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
