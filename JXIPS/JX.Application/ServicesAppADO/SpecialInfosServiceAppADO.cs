...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SpecialInfosServiceAppADO : ISpecialInfosServiceAppADO
	{
		#region 仓储接口
		private readonly ISpecialInfosRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SpecialInfosServiceAppADO(ISpecialInfosRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SpecialInfosDTO dto)
		{
			return _repository.Add(Mapper.Map<SpecialInfos>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialInfosDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SpecialInfos>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialInfosDTO dto)
		{
			return _repository.Insert(Mapper.Map<SpecialInfos>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialInfosDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SpecialInfos>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialInfosDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialInfosDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(specialInfoID,specialID,generalID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(specialInfoID,specialID,generalID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialInfosDTO dto)
		{
			return _repository.Update(Mapper.Map<SpecialInfos>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialInfosDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SpecialInfos>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SpecialInfosDTO GetDTO(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			var entity = _repository.GetEntity(specialInfoID,specialID,generalID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialInfosDTO> GetDTOAsync(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			var entity = await _repository.GetEntityAsync(specialInfoID,specialID,generalID );
			return Mapper.Map<SpecialInfosDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialInfosDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialInfosDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialInfosDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialInfosDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SpecialInfosDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfosDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfosDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
