...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RolesPermissionsServiceAppADO : IRolesPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IRolesPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RolesPermissionsServiceAppADO(IRolesPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RolesPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<RolesPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RolesPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<RolesPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RolesPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(roleID,operateCode );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(roleID,operateCode );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<RolesPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RolesPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RolesPermissionsDTO GetDTO(System.Int32 roleID, System.String operateCode)
		{
			var entity = _repository.GetEntity(roleID,operateCode );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesPermissionsDTO> GetDTOAsync(System.Int32 roleID, System.String operateCode)
		{
			var entity = await _repository.GetEntityAsync(roleID,operateCode );
			return Mapper.Map<RolesPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RolesPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
