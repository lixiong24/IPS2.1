...
namespace JX.Application
{
	...
	{
		#region 仓储接口
		private readonly IUsersRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public UsersServiceAppADO(IUsersRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(UsersDTO dto)
		{
			return _repository.Add(Mapper.Map<Users>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UsersDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Users>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(UsersDTO dto)
		{
			return _repository.Insert(Mapper.Map<Users>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UsersDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Users>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UsersDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UsersDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(UsersDTO dto)
		{
			return _repository.Update(Mapper.Map<Users>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UsersDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Users>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public UsersDTO GetDTO(System.Int32 userID)
		{
			var entity = _repository.GetEntity(userID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UsersDTO> GetDTOAsync(System.Int32 userID)
		{
			var entity = await _repository.GetEntityAsync(userID );
			return Mapper.Map<UsersDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UsersDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UsersDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UsersDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UsersDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<UsersDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UsersDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UsersDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
