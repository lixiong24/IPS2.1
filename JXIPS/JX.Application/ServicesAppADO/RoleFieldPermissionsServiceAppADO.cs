...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RoleFieldPermissionsServiceAppADO : IRoleFieldPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IRoleFieldPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RoleFieldPermissionsServiceAppADO(IRoleFieldPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RoleFieldPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<RoleFieldPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleFieldPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RoleFieldPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleFieldPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<RoleFieldPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleFieldPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RoleFieldPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleFieldPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleFieldPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(roleID,modelID,fieldName,operateCode );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(roleID,modelID,fieldName,operateCode );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleFieldPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<RoleFieldPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleFieldPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RoleFieldPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RoleFieldPermissionsDTO GetDTO(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			var entity = _repository.GetEntity(roleID,modelID,fieldName,operateCode );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleFieldPermissionsDTO> GetDTOAsync(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			var entity = await _repository.GetEntityAsync(roleID,modelID,fieldName,operateCode );
			return Mapper.Map<RoleFieldPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleFieldPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleFieldPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleFieldPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleFieldPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RoleFieldPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
