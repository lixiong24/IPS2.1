...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ProducerServiceAppADO : IProducerServiceAppADO
	{
		#region 仓储接口
		private readonly IProducerRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ProducerServiceAppADO(IProducerRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ProducerDTO dto)
		{
			return _repository.Add(Mapper.Map<Producer>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProducerDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Producer>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ProducerDTO dto)
		{
			return _repository.Insert(Mapper.Map<Producer>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProducerDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Producer>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProducerDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProducerDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(producerID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(producerID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ProducerDTO dto)
		{
			return _repository.Update(Mapper.Map<Producer>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProducerDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Producer>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ProducerDTO GetDTO(System.Int32 producerID)
		{
			var entity = _repository.GetEntity(producerID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProducerDTO> GetDTOAsync(System.Int32 producerID)
		{
			var entity = await _repository.GetEntityAsync(producerID );
			return Mapper.Map<ProducerDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProducerDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProducerDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProducerDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProducerDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ProducerDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProducerDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProducerDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
