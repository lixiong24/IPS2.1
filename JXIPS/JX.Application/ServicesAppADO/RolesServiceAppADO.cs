...
namespace JX.Application
{
	...
	{
		#region 仓储接口
		private readonly IRolesRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		...
		/// <returns></returns>
		public virtual bool Add(RolesDTO dto)
		{
			return _repository.Add(Mapper.Map<Roles>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Roles>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesDTO dto)
		{
			return _repository.Insert(Mapper.Map<Roles>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Roles>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(roleID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesDTO dto)
		{
			return _repository.Update(Mapper.Map<Roles>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Roles>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RolesDTO GetDTO(System.Int32 roleID)
		{
			var entity = _repository.GetEntity(roleID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesDTO> GetDTOAsync(System.Int32 roleID)
		{
			var entity = await _repository.GetEntityAsync(roleID );
			return Mapper.Map<RolesDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RolesDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
