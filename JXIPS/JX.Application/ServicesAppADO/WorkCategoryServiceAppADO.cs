...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WorkCategoryServiceAppADO : IWorkCategoryServiceAppADO
	{
		#region 仓储接口
		private readonly IWorkCategoryRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WorkCategoryServiceAppADO(IWorkCategoryRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WorkCategoryDTO dto)
		{
			return _repository.Add(Mapper.Map<WorkCategory>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkCategoryDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<WorkCategory>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkCategoryDTO dto)
		{
			return _repository.Insert(Mapper.Map<WorkCategory>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkCategoryDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<WorkCategory>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkCategoryDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkCategoryDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkCategoryDTO dto)
		{
			return _repository.Update(Mapper.Map<WorkCategory>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkCategoryDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<WorkCategory>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WorkCategoryDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkCategoryDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkCategoryDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkCategoryDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkCategoryDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkCategoryDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WorkCategoryDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkCategoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
