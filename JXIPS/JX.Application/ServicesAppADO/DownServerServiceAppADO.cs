...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DownServerServiceAppADO : IDownServerServiceAppADO
	{
		#region 仓储接口
		private readonly IDownServerRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DownServerServiceAppADO(IDownServerRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DownServerDTO dto)
		{
			return _repository.Add(Mapper.Map<DownServer>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownServerDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<DownServer>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DownServerDTO dto)
		{
			return _repository.Insert(Mapper.Map<DownServer>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DownServerDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<DownServer>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownServerDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownServerDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(serverID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DownServerDTO dto)
		{
			return _repository.Update(Mapper.Map<DownServer>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownServerDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<DownServer>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DownServerDTO GetDTO(System.Int32 serverID)
		{
			var entity = _repository.GetEntity(serverID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DownServerDTO> GetDTOAsync(System.Int32 serverID)
		{
			var entity = await _repository.GetEntityAsync(serverID );
			return Mapper.Map<DownServerDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DownServerDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DownServerDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DownServerDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DownServerDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DownServerDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownServerDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownServerDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
