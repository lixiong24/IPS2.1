...
namespace JX.Application
{
	...
	/// </summary>
	public partial class GroupFieldPermissionsServiceAppADO : IGroupFieldPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IGroupFieldPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public GroupFieldPermissionsServiceAppADO(IGroupFieldPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(GroupFieldPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<GroupFieldPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupFieldPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<GroupFieldPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupFieldPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<GroupFieldPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupFieldPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<GroupFieldPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupFieldPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupFieldPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(groupID,operateCode,modelID,fieldName,idType );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(groupID,operateCode,modelID,fieldName,idType );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupFieldPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<GroupFieldPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupFieldPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<GroupFieldPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public GroupFieldPermissionsDTO GetDTO(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			var entity = _repository.GetEntity(groupID,operateCode,modelID,fieldName,idType );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupFieldPermissionsDTO> GetDTOAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 modelID, System.String fieldName, System.Int32 idType)
		{
			var entity = await _repository.GetEntityAsync(groupID,operateCode,modelID,fieldName,idType );
			return Mapper.Map<GroupFieldPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupFieldPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupFieldPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupFieldPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupFieldPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<GroupFieldPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupFieldPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
