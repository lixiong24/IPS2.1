...
namespace JX.Application
{
	...
	/// </summary>
	public partial class WorkFlowsServiceAppADO : IWorkFlowsServiceAppADO
	{
		#region 仓储接口
		private readonly IWorkFlowsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public WorkFlowsServiceAppADO(IWorkFlowsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(WorkFlowsDTO dto)
		{
			return _repository.Add(Mapper.Map<WorkFlows>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkFlowsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<WorkFlows>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkFlowsDTO dto)
		{
			return _repository.Insert(Mapper.Map<WorkFlows>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkFlowsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<WorkFlows>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkFlowsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkFlowsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(flowID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkFlowsDTO dto)
		{
			return _repository.Update(Mapper.Map<WorkFlows>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkFlowsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<WorkFlows>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public WorkFlowsDTO GetDTO(System.Int32 flowID)
		{
			var entity = _repository.GetEntity(flowID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkFlowsDTO> GetDTOAsync(System.Int32 flowID)
		{
			var entity = await _repository.GetEntityAsync(flowID );
			return Mapper.Map<WorkFlowsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkFlowsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkFlowsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkFlowsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkFlowsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<WorkFlowsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlowsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlowsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
