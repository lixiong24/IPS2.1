...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CommentPKServiceAppADO : ICommentPKServiceAppADO
	{
		#region 仓储接口
		private readonly ICommentPKRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CommentPKServiceAppADO(ICommentPKRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CommentPKDTO dto)
		{
			return _repository.Add(Mapper.Map<CommentPK>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommentPKDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CommentPK>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CommentPKDTO dto)
		{
			return _repository.Insert(Mapper.Map<CommentPK>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommentPKDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CommentPK>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommentPKDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommentPKDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(pkid );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(pkid );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CommentPKDTO dto)
		{
			return _repository.Update(Mapper.Map<CommentPK>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommentPKDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CommentPK>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CommentPKDTO GetDTO(System.Int32 pkid)
		{
			var entity = _repository.GetEntity(pkid );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommentPKDTO> GetDTOAsync(System.Int32 pkid)
		{
			var entity = await _repository.GetEntityAsync(pkid );
			return Mapper.Map<CommentPKDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommentPKDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommentPKDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommentPKDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommentPKDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CommentPKDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPKDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentPKDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
