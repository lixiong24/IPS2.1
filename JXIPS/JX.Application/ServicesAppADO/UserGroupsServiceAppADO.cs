...
namespace JX.Application
{
	...
	/// </summary>
	public partial class UserGroupsServiceAppADO : IUserGroupsServiceAppADO
	{
		#region 仓储接口
		private readonly IUserGroupsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public UserGroupsServiceAppADO(IUserGroupsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(UserGroupsDTO dto)
		{
			return _repository.Add(Mapper.Map<UserGroups>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserGroupsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<UserGroups>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(UserGroupsDTO dto)
		{
			return _repository.Insert(Mapper.Map<UserGroups>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UserGroupsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<UserGroups>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UserGroupsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UserGroupsDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(UserGroupsDTO dto)
		{
			return _repository.Update(Mapper.Map<UserGroups>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UserGroupsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<UserGroups>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public UserGroupsDTO GetDTO(System.Int32 groupID)
		{
			var entity = _repository.GetEntity(groupID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserGroupsDTO> GetDTOAsync(System.Int32 groupID)
		{
			var entity = await _repository.GetEntityAsync(groupID );
			return Mapper.Map<UserGroupsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserGroupsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UserGroupsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserGroupsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserGroupsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<UserGroupsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroupsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroupsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
