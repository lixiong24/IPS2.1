...
namespace JX.Application
{
	...
	/// </summary>
	public partial class FlowProcessServiceAppADO : IFlowProcessServiceAppADO
	{
		#region 仓储接口
		private readonly IFlowProcessRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public FlowProcessServiceAppADO(IFlowProcessRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(FlowProcessDTO dto)
		{
			return _repository.Add(Mapper.Map<FlowProcess>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FlowProcessDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<FlowProcess>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(FlowProcessDTO dto)
		{
			return _repository.Insert(Mapper.Map<FlowProcess>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FlowProcessDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<FlowProcess>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FlowProcessDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FlowProcessDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(processID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(processID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(FlowProcessDTO dto)
		{
			return _repository.Update(Mapper.Map<FlowProcess>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FlowProcessDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<FlowProcess>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public FlowProcessDTO GetDTO(System.Int32 processID)
		{
			var entity = _repository.GetEntity(processID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FlowProcessDTO> GetDTOAsync(System.Int32 processID)
		{
			var entity = await _repository.GetEntityAsync(processID );
			return Mapper.Map<FlowProcessDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FlowProcessDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FlowProcessDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FlowProcessDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FlowProcessDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<FlowProcessDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcessDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcessDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
