...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CommonProductServiceAppADO : ICommonProductServiceAppADO
	{
		#region 仓储接口
		private readonly ICommonProductRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CommonProductServiceAppADO(ICommonProductRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CommonProductDTO dto)
		{
			return _repository.Add(Mapper.Map<CommonProduct>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommonProductDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CommonProduct>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CommonProductDTO dto)
		{
			return _repository.Insert(Mapper.Map<CommonProduct>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommonProductDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CommonProduct>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommonProductDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommonProductDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CommonProductDTO dto)
		{
			return _repository.Update(Mapper.Map<CommonProduct>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommonProductDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CommonProduct>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CommonProductDTO GetDTO(System.Int32 productID)
		{
			var entity = _repository.GetEntity(productID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommonProductDTO> GetDTOAsync(System.Int32 productID)
		{
			var entity = await _repository.GetEntityAsync(productID );
			return Mapper.Map<CommonProductDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommonProductDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommonProductDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommonProductDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommonProductDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CommonProductDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonProductDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonProductDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
