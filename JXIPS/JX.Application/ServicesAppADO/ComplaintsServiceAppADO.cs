...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ComplaintsServiceAppADO : IComplaintsServiceAppADO
	{
		#region 仓储接口
		private readonly IComplaintsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ComplaintsServiceAppADO(IComplaintsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsDTO dto)
		{
			return _repository.Add(Mapper.Map<Complaints>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Complaints>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsDTO dto)
		{
			return _repository.Insert(Mapper.Map<Complaints>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Complaints>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsDTO dto)
		{
			return _repository.Update(Mapper.Map<Complaints>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Complaints>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsDTO GetDTO(System.Int32 cid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsDTO> GetDTOAsync(System.Int32 cid)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ComplaintsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
