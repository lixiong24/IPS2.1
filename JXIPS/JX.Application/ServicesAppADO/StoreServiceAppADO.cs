...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StoreServiceAppADO : IStoreServiceAppADO
	{
		#region 仓储接口
		private readonly IStoreRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StoreServiceAppADO(IStoreRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StoreDTO dto)
		{
			return _repository.Add(Mapper.Map<Store>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StoreDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Store>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StoreDTO dto)
		{
			return _repository.Insert(Mapper.Map<Store>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StoreDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Store>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StoreDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StoreDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StoreDTO dto)
		{
			return _repository.Update(Mapper.Map<Store>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StoreDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Store>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StoreDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StoreDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StoreDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StoreDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StoreDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StoreDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StoreDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StoreDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StoreDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
