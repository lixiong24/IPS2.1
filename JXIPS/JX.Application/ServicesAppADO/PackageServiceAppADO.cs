...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PackageServiceAppADO : IPackageServiceAppADO
	{
		#region 仓储接口
		private readonly IPackageRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PackageServiceAppADO(IPackageRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PackageDTO dto)
		{
			return _repository.Add(Mapper.Map<Package>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PackageDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Package>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PackageDTO dto)
		{
			return _repository.Insert(Mapper.Map<Package>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PackageDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Package>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PackageDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PackageDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(packageID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(packageID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PackageDTO dto)
		{
			return _repository.Update(Mapper.Map<Package>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PackageDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Package>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PackageDTO GetDTO(System.Int32 packageID)
		{
			var entity = _repository.GetEntity(packageID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PackageDTO> GetDTOAsync(System.Int32 packageID)
		{
			var entity = await _repository.GetEntityAsync(packageID );
			return Mapper.Map<PackageDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PackageDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PackageDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PackageDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PackageDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PackageDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PackageDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PackageDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
