...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CommentServiceAppADO : ICommentServiceAppADO
	{
		#region 仓储接口
		private readonly ICommentRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CommentServiceAppADO(ICommentRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CommentDTO dto)
		{
			return _repository.Add(Mapper.Map<Comment>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommentDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Comment>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CommentDTO dto)
		{
			return _repository.Insert(Mapper.Map<Comment>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommentDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Comment>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommentDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommentDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(commentID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CommentDTO dto)
		{
			return _repository.Update(Mapper.Map<Comment>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommentDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Comment>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CommentDTO GetDTO(System.Int32 commentID)
		{
			var entity = _repository.GetEntity(commentID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommentDTO> GetDTOAsync(System.Int32 commentID)
		{
			var entity = await _repository.GetEntityAsync(commentID );
			return Mapper.Map<CommentDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommentDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommentDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommentDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommentDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CommentDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
