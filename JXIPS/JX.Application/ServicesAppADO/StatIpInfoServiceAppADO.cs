...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatIpInfoServiceAppADO : IStatIpInfoServiceAppADO
	{
		#region 仓储接口
		private readonly IStatIpInfoRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatIpInfoServiceAppADO(IStatIpInfoRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatIpInfoDTO dto)
		{
			return _repository.Add(Mapper.Map<StatIpInfo>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatIpInfoDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatIpInfo>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatIpInfoDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatIpInfo>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatIpInfoDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatIpInfo>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatIpInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatIpInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatIpInfoDTO dto)
		{
			return _repository.Update(Mapper.Map<StatIpInfo>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatIpInfoDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatIpInfo>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatIpInfoDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatIpInfoDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatIpInfoDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatIpInfoDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatIpInfoDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatIpInfoDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatIpInfoDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIpInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
