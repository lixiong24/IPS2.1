...
namespace JX.Application
{
	...
	/// </summary>
	public partial class FileRelationInfoServiceAppADO : IFileRelationInfoServiceAppADO
	{
		#region 仓储接口
		private readonly IFileRelationInfoRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public FileRelationInfoServiceAppADO(IFileRelationInfoRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(FileRelationInfoDTO dto)
		{
			return _repository.Add(Mapper.Map<FileRelationInfo>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FileRelationInfoDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<FileRelationInfo>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(FileRelationInfoDTO dto)
		{
			return _repository.Insert(Mapper.Map<FileRelationInfo>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FileRelationInfoDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<FileRelationInfo>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FileRelationInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FileRelationInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(FileRelationInfoDTO dto)
		{
			return _repository.Update(Mapper.Map<FileRelationInfo>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FileRelationInfoDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<FileRelationInfo>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public FileRelationInfoDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FileRelationInfoDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FileRelationInfoDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FileRelationInfoDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FileRelationInfoDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FileRelationInfoDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<FileRelationInfoDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FileRelationInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
