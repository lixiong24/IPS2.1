...
namespace JX.Application
{
	...
	/// </summary>
	public partial class OrderFeedbackServiceAppADO : IOrderFeedbackServiceAppADO
	{
		#region 仓储接口
		private readonly IOrderFeedbackRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public OrderFeedbackServiceAppADO(IOrderFeedbackRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(OrderFeedbackDTO dto)
		{
			return _repository.Add(Mapper.Map<OrderFeedback>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderFeedbackDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<OrderFeedback>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderFeedbackDTO dto)
		{
			return _repository.Insert(Mapper.Map<OrderFeedback>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderFeedbackDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<OrderFeedback>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderFeedbackDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderFeedbackDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderFeedbackDTO dto)
		{
			return _repository.Update(Mapper.Map<OrderFeedback>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderFeedbackDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<OrderFeedback>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public OrderFeedbackDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderFeedbackDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderFeedbackDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderFeedbackDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderFeedbackDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderFeedbackDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<OrderFeedbackDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderFeedbackDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderFeedbackDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
