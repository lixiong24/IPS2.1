...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RemindItemServiceAppADO : IRemindItemServiceAppADO
	{
		#region 仓储接口
		private readonly IRemindItemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RemindItemServiceAppADO(IRemindItemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RemindItemDTO dto)
		{
			return _repository.Add(Mapper.Map<RemindItem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RemindItemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RemindItem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RemindItemDTO dto)
		{
			return _repository.Insert(Mapper.Map<RemindItem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RemindItemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RemindItem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RemindItemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RemindItemDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(remindID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(remindID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RemindItemDTO dto)
		{
			return _repository.Update(Mapper.Map<RemindItem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RemindItemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RemindItem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RemindItemDTO GetDTO(System.Int32 remindID)
		{
			var entity = _repository.GetEntity(remindID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RemindItemDTO> GetDTOAsync(System.Int32 remindID)
		{
			var entity = await _repository.GetEntityAsync(remindID );
			return Mapper.Map<RemindItemDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RemindItemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RemindItemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RemindItemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RemindItemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RemindItemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
