...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CommonInfoServiceAppADO : ICommonInfoServiceAppADO
	{
		#region 仓储接口
		private readonly ICommonInfoRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CommonInfoServiceAppADO(ICommonInfoRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CommonInfoDTO dto)
		{
			return _repository.Add(Mapper.Map<CommonInfo>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CommonInfoDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CommonInfo>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CommonInfoDTO dto)
		{
			return _repository.Insert(Mapper.Map<CommonInfo>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CommonInfoDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CommonInfo>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CommonInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CommonInfoDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CommonInfoDTO dto)
		{
			return _repository.Update(Mapper.Map<CommonInfo>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CommonInfoDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CommonInfo>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CommonInfoDTO GetDTO(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CommonInfoDTO> GetDTOAsync(System.Int32 generalID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CommonInfoDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CommonInfoDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CommonInfoDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CommonInfoDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CommonInfoDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CommonInfoDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
