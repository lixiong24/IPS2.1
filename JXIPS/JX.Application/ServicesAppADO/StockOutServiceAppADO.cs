...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StockOutServiceAppADO : IStockOutServiceAppADO
	{
		#region 仓储接口
		private readonly IStockOutRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StockOutServiceAppADO(IStockOutRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StockOutDTO dto)
		{
			return _repository.Add(Mapper.Map<StockOut>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockOutDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StockOut>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StockOutDTO dto)
		{
			return _repository.Insert(Mapper.Map<StockOut>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockOutDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StockOut>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockOutDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockOutDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StockOutDTO dto)
		{
			return _repository.Update(Mapper.Map<StockOut>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockOutDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StockOut>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StockOutDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockOutDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockOutDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockOutDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockOutDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockOutDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StockOutDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOutDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOutDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
