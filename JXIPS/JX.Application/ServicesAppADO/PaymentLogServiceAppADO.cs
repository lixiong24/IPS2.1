...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PaymentLogServiceAppADO : IPaymentLogServiceAppADO
	{
		#region 仓储接口
		private readonly IPaymentLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PaymentLogServiceAppADO(IPaymentLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PaymentLogDTO dto)
		{
			return _repository.Add(Mapper.Map<PaymentLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PaymentLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<PaymentLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PaymentLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PaymentLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PaymentLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PaymentLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(paymentLogID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(paymentLogID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentLogDTO dto)
		{
			return _repository.Update(Mapper.Map<PaymentLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PaymentLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PaymentLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PaymentLogDTO GetDTO(System.Int32 paymentLogID)
		{
			var entity = _repository.GetEntity(paymentLogID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentLogDTO> GetDTOAsync(System.Int32 paymentLogID)
		{
			var entity = await _repository.GetEntityAsync(paymentLogID );
			return Mapper.Map<PaymentLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PaymentLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PaymentLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
