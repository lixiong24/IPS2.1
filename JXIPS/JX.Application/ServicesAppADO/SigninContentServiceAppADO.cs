...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SigninContentServiceAppADO : ISigninContentServiceAppADO
	{
		#region 仓储接口
		private readonly ISigninContentRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SigninContentServiceAppADO(ISigninContentRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SigninContentDTO dto)
		{
			return _repository.Add(Mapper.Map<SigninContent>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SigninContentDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<SigninContent>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SigninContentDTO dto)
		{
			return _repository.Insert(Mapper.Map<SigninContent>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SigninContentDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<SigninContent>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SigninContentDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SigninContentDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SigninContentDTO dto)
		{
			return _repository.Update(Mapper.Map<SigninContent>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SigninContentDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<SigninContent>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SigninContentDTO GetDTO(System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SigninContentDTO> GetDTOAsync(System.Int32 generalID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SigninContentDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SigninContentDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SigninContentDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SigninContentDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SigninContentDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SigninContentDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
