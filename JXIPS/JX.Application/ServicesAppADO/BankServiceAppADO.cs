...
namespace JX.Application
{
	...
	/// </summary>
	public partial class BankServiceAppADO : IBankServiceAppADO
	{
		#region 仓储接口
		private readonly IBankRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public BankServiceAppADO(IBankRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(BankDTO dto)
		{
			return _repository.Add(Mapper.Map<Bank>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(BankDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Bank>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(BankDTO dto)
		{
			return _repository.Insert(Mapper.Map<Bank>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(BankDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Bank>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(BankDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(BankDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(bankID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(bankID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(BankDTO dto)
		{
			return _repository.Update(Mapper.Map<Bank>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(BankDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Bank>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public BankDTO GetDTO(System.Int32 bankID)
		{
			var entity = _repository.GetEntity(bankID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<BankDTO> GetDTOAsync(System.Int32 bankID)
		{
			var entity = await _repository.GetEntityAsync(bankID );
			return Mapper.Map<BankDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual BankDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<BankDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<BankDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<BankDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<BankDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<BankDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
