...
namespace JX.Application
{
	...
	{
		#region 仓储接口
		private readonly IAdminRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		...
		/// <returns></returns>
		public virtual bool Add(AdminDTO dto)
		{
			return _repository.Add(Mapper.Map<Admin>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdminDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Admin>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AdminDTO dto)
		{
			return _repository.Insert(Mapper.Map<Admin>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdminDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Admin>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdminDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdminDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(adminID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(adminID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AdminDTO dto)
		{
			return _repository.Update(Mapper.Map<Admin>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdminDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Admin>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AdminDTO GetDTO(System.Int32 adminID)
		{
			var entity = _repository.GetEntity(adminID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdminDTO> GetDTOAsync(System.Int32 adminID)
		{
			var entity = await _repository.GetEntityAsync(adminID );
			return Mapper.Map<AdminDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdminDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdminDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdminDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdminDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AdminDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
