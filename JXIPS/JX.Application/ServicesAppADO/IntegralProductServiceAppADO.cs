...
namespace JX.Application
{
	...
	/// </summary>
	public partial class IntegralProductServiceAppADO : IIntegralProductServiceAppADO
	{
		#region 仓储接口
		private readonly IIntegralProductRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public IntegralProductServiceAppADO(IIntegralProductRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(IntegralProductDTO dto)
		{
			return _repository.Add(Mapper.Map<IntegralProduct>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IntegralProductDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<IntegralProduct>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(IntegralProductDTO dto)
		{
			return _repository.Insert(Mapper.Map<IntegralProduct>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IntegralProductDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<IntegralProduct>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IntegralProductDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IntegralProductDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(IntegralProductDTO dto)
		{
			return _repository.Update(Mapper.Map<IntegralProduct>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IntegralProductDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<IntegralProduct>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public IntegralProductDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IntegralProductDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IntegralProductDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IntegralProductDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IntegralProductDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IntegralProductDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<IntegralProductDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
