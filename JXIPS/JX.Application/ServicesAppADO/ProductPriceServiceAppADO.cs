...
namespace JX.Application
{
	...
	/// </summary>
	public partial class ProductPriceServiceAppADO : IProductPriceServiceAppADO
	{
		#region 仓储接口
		private readonly IProductPriceRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public ProductPriceServiceAppADO(IProductPriceRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(ProductPriceDTO dto)
		{
			return _repository.Add(Mapper.Map<ProductPrice>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ProductPriceDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<ProductPrice>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(ProductPriceDTO dto)
		{
			return _repository.Insert(Mapper.Map<ProductPrice>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ProductPriceDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<ProductPrice>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ProductPriceDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ProductPriceDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(ProductPriceDTO dto)
		{
			return _repository.Update(Mapper.Map<ProductPrice>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ProductPriceDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<ProductPrice>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public ProductPriceDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ProductPriceDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ProductPriceDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ProductPriceDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ProductPriceDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ProductPriceDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<ProductPriceDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProductPriceDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ProductPriceDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
