...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RoleSpecialPermissionsServiceAppADO : IRoleSpecialPermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IRoleSpecialPermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RoleSpecialPermissionsServiceAppADO(IRoleSpecialPermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RoleSpecialPermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleSpecialPermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleSpecialPermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleSpecialPermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleSpecialPermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleSpecialPermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(roleID,specialID,operateCode );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(roleID,specialID,operateCode );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleSpecialPermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleSpecialPermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RoleSpecialPermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RoleSpecialPermissionsDTO GetDTO(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			var entity = _repository.GetEntity(roleID,specialID,operateCode );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleSpecialPermissionsDTO> GetDTOAsync(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			var entity = await _repository.GetEntityAsync(roleID,specialID,operateCode );
			return Mapper.Map<RoleSpecialPermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleSpecialPermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleSpecialPermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleSpecialPermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleSpecialPermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RoleSpecialPermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
