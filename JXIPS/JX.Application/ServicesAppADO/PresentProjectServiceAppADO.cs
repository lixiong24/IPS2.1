...
namespace JX.Application
{
	...
	/// </summary>
	public partial class PresentProjectServiceAppADO : IPresentProjectServiceAppADO
	{
		#region 仓储接口
		private readonly IPresentProjectRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public PresentProjectServiceAppADO(IPresentProjectRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(PresentProjectDTO dto)
		{
			return _repository.Add(Mapper.Map<PresentProject>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentProjectDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<PresentProject>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentProjectDTO dto)
		{
			return _repository.Insert(Mapper.Map<PresentProject>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentProjectDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<PresentProject>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentProjectDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentProjectDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentProjectDTO dto)
		{
			return _repository.Update(Mapper.Map<PresentProject>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentProjectDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<PresentProject>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public PresentProjectDTO GetDTO(System.Int32 projectID)
		{
			var entity = _repository.GetEntity(projectID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentProjectDTO> GetDTOAsync(System.Int32 projectID)
		{
			var entity = await _repository.GetEntityAsync(projectID );
			return Mapper.Map<PresentProjectDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentProjectDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentProjectDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentProjectDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentProjectDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<PresentProjectDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProjectDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProjectDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
