...
namespace JX.Application
{
	...
	/// </summary>
	public partial class IntegralProductTypeServiceAppADO : IIntegralProductTypeServiceAppADO
	{
		#region 仓储接口
		private readonly IIntegralProductTypeRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public IntegralProductTypeServiceAppADO(IIntegralProductTypeRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(IntegralProductTypeDTO dto)
		{
			return _repository.Add(Mapper.Map<IntegralProductType>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(IntegralProductTypeDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<IntegralProductType>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(IntegralProductTypeDTO dto)
		{
			return _repository.Insert(Mapper.Map<IntegralProductType>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(IntegralProductTypeDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<IntegralProductType>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(IntegralProductTypeDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(IntegralProductTypeDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(typeID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(IntegralProductTypeDTO dto)
		{
			return _repository.Update(Mapper.Map<IntegralProductType>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(IntegralProductTypeDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<IntegralProductType>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public IntegralProductTypeDTO GetDTO(System.Int32 typeID)
		{
			var entity = _repository.GetEntity(typeID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<IntegralProductTypeDTO> GetDTOAsync(System.Int32 typeID)
		{
			var entity = await _repository.GetEntityAsync(typeID );
			return Mapper.Map<IntegralProductTypeDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IntegralProductTypeDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IntegralProductTypeDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<IntegralProductTypeDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<IntegralProductTypeDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<IntegralProductTypeDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<IntegralProductTypeDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
