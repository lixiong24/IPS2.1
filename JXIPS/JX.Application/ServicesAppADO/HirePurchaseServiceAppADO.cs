...
namespace JX.Application
{
	...
	/// </summary>
	public partial class HirePurchaseServiceAppADO : IHirePurchaseServiceAppADO
	{
		#region 仓储接口
		private readonly IHirePurchaseRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public HirePurchaseServiceAppADO(IHirePurchaseRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(HirePurchaseDTO dto)
		{
			return _repository.Add(Mapper.Map<HirePurchase>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(HirePurchaseDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<HirePurchase>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(HirePurchaseDTO dto)
		{
			return _repository.Insert(Mapper.Map<HirePurchase>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(HirePurchaseDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<HirePurchase>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(HirePurchaseDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(HirePurchaseDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(HirePurchaseDTO dto)
		{
			return _repository.Update(Mapper.Map<HirePurchase>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(HirePurchaseDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<HirePurchase>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public HirePurchaseDTO GetDTO(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<HirePurchaseDTO> GetDTOAsync(System.Int32 id)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual HirePurchaseDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<HirePurchaseDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<HirePurchaseDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<HirePurchaseDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<HirePurchaseDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<HirePurchaseDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<HirePurchaseDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
