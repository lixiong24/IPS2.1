...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatMonthServiceAppADO : IStatMonthServiceAppADO
	{
		#region 仓储接口
		private readonly IStatMonthRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatMonthServiceAppADO(IStatMonthRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatMonthDTO dto)
		{
			return _repository.Add(Mapper.Map<StatMonth>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatMonthDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatMonth>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatMonthDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatMonth>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatMonthDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatMonth>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatMonthDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatMonthDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tMonth );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tMonth );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatMonthDTO dto)
		{
			return _repository.Update(Mapper.Map<StatMonth>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatMonthDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatMonth>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatMonthDTO GetDTO(System.String tMonth)
		{
			var entity = _repository.GetEntity(tMonth );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatMonthDTO> GetDTOAsync(System.String tMonth)
		{
			var entity = await _repository.GetEntityAsync(tMonth );
			return Mapper.Map<StatMonthDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatMonthDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatMonthDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatMonthDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatMonthDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatMonthDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMonthDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMonthDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
