...
namespace JX.Application
{
	...
	/// </summary>
	public partial class SurveyServiceAppADO : ISurveyServiceAppADO
	{
		#region 仓储接口
		private readonly ISurveyRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public SurveyServiceAppADO(ISurveyRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(SurveyDTO dto)
		{
			return _repository.Add(Mapper.Map<Survey>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SurveyDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Survey>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(SurveyDTO dto)
		{
			return _repository.Insert(Mapper.Map<Survey>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SurveyDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Survey>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SurveyDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SurveyDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(surveyID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(SurveyDTO dto)
		{
			return _repository.Update(Mapper.Map<Survey>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SurveyDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Survey>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public SurveyDTO GetDTO(System.Int32 surveyID)
		{
			var entity = _repository.GetEntity(surveyID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SurveyDTO> GetDTOAsync(System.Int32 surveyID)
		{
			var entity = await _repository.GetEntityAsync(surveyID );
			return Mapper.Map<SurveyDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SurveyDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SurveyDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SurveyDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SurveyDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<SurveyDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
