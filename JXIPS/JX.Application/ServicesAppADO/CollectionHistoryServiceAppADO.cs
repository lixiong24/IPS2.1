...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CollectionHistoryServiceAppADO : ICollectionHistoryServiceAppADO
	{
		#region 仓储接口
		private readonly ICollectionHistoryRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CollectionHistoryServiceAppADO(ICollectionHistoryRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionHistoryDTO dto)
		{
			return _repository.Add(Mapper.Map<CollectionHistory>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionHistoryDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<CollectionHistory>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionHistoryDTO dto)
		{
			return _repository.Insert(Mapper.Map<CollectionHistory>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionHistoryDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<CollectionHistory>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionHistoryDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionHistoryDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(historyID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(historyID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionHistoryDTO dto)
		{
			return _repository.Update(Mapper.Map<CollectionHistory>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionHistoryDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<CollectionHistory>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CollectionHistoryDTO GetDTO(System.Int32 historyID)
		{
			var entity = _repository.GetEntity(historyID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionHistoryDTO> GetDTOAsync(System.Int32 historyID)
		{
			var entity = await _repository.GetEntityAsync(historyID );
			return Mapper.Map<CollectionHistoryDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionHistoryDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionHistoryDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionHistoryDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionHistoryDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CollectionHistoryDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistoryDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
