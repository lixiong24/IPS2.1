...
namespace JX.Application
{
	...
	/// </summary>
	public partial class CardsServiceAppADO : ICardsServiceAppADO
	{
		#region 仓储接口
		private readonly ICardsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public CardsServiceAppADO(ICardsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(CardsDTO dto)
		{
			return _repository.Add(Mapper.Map<Cards>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CardsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<Cards>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(CardsDTO dto)
		{
			return _repository.Insert(Mapper.Map<Cards>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CardsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<Cards>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CardsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CardsDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(CardsDTO dto)
		{
			return _repository.Update(Mapper.Map<Cards>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CardsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<Cards>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public CardsDTO GetDTO(System.Int32 cardID)
		{
			var entity = _repository.GetEntity(cardID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CardsDTO> GetDTOAsync(System.Int32 cardID)
		{
			var entity = await _repository.GetEntityAsync(cardID );
			return Mapper.Map<CardsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CardsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CardsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CardsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CardsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<CardsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CardsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CardsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
