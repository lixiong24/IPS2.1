...
namespace JX.Application
{
	...
	/// </summary>
	public partial class OrderItemServiceAppADO : IOrderItemServiceAppADO
	{
		#region 仓储接口
		private readonly IOrderItemRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public OrderItemServiceAppADO(IOrderItemRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(OrderItemDTO dto)
		{
			return _repository.Add(Mapper.Map<OrderItem>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderItemDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<OrderItem>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderItemDTO dto)
		{
			return _repository.Insert(Mapper.Map<OrderItem>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderItemDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<OrderItem>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderItemDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderItemDTO dto, bool IsSave)
		{
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderItemDTO dto)
		{
			return _repository.Update(Mapper.Map<OrderItem>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderItemDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<OrderItem>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public OrderItemDTO GetDTO(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderItemDTO> GetDTOAsync(System.Int32 itemID)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderItemDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderItemDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderItemDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderItemDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<OrderItemDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderItemDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
