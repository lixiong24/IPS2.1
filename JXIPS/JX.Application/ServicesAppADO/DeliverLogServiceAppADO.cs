...
namespace JX.Application
{
	...
	/// </summary>
	public partial class DeliverLogServiceAppADO : IDeliverLogServiceAppADO
	{
		#region 仓储接口
		private readonly IDeliverLogRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public DeliverLogServiceAppADO(IDeliverLogRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverLogDTO dto)
		{
			return _repository.Add(Mapper.Map<DeliverLog>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverLogDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<DeliverLog>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverLogDTO dto)
		{
			return _repository.Insert(Mapper.Map<DeliverLog>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverLogDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<DeliverLog>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverLogDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverLogDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(deliverID );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(deliverID );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverLogDTO dto)
		{
			return _repository.Update(Mapper.Map<DeliverLog>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverLogDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<DeliverLog>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public DeliverLogDTO GetDTO(System.Int32 deliverID)
		{
			var entity = _repository.GetEntity(deliverID );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverLogDTO> GetDTOAsync(System.Int32 deliverID)
		{
			var entity = await _repository.GetEntityAsync(deliverID );
			return Mapper.Map<DeliverLogDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverLogDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverLogDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverLogDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverLogDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<DeliverLogDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLogDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
