...
namespace JX.Application
{
	...
	/// </summary>
	public partial class AdvertisementZoneServiceAppADO : IAdvertisementZoneServiceAppADO
	{
		#region 仓储接口
		private readonly IAdvertisementZoneRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public AdvertisementZoneServiceAppADO(IAdvertisementZoneRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(AdvertisementZoneDTO dto)
		{
			return _repository.Add(Mapper.Map<AdvertisementZone>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdvertisementZoneDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<AdvertisementZone>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(AdvertisementZoneDTO dto)
		{
			return _repository.Insert(Mapper.Map<AdvertisementZone>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdvertisementZoneDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<AdvertisementZone>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdvertisementZoneDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdvertisementZoneDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(zoneID,adid );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(zoneID,adid );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(AdvertisementZoneDTO dto)
		{
			return _repository.Update(Mapper.Map<AdvertisementZone>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdvertisementZoneDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<AdvertisementZone>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public AdvertisementZoneDTO GetDTO(System.Int32 zoneID, System.Int32 adid)
		{
			var entity = _repository.GetEntity(zoneID,adid );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdvertisementZoneDTO> GetDTOAsync(System.Int32 zoneID, System.Int32 adid)
		{
			var entity = await _repository.GetEntityAsync(zoneID,adid );
			return Mapper.Map<AdvertisementZoneDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdvertisementZoneDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdvertisementZoneDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdvertisementZoneDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdvertisementZoneDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<AdvertisementZoneDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZoneDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZoneDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
