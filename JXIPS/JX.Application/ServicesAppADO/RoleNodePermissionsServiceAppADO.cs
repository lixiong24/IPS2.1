...
namespace JX.Application
{
	...
	/// </summary>
	public partial class RoleNodePermissionsServiceAppADO : IRoleNodePermissionsServiceAppADO
	{
		#region 仓储接口
		private readonly IRoleNodePermissionsRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public RoleNodePermissionsServiceAppADO(IRoleNodePermissionsRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(RoleNodePermissionsDTO dto)
		{
			return _repository.Add(Mapper.Map<RoleNodePermissions>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleNodePermissionsDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<RoleNodePermissions>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleNodePermissionsDTO dto)
		{
			return _repository.Insert(Mapper.Map<RoleNodePermissions>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleNodePermissionsDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<RoleNodePermissions>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleNodePermissionsDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleNodePermissionsDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(roleID,nodeID,operateCode );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(roleID,nodeID,operateCode );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleNodePermissionsDTO dto)
		{
			return _repository.Update(Mapper.Map<RoleNodePermissions>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleNodePermissionsDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<RoleNodePermissions>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public RoleNodePermissionsDTO GetDTO(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			var entity = _repository.GetEntity(roleID,nodeID,operateCode );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleNodePermissionsDTO> GetDTOAsync(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			var entity = await _repository.GetEntityAsync(roleID,nodeID,operateCode );
			return Mapper.Map<RoleNodePermissionsDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleNodePermissionsDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleNodePermissionsDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleNodePermissionsDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleNodePermissionsDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<RoleNodePermissionsDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissionsDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
