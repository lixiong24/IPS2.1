...
namespace JX.Application
{
	...
	/// </summary>
	public partial class StatKeywordServiceAppADO : IStatKeywordServiceAppADO
	{
		#region 仓储接口
		private readonly IStatKeywordRepositoryADO _repository;
		/// <summary>
		/// 构造器注入
		/// </summary>
		/// <param name="repository"></param>
		public StatKeywordServiceAppADO(IStatKeywordRepositoryADO repository)
		{
		...
		/// <returns></returns>
		public virtual bool Add(StatKeywordDTO dto)
		{
			return _repository.Add(Mapper.Map<StatKeyword>(dto));
		}
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatKeywordDTO dto)
		{
			return await _repository.AddAsync(Mapper.Map<StatKeyword>(dto));
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual int Insert(StatKeywordDTO dto)
		{
			return _repository.Insert(Mapper.Map<StatKeyword>(dto));
		}
		/// <summary>
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatKeywordDTO dto)
		{
			return await _repository.InsertAsync(Mapper.Map<StatKeyword>(dto));
		}
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatKeywordDTO dto, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatKeywordDTO dto, bool IsSave)
		{
		...
		{
			return _repository.Delete(tKeyword );
		}
		/// <summary>
		/// 通过主键删除
		/// </summary>
		...
		{
			return await _repository.DeleteAsync(tKeyword );
		}
		...
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual bool Update(StatKeywordDTO dto)
		{
			return _repository.Update(Mapper.Map<StatKeyword>(dto));
		}
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatKeywordDTO dto)
		{
			return await _repository.UpdateAsync(Mapper.Map<StatKeyword>(dto));
		}
		...
		/// </summary>
		/// <returns></returns>
		public StatKeywordDTO GetDTO(System.String tKeyword)
		{
			var entity = _repository.GetEntity(tKeyword );
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatKeywordDTO> GetDTOAsync(System.String tKeyword)
		{
			var entity = await _repository.GetEntityAsync(tKeyword );
			return Mapper.Map<StatKeywordDTO>(entity);
		}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatKeywordDTO GetDTO(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatKeywordDTO> GetDTOAsync(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatKeywordDTO> GetDTOList(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatKeywordDTO>> GetDTOListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
		...
		/// <returns></returns>
		public IList<StatKeywordDTO> GetList(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeywordDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeywordDTO> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string Sorts, string Filter, out int Total)
		{
			Total = 0;
