...
namespace JX.Application
{
	...
	public interface IServiceApp<T> where T : class
	{
		...
		/// <returns></returns>
		bool Add(T dto, bool IsCommit = true);
		/// <summary>
		/// 增加一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> AddAsync(T dto, bool IsCommit = true);
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool AddList(IList<T> dtoList, bool IsCommit = true);
		/// <summary>
		/// 增加多条记录，同一模型（异步方式）
		/// </summary>
		/// <param name="dtoList">dto模型集合</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> AddListAsync(IList<T> dtoList, bool IsCommit = true);
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool AddOrUpdate(T dto, bool IsSave, bool IsCommit = true);
		/// <summary>
		/// 增加或更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> AddOrUpdateAsync(T dto, bool IsSave, bool IsCommit = true);
		#endregion
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool Delete(T dto, bool IsCommit = true);
		/// <summary>
		/// 删除一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> DeleteAsync(T dto, bool IsCommit = true);
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool DeleteList(IList<T> dtoList, bool IsCommit = true);
		/// <summary>
		/// 删除多条记录，同一模型（异步方式）
		/// </summary>
		/// <param name="dtoList">dto模型集合</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> DeleteListAsync(IList<T> dtoList, bool IsCommit = true);
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool Update(T dto, bool IsCommit = true);
		/// <summary>
		/// 更新一条记录（异步方式）
		/// </summary>
		/// <param name="dto">dto模型</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> UpdateAsync(T dto, bool IsCommit = true);
		...
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		bool UpdateList(IList<T> dtoList, bool IsCommit = true);
		/// <summary>
		/// 更新多条记录，同一模型（异步方式）
		/// </summary>
		/// <param name="dtoList">dto模型集合</param>
		/// <param name="IsCommit">是否提交（默认提交）</param>
		/// <returns></returns>
		Task<bool> UpdateListAsync(IList<T> dtoList, bool IsCommit = true);
