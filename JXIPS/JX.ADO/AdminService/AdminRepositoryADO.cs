...
namespace JX.ADO
{
	...
	public partial class AdminRepositoryADO : IAdminRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual Admin GetEntityFull(string strWhere, Dictionary<string, object> dict = null)
		{
			Admin obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Admin> GetEntityFullAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Admin obj = null;
			string strSQL = "select top 1 * from Admin where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Admin> GetEntityFullList(string strWhere = "", Dictionary<string, object> dict = null)
		{
			...
			using (NullableDataReader reader = _DB.GetDataReader(strSQL, dict))
			{
				while (reader.Read())
				{
					Admin obj = GetEntityFromrdr(reader);
					obj = GetAdminFull(obj);
					list.Add(obj);
				}
			}
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Admin>> GetEntityFullListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Admin> list = new List<Admin>();
			string strSQL = "select * from Admin where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
