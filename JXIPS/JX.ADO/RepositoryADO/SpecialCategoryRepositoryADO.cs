...
namespace JX.ADO
{
	...
	public partial class SpecialCategoryRepositoryADO : ISpecialCategoryRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SpecialCategory entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialCategory entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialCategory entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialCategory entity)
		{
			if(entity.SpecialCategoryID <= 0) entity.SpecialCategoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialCategory entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialCategory entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialCategory entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialCategory entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialCategory SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SpecialCategory GetEntity(System.Int32 specialCategoryID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialCategory> GetEntityAsync(System.Int32 specialCategoryID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialCategoryID = @SpecialCategoryID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialCategory GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialCategory obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialCategory> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialCategory obj = null;
			string strSQL = "select top 1 * from SpecialCategory where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialCategory> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SpecialCategory> list = new List<SpecialCategory>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialCategory>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SpecialCategory> list = new List<SpecialCategory>();
			string strSQL = "select * from SpecialCategory where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SpecialCategory> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SpecialCategory> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SpecialCategory> list = new List<SpecialCategory>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategory> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialCategory> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SpecialCategory> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SpecialCategory> list = new List<SpecialCategory>();
		...
		private static void GetParameters(SpecialCategory entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SpecialCategory GetEntityFromrdr(NullableDataReader rdr)
		{
			SpecialCategory info = new SpecialCategory();
