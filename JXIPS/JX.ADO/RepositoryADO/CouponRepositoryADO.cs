...
namespace JX.ADO
{
	...
	public partial class CouponRepositoryADO : ICouponRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Coupon entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Coupon entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Coupon entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Coupon entity)
		{
			if(entity.CouponID <= 0) entity.CouponID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Coupon entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Coupon entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Coupon entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Coupon entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Coupon SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Coupon GetEntity(System.Int32 couponID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Coupon> GetEntityAsync(System.Int32 couponID)
		{
			string strCondition = string.Empty;
			strCondition += " and CouponID = @CouponID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Coupon GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Coupon obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Coupon> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Coupon obj = null;
			string strSQL = "select top 1 * from Coupon where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Coupon> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Coupon> list = new List<Coupon>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Coupon>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Coupon> list = new List<Coupon>();
			string strSQL = "select * from Coupon where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Coupon> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Coupon> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Coupon> list = new List<Coupon>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Coupon> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Coupon> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Coupon> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Coupon> list = new List<Coupon>();
		...
		private static void GetParameters(Coupon entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Coupon GetEntityFromrdr(NullableDataReader rdr)
		{
