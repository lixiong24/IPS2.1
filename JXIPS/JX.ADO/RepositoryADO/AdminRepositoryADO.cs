...
namespace JX.ADO
{
	...
	public partial class AdminRepositoryADO : IAdminRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Admin entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Admin entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Admin entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Admin entity)
		{
			if(entity.AdminID <= 0) entity.AdminID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Admin entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Admin entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Admin entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Admin entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Admin SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Admin GetEntity(System.Int32 adminID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Admin> GetEntityAsync(System.Int32 adminID)
		{
			string strCondition = string.Empty;
			strCondition += " and AdminID = @AdminID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Admin GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Admin obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Admin> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Admin obj = null;
			string strSQL = "select top 1 * from Admin where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Admin> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Admin>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Admin> list = new List<Admin>();
			string strSQL = "select * from Admin where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Admin> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Admin> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Admin> list = new List<Admin>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Admin> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Admin> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Admin> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Admin> list = new List<Admin>();
		...
		private static void GetParameters(Admin entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Admin GetEntityFromrdr(NullableDataReader rdr)
		{
