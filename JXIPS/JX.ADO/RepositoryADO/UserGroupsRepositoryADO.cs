...
namespace JX.ADO
{
	...
	public partial class UserGroupsRepositoryADO : IUserGroupsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(UserGroups entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserGroups entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(UserGroups entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UserGroups entity)
		{
			if(entity.GroupID <= 0) entity.GroupID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UserGroups entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UserGroups entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(UserGroups entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UserGroups entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update UserGroups SET "+
		...
		/// </summary>
		/// <returns></returns>
		public UserGroups GetEntity(System.Int32 groupID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserGroups> GetEntityAsync(System.Int32 groupID)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserGroups GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			UserGroups obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UserGroups> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			UserGroups obj = null;
			string strSQL = "select top 1 * from UserGroups where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserGroups> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<UserGroups> list = new List<UserGroups>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserGroups>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<UserGroups> list = new List<UserGroups>();
			string strSQL = "select * from UserGroups where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<UserGroups> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<UserGroups> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<UserGroups> list = new List<UserGroups>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroups> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserGroups> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<UserGroups> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<UserGroups> list = new List<UserGroups>();
		...
		private static void GetParameters(UserGroups entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static UserGroups GetEntityFromrdr(NullableDataReader rdr)
		{
