...
namespace JX.ADO
{
	...
	public partial class StatYearRepositoryADO : IStatYearRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatYear entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatYear entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatYear entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatYear entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatYear entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatYear entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatYear entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatYear entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatYear SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatYear GetEntity(System.String tYear)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatYear> GetEntityAsync(System.String tYear)
		{
			string strCondition = string.Empty;
			strCondition += " and TYear = @TYear";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatYear GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatYear obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatYear> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatYear obj = null;
			string strSQL = "select top 1 * from StatYear where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatYear> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatYear> list = new List<StatYear>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatYear>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatYear> list = new List<StatYear>();
			string strSQL = "select * from StatYear where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatYear> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatYear> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatYear> list = new List<StatYear>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYear> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatYear> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatYear> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatYear> list = new List<StatYear>();
		...
		private static void GetParameters(StatYear entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatYear GetEntityFromrdr(NullableDataReader rdr)
		{
			StatYear info = new StatYear();
