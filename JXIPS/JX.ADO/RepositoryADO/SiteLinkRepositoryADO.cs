...
namespace JX.ADO
{
	...
	public partial class SiteLinkRepositoryADO : ISiteLinkRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SiteLink entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SiteLink entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SiteLink entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SiteLink entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SiteLink entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SiteLink entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SiteLink entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SiteLink entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SiteLink SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SiteLink GetEntity(System.Int32 insideLinkID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SiteLink> GetEntityAsync(System.Int32 insideLinkID)
		{
			string strCondition = string.Empty;
			strCondition += " and InsideLinkID = @InsideLinkID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SiteLink GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SiteLink obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SiteLink> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SiteLink obj = null;
			string strSQL = "select top 1 * from SiteLink where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SiteLink> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SiteLink> list = new List<SiteLink>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SiteLink>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SiteLink> list = new List<SiteLink>();
			string strSQL = "select * from SiteLink where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SiteLink> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SiteLink> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SiteLink> list = new List<SiteLink>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLink> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SiteLink> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SiteLink> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SiteLink> list = new List<SiteLink>();
		...
		private static void GetParameters(SiteLink entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SiteLink GetEntityFromrdr(NullableDataReader rdr)
		{
			SiteLink info = new SiteLink();
