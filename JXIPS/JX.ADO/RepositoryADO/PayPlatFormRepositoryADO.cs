...
namespace JX.ADO
{
	...
	public partial class PayPlatFormRepositoryADO : IPayPlatFormRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(PayPlatForm entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PayPlatForm entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PayPlatForm entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PayPlatForm entity)
		{
			if(entity.PayPlatformID <= 0) entity.PayPlatformID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PayPlatForm entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PayPlatForm entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PayPlatForm entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PayPlatForm entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PayPlatForm SET "+
		...
		/// </summary>
		/// <returns></returns>
		public PayPlatForm GetEntity(System.Int32 payPlatformID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PayPlatForm> GetEntityAsync(System.Int32 payPlatformID)
		{
			string strCondition = string.Empty;
			strCondition += " and PayPlatformID = @PayPlatformID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PayPlatForm GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PayPlatForm obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PayPlatForm> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PayPlatForm obj = null;
			string strSQL = "select top 1 * from PayPlatForm where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PayPlatForm> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PayPlatForm> list = new List<PayPlatForm>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PayPlatForm>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PayPlatForm> list = new List<PayPlatForm>();
			string strSQL = "select * from PayPlatForm where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<PayPlatForm> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PayPlatForm> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PayPlatForm> list = new List<PayPlatForm>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatForm> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PayPlatForm> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PayPlatForm> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PayPlatForm> list = new List<PayPlatForm>();
		...
		private static void GetParameters(PayPlatForm entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static PayPlatForm GetEntityFromrdr(NullableDataReader rdr)
		{
			PayPlatForm info = new PayPlatForm();
