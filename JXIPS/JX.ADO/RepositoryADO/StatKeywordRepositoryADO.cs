...
namespace JX.ADO
{
	...
	public partial class StatKeywordRepositoryADO : IStatKeywordRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatKeyword entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatKeyword entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatKeyword entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatKeyword entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatKeyword entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatKeyword entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatKeyword entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatKeyword entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatKeyword SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatKeyword GetEntity(System.String tKeyword)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatKeyword> GetEntityAsync(System.String tKeyword)
		{
			string strCondition = string.Empty;
			strCondition += " and TKeyword = @TKeyword";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatKeyword GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatKeyword obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatKeyword> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatKeyword obj = null;
			string strSQL = "select top 1 * from StatKeyword where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatKeyword> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatKeyword> list = new List<StatKeyword>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatKeyword>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatKeyword> list = new List<StatKeyword>();
			string strSQL = "select * from StatKeyword where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatKeyword> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatKeyword> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatKeyword> list = new List<StatKeyword>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeyword> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatKeyword> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatKeyword> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatKeyword> list = new List<StatKeyword>();
		...
		private static void GetParameters(StatKeyword entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatKeyword GetEntityFromrdr(NullableDataReader rdr)
		{
			StatKeyword info = new StatKeyword();
