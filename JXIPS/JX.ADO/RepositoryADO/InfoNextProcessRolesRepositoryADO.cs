...
namespace JX.ADO
{
	...
	public partial class InfoNextProcessRolesRepositoryADO : IInfoNextProcessRolesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(InfoNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(InfoNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(InfoNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(InfoNextProcessRoles entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(InfoNextProcessRoles entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(InfoNextProcessRoles entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(InfoNextProcessRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(InfoNextProcessRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update InfoNextProcessRoles SET "+
		...
		/// </summary>
		/// <returns></returns>
		public InfoNextProcessRoles GetEntity(System.Int32 generalID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<InfoNextProcessRoles> GetEntityAsync(System.Int32 generalID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralID = @GeneralID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual InfoNextProcessRoles GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			InfoNextProcessRoles obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<InfoNextProcessRoles> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			InfoNextProcessRoles obj = null;
			string strSQL = "select top 1 * from InfoNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<InfoNextProcessRoles> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<InfoNextProcessRoles> list = new List<InfoNextProcessRoles>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<InfoNextProcessRoles>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<InfoNextProcessRoles> list = new List<InfoNextProcessRoles>();
			string strSQL = "select * from InfoNextProcessRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<InfoNextProcessRoles> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<InfoNextProcessRoles> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<InfoNextProcessRoles> list = new List<InfoNextProcessRoles>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<InfoNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<InfoNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<InfoNextProcessRoles> list = new List<InfoNextProcessRoles>();
		...
		private static void GetParameters(InfoNextProcessRoles entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static InfoNextProcessRoles GetEntityFromrdr(NullableDataReader rdr)
		{
			InfoNextProcessRoles info = new InfoNextProcessRoles();
