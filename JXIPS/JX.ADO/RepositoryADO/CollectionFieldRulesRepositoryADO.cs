...
namespace JX.ADO
{
	...
	public partial class CollectionFieldRulesRepositoryADO : ICollectionFieldRulesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionFieldRules entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionFieldRules entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionFieldRules entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionFieldRules entity)
		{
			if(entity.FieldRuleID <= 0) entity.FieldRuleID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionFieldRules entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionFieldRules entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionFieldRules entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionFieldRules entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionFieldRules SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CollectionFieldRules GetEntity(System.Int32 fieldRuleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionFieldRules> GetEntityAsync(System.Int32 fieldRuleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FieldRuleID = @FieldRuleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionFieldRules GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFieldRules obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionFieldRules> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionFieldRules obj = null;
			string strSQL = "select top 1 * from CollectionFieldRules where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionFieldRules> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionFieldRules> list = new List<CollectionFieldRules>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionFieldRules>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionFieldRules> list = new List<CollectionFieldRules>();
			string strSQL = "select * from CollectionFieldRules where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CollectionFieldRules> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionFieldRules> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionFieldRules> list = new List<CollectionFieldRules>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionFieldRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionFieldRules> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionFieldRules> list = new List<CollectionFieldRules>();
		...
		private static void GetParameters(CollectionFieldRules entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CollectionFieldRules GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionFieldRules info = new CollectionFieldRules();
