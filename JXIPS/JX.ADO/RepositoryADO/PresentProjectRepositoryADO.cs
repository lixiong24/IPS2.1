...
namespace JX.ADO
{
	...
	public partial class PresentProjectRepositoryADO : IPresentProjectRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(PresentProject entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PresentProject entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PresentProject entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PresentProject entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PresentProject entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PresentProject entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PresentProject entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PresentProject entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PresentProject SET "+
		...
		/// </summary>
		/// <returns></returns>
		public PresentProject GetEntity(System.Int32 projectID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PresentProject> GetEntityAsync(System.Int32 projectID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProjectID = @ProjectID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PresentProject GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentProject obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PresentProject> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PresentProject obj = null;
			string strSQL = "select top 1 * from PresentProject where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PresentProject> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PresentProject> list = new List<PresentProject>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PresentProject>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PresentProject> list = new List<PresentProject>();
			string strSQL = "select * from PresentProject where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<PresentProject> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PresentProject> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PresentProject> list = new List<PresentProject>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProject> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PresentProject> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PresentProject> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PresentProject> list = new List<PresentProject>();
		...
		private static void GetParameters(PresentProject entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static PresentProject GetEntityFromrdr(NullableDataReader rdr)
		{
			PresentProject info = new PresentProject();
