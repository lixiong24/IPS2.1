...
namespace JX.ADO
{
	...
	public partial class ProducerRepositoryADO : IProducerRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Producer entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Producer entity)
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Producer entity)
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Producer entity)
		{
			if(entity.ProducerID <= 0) entity.ProducerID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Producer entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Producer entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Producer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Producer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Producer SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Producer GetEntity(System.Int32 producerID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Producer> GetEntityAsync(System.Int32 producerID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProducerID = @ProducerID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Producer GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Producer obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Producer> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Producer obj = null;
			string strSQL = "select top 1 * from Producer where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Producer> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Producer> list = new List<Producer>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Producer>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Producer> list = new List<Producer>();
			string strSQL = "select * from Producer where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Producer> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Producer> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Producer> list = new List<Producer>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Producer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Producer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Producer> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Producer> list = new List<Producer>();
		...
		private static void GetParameters(Producer entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Producer GetEntityFromrdr(NullableDataReader rdr)
		{
			Producer info = new Producer();
