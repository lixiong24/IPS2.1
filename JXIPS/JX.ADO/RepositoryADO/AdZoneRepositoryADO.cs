...
namespace JX.ADO
{
	...
	public partial class AdZoneRepositoryADO : IAdZoneRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(AdZone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdZone entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdZone entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdZone entity)
		{
			if(entity.ZoneID <= 0) entity.ZoneID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdZone entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdZone entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdZone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdZone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdZone SET "+
		...
		/// </summary>
		/// <returns></returns>
		public AdZone GetEntity(System.Int32 zoneID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdZone> GetEntityAsync(System.Int32 zoneID)
		{
			string strCondition = string.Empty;
			strCondition += " and ZoneID = @ZoneID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdZone GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdZone obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdZone> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdZone obj = null;
			string strSQL = "select top 1 * from AdZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdZone> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdZone> list = new List<AdZone>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdZone>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdZone> list = new List<AdZone>();
			string strSQL = "select * from AdZone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<AdZone> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdZone> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdZone> list = new List<AdZone>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdZone> list = new List<AdZone>();
		...
		private static void GetParameters(AdZone entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static AdZone GetEntityFromrdr(NullableDataReader rdr)
		{
			AdZone info = new AdZone();
