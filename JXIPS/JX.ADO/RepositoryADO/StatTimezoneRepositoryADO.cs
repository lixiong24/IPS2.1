...
namespace JX.ADO
{
	...
	public partial class StatTimezoneRepositoryADO : IStatTimezoneRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatTimezone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatTimezone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatTimezone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatTimezone entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatTimezone entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatTimezone entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatTimezone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatTimezone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatTimezone SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatTimezone GetEntity(System.String tTimezone)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatTimezone> GetEntityAsync(System.String tTimezone)
		{
			string strCondition = string.Empty;
			strCondition += " and TTimezone = @TTimezone";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatTimezone GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatTimezone obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatTimezone> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatTimezone obj = null;
			string strSQL = "select top 1 * from StatTimezone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatTimezone> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatTimezone> list = new List<StatTimezone>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatTimezone>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatTimezone> list = new List<StatTimezone>();
			string strSQL = "select * from StatTimezone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatTimezone> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatTimezone> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatTimezone> list = new List<StatTimezone>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatTimezone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatTimezone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatTimezone> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatTimezone> list = new List<StatTimezone>();
		...
		private static void GetParameters(StatTimezone entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatTimezone GetEntityFromrdr(NullableDataReader rdr)
		{
			StatTimezone info = new StatTimezone();
