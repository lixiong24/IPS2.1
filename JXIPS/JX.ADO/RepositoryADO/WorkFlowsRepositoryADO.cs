...
namespace JX.ADO
{
	...
	public partial class WorkFlowsRepositoryADO : IWorkFlowsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(WorkFlows entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkFlows entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkFlows entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkFlows entity)
		{
			if(entity.FlowID <= 0) entity.FlowID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkFlows entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkFlows entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkFlows entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkFlows entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkFlows SET "+
		...
		/// </summary>
		/// <returns></returns>
		public WorkFlows GetEntity(System.Int32 flowID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkFlows> GetEntityAsync(System.Int32 flowID)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkFlows GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkFlows obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkFlows> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkFlows obj = null;
			string strSQL = "select top 1 * from WorkFlows where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkFlows> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkFlows> list = new List<WorkFlows>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkFlows>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkFlows> list = new List<WorkFlows>();
			string strSQL = "select * from WorkFlows where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<WorkFlows> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WorkFlows> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WorkFlows> list = new List<WorkFlows>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlows> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkFlows> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WorkFlows> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WorkFlows> list = new List<WorkFlows>();
		...
		private static void GetParameters(WorkFlows entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static WorkFlows GetEntityFromrdr(NullableDataReader rdr)
		{
			WorkFlows info = new WorkFlows();
