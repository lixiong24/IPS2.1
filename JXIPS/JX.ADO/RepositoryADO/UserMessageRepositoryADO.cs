...
namespace JX.ADO
{
	...
	public partial class UserMessageRepositoryADO : IUserMessageRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(UserMessage entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(UserMessage entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(UserMessage entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(UserMessage entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(UserMessage entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(UserMessage entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(UserMessage entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(UserMessage entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update UserMessage SET "+
		...
		/// </summary>
		/// <returns></returns>
		public UserMessage GetEntity(System.Int32 messageID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<UserMessage> GetEntityAsync(System.Int32 messageID)
		{
			string strCondition = string.Empty;
			strCondition += " and MessageID = @MessageID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual UserMessage GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<UserMessage> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			UserMessage obj = null;
			string strSQL = "select top 1 * from UserMessage where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<UserMessage> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<UserMessage>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<UserMessage> list = new List<UserMessage>();
			string strSQL = "select * from UserMessage where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<UserMessage> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<UserMessage> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<UserMessage> list = new List<UserMessage>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessage> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<UserMessage> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<UserMessage> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<UserMessage> list = new List<UserMessage>();
		...
		private static void GetParameters(UserMessage entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static UserMessage GetEntityFromrdr(NullableDataReader rdr)
		{
