...
namespace JX.ADO
{
	...
	public partial class RoleSpecialPermissionsRepositoryADO : IRoleSpecialPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RoleSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleSpecialPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleSpecialPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleSpecialPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleSpecialPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleSpecialPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleSpecialPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RoleSpecialPermissions GetEntity(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleSpecialPermissions> GetEntityAsync(System.Int32 roleID, System.Int32 specialID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleSpecialPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleSpecialPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleSpecialPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleSpecialPermissions obj = null;
			string strSQL = "select top 1 * from RoleSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleSpecialPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleSpecialPermissions> list = new List<RoleSpecialPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleSpecialPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleSpecialPermissions> list = new List<RoleSpecialPermissions>();
			string strSQL = "select * from RoleSpecialPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RoleSpecialPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleSpecialPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleSpecialPermissions> list = new List<RoleSpecialPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleSpecialPermissions> list = new List<RoleSpecialPermissions>();
		...
		private static void GetParameters(RoleSpecialPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RoleSpecialPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleSpecialPermissions info = new RoleSpecialPermissions();
