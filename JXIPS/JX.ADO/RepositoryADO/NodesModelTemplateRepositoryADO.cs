...
namespace JX.ADO
{
	...
	public partial class NodesModelTemplateRepositoryADO : INodesModelTemplateRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(NodesModelTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(NodesModelTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(NodesModelTemplate entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(NodesModelTemplate entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(NodesModelTemplate entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(NodesModelTemplate entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(NodesModelTemplate entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(NodesModelTemplate entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update NodesModelTemplate SET "+
		...
		/// </summary>
		/// <returns></returns>
		public NodesModelTemplate GetEntity(System.Int32 nodeID, System.Int32 modelID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<NodesModelTemplate> GetEntityAsync(System.Int32 nodeID, System.Int32 modelID)
		{
			string strCondition = string.Empty;
			strCondition += " and NodeID = @NodeID";
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual NodesModelTemplate GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesModelTemplate obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<NodesModelTemplate> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			NodesModelTemplate obj = null;
			string strSQL = "select top 1 * from NodesModelTemplate where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<NodesModelTemplate> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<NodesModelTemplate> list = new List<NodesModelTemplate>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<NodesModelTemplate>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<NodesModelTemplate> list = new List<NodesModelTemplate>();
			string strSQL = "select * from NodesModelTemplate where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<NodesModelTemplate> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<NodesModelTemplate> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<NodesModelTemplate> list = new List<NodesModelTemplate>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<NodesModelTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<NodesModelTemplate> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<NodesModelTemplate> list = new List<NodesModelTemplate>();
		...
		private static void GetParameters(NodesModelTemplate entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static NodesModelTemplate GetEntityFromrdr(NullableDataReader rdr)
		{
			NodesModelTemplate info = new NodesModelTemplate();
