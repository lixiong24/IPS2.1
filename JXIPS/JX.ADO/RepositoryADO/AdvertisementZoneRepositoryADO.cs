...
namespace JX.ADO
{
	...
	public partial class AdvertisementZoneRepositoryADO : IAdvertisementZoneRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(AdvertisementZone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdvertisementZone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdvertisementZone entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdvertisementZone entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdvertisementZone entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdvertisementZone entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdvertisementZone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdvertisementZone entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdvertisementZone SET "+
		...
		/// </summary>
		/// <returns></returns>
		public AdvertisementZone GetEntity(System.Int32 zoneID, System.Int32 adid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdvertisementZone> GetEntityAsync(System.Int32 zoneID, System.Int32 adid)
		{
			string strCondition = string.Empty;
			strCondition += " and ZoneID = @ZoneID";
			strCondition += " and ADID = @ADID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdvertisementZone GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdvertisementZone obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdvertisementZone> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdvertisementZone obj = null;
			string strSQL = "select top 1 * from AdvertisementZone where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdvertisementZone> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementZone> list = new List<AdvertisementZone>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdvertisementZone>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdvertisementZone> list = new List<AdvertisementZone>();
			string strSQL = "select * from AdvertisementZone where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<AdvertisementZone> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdvertisementZone> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdvertisementZone> list = new List<AdvertisementZone>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdvertisementZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdvertisementZone> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdvertisementZone> list = new List<AdvertisementZone>();
		...
		private static void GetParameters(AdvertisementZone entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static AdvertisementZone GetEntityFromrdr(NullableDataReader rdr)
		{
			AdvertisementZone info = new AdvertisementZone();
