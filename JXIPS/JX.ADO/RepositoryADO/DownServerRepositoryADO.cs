...
namespace JX.ADO
{
	...
	public partial class DownServerRepositoryADO : IDownServerRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(DownServer entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DownServer entity)
		{
			if(entity.ServerID <= 0) entity.ServerID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DownServer entity)
		{
			if(entity.ServerID <= 0) entity.ServerID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DownServer entity)
		{
			if(entity.ServerID <= 0) entity.ServerID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DownServer entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DownServer entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DownServer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DownServer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DownServer SET "+
		...
		/// </summary>
		/// <returns></returns>
		public DownServer GetEntity(System.Int32 serverID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DownServer> GetEntityAsync(System.Int32 serverID)
		{
			string strCondition = string.Empty;
			strCondition += " and ServerID = @ServerID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DownServer GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DownServer obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DownServer> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DownServer obj = null;
			string strSQL = "select top 1 * from DownServer where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DownServer> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DownServer> list = new List<DownServer>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DownServer>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DownServer> list = new List<DownServer>();
			string strSQL = "select * from DownServer where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<DownServer> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DownServer> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DownServer> list = new List<DownServer>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownServer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DownServer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DownServer> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DownServer> list = new List<DownServer>();
		...
		private static void GetParameters(DownServer entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static DownServer GetEntityFromrdr(NullableDataReader rdr)
		{
			DownServer info = new DownServer();
