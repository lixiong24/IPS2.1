...
namespace JX.ADO
{
	...
	public partial class OrdersRepositoryADO : IOrdersRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Orders entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Orders entity)
		{
			if(entity.OrderID <= 0) entity.OrderID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Orders entity)
		{
			if(entity.OrderID <= 0) entity.OrderID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Orders entity)
		{
			if(entity.OrderID <= 0) entity.OrderID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Orders entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Orders entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Orders entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Orders entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Orders SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Orders GetEntity(System.Int32 orderID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Orders> GetEntityAsync(System.Int32 orderID)
		{
			string strCondition = string.Empty;
			strCondition += " and OrderID = @OrderID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Orders GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Orders obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Orders> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Orders obj = null;
			string strSQL = "select top 1 * from Orders where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Orders> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Orders>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Orders> list = new List<Orders>();
			string strSQL = "select * from Orders where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Orders> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Orders> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Orders> list = new List<Orders>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Orders> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Orders> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Orders> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Orders> list = new List<Orders>();
		...
		private static void GetParameters(Orders entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Orders GetEntityFromrdr(NullableDataReader rdr)
		{
