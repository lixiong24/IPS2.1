...
namespace JX.ADO
{
	...
	public partial class GroupSpecialCategoryPermissionsRepositoryADO : IGroupSpecialCategoryPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialCategoryPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialCategoryPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupSpecialCategoryPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupSpecialCategoryPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialCategoryPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialCategoryPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialCategoryPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialCategoryPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupSpecialCategoryPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public GroupSpecialCategoryPermissions GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialCategoryID, System.Int32 iDType)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupSpecialCategoryPermissions> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialCategoryID, System.Int32 iDType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupSpecialCategoryPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialCategoryPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialCategoryPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialCategoryPermissions obj = null;
			string strSQL = "select top 1 * from GroupSpecialCategoryPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialCategoryPermissions> list = new List<GroupSpecialCategoryPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupSpecialCategoryPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialCategoryPermissions> list = new List<GroupSpecialCategoryPermissions>();
			string strSQL = "select * from GroupSpecialCategoryPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupSpecialCategoryPermissions> list = new List<GroupSpecialCategoryPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialCategoryPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialCategoryPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupSpecialCategoryPermissions> list = new List<GroupSpecialCategoryPermissions>();
		...
		private static void GetParameters(GroupSpecialCategoryPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupSpecialCategoryPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupSpecialCategoryPermissions info = new GroupSpecialCategoryPermissions();
