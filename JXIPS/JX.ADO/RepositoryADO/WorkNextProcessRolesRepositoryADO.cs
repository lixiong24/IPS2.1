...
namespace JX.ADO
{
	...
	public partial class WorkNextProcessRolesRepositoryADO : IWorkNextProcessRolesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(WorkNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(WorkNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(WorkNextProcessRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(WorkNextProcessRoles entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(WorkNextProcessRoles entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(WorkNextProcessRoles entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(WorkNextProcessRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(WorkNextProcessRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update WorkNextProcessRoles SET "+
		...
		/// </summary>
		/// <returns></returns>
		public WorkNextProcessRoles GetEntity(System.Int32 workID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<WorkNextProcessRoles> GetEntityAsync(System.Int32 workID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and WorkID = @WorkID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual WorkNextProcessRoles GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkNextProcessRoles obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<WorkNextProcessRoles> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			WorkNextProcessRoles obj = null;
			string strSQL = "select top 1 * from WorkNextProcessRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<WorkNextProcessRoles> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<WorkNextProcessRoles> list = new List<WorkNextProcessRoles>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<WorkNextProcessRoles>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<WorkNextProcessRoles> list = new List<WorkNextProcessRoles>();
			string strSQL = "select * from WorkNextProcessRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<WorkNextProcessRoles> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WorkNextProcessRoles> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WorkNextProcessRoles> list = new List<WorkNextProcessRoles>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<WorkNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<WorkNextProcessRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<WorkNextProcessRoles> list = new List<WorkNextProcessRoles>();
		...
		private static void GetParameters(WorkNextProcessRoles entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static WorkNextProcessRoles GetEntityFromrdr(NullableDataReader rdr)
		{
			WorkNextProcessRoles info = new WorkNextProcessRoles();
