...
namespace JX.ADO
{
	...
	public partial class CourierRepositoryADO : ICourierRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Courier entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Courier entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Courier entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Courier entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Courier entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Courier entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Courier entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Courier entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Courier SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Courier GetEntity(System.Int32 courierID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Courier> GetEntityAsync(System.Int32 courierID)
		{
			string strCondition = string.Empty;
			strCondition += " and CourierID = @CourierID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Courier GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Courier obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Courier> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Courier obj = null;
			string strSQL = "select top 1 * from Courier where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Courier> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Courier> list = new List<Courier>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Courier>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Courier> list = new List<Courier>();
			string strSQL = "select * from Courier where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Courier> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Courier> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Courier> list = new List<Courier>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Courier> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Courier> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Courier> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Courier> list = new List<Courier>();
		...
		private static void GetParameters(Courier entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Courier GetEntityFromrdr(NullableDataReader rdr)
		{
			Courier info = new Courier();
