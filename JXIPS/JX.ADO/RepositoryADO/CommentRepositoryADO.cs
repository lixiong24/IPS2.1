...
namespace JX.ADO
{
	...
	public partial class CommentRepositoryADO : ICommentRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Comment entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Comment entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Comment entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Comment entity)
		{
			if(entity.CommentID <= 0) entity.CommentID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Comment entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Comment entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Comment entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Comment entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Comment SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Comment GetEntity(System.Int32 commentID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Comment> GetEntityAsync(System.Int32 commentID)
		{
			string strCondition = string.Empty;
			strCondition += " and CommentID = @CommentID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Comment GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Comment obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Comment> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Comment obj = null;
			string strSQL = "select top 1 * from Comment where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Comment> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Comment>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Comment> list = new List<Comment>();
			string strSQL = "select * from Comment where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Comment> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Comment> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Comment> list = new List<Comment>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Comment> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Comment> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Comment> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Comment> list = new List<Comment>();
		...
		private static void GetParameters(Comment entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Comment GetEntityFromrdr(NullableDataReader rdr)
		{
