...
namespace JX.ADO
{
	...
	public partial class SpecialsRepositoryADO : ISpecialsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Specials entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Specials entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Specials entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Specials entity)
		{
			if(entity.SpecialID <= 0) entity.SpecialID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Specials entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Specials entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Specials entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Specials entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Specials SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Specials GetEntity(System.Int32 specialID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Specials> GetEntityAsync(System.Int32 specialID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Specials GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Specials obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Specials> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Specials obj = null;
			string strSQL = "select top 1 * from Specials where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Specials> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Specials> list = new List<Specials>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Specials>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Specials> list = new List<Specials>();
			string strSQL = "select * from Specials where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Specials> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Specials> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Specials> list = new List<Specials>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Specials> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Specials> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Specials> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Specials> list = new List<Specials>();
		...
		private static void GetParameters(Specials entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Specials GetEntityFromrdr(NullableDataReader rdr)
		{
			Specials info = new Specials();
