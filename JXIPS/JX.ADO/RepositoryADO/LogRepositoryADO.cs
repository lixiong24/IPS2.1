...
namespace JX.ADO
{
	...
	public partial class LogRepositoryADO : ILogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Log entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Log entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Log entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Log entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Log entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Log entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Log entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Log entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Log SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Log GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Log> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Log GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Log obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Log> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Log obj = null;
			string strSQL = "select top 1 * from Log where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Log> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Log>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Log> list = new List<Log>();
			string strSQL = "select * from Log where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Log> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Log> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Log> list = new List<Log>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Log> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Log> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Log> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Log> list = new List<Log>();
		...
		private static void GetParameters(Log entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Log GetEntityFromrdr(NullableDataReader rdr)
		{
			Log info = new Log();
