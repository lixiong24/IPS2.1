...
namespace JX.ADO
{
	...
	public partial class SpecialInfosRepositoryADO : ISpecialInfosRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SpecialInfos entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SpecialInfos entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SpecialInfos entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SpecialInfos entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SpecialInfos entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SpecialInfos entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SpecialInfos entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SpecialInfos entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SpecialInfos SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SpecialInfos GetEntity(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SpecialInfos> GetEntityAsync(System.Int32 specialInfoID, System.Int32 specialID, System.Int32 generalID)
		{
			string strCondition = string.Empty;
			strCondition += " and SpecialInfoID = @SpecialInfoID";
			strCondition += " and SpecialID = @SpecialID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SpecialInfos GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialInfos obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SpecialInfos> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SpecialInfos obj = null;
			string strSQL = "select top 1 * from SpecialInfos where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SpecialInfos> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SpecialInfos> list = new List<SpecialInfos>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SpecialInfos>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SpecialInfos> list = new List<SpecialInfos>();
			string strSQL = "select * from SpecialInfos where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SpecialInfos> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SpecialInfos> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SpecialInfos> list = new List<SpecialInfos>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfos> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SpecialInfos> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SpecialInfos> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SpecialInfos> list = new List<SpecialInfos>();
		...
		private static void GetParameters(SpecialInfos entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SpecialInfos GetEntityFromrdr(NullableDataReader rdr)
		{
			SpecialInfos info = new SpecialInfos();
