...
namespace JX.ADO
{
	...
	public partial class ComplaintsResultsRepositoryADO : IComplaintsResultsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ComplaintsResults entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplaintsResults entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplaintsResults entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplaintsResults entity)
		{
			if(entity.RID <= 0) entity.RID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplaintsResults entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplaintsResults entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplaintsResults entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplaintsResults entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplaintsResults SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ComplaintsResults GetEntity(System.Int32 rid)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplaintsResults> GetEntityAsync(System.Int32 rid)
		{
			string strCondition = string.Empty;
			strCondition += " and RID = @RID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplaintsResults GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsResults obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplaintsResults> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplaintsResults obj = null;
			string strSQL = "select top 1 * from ComplaintsResults where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplaintsResults> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsResults> list = new List<ComplaintsResults>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplaintsResults>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplaintsResults> list = new List<ComplaintsResults>();
			string strSQL = "select * from ComplaintsResults where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ComplaintsResults> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplaintsResults> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplaintsResults> list = new List<ComplaintsResults>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResults> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplaintsResults> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplaintsResults> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplaintsResults> list = new List<ComplaintsResults>();
		...
		private static void GetParameters(ComplaintsResults entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ComplaintsResults GetEntityFromrdr(NullableDataReader rdr)
		{
			ComplaintsResults info = new ComplaintsResults();
