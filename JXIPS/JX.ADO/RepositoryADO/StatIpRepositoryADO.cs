...
namespace JX.ADO
{
	...
	public partial class StatIpRepositoryADO : IStatIpRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatIp entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatIp entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatIp entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatIp entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatIp entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatIp entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatIp entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatIp entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatIp SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatIp GetEntity(System.String tIp)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatIp> GetEntityAsync(System.String tIp)
		{
			string strCondition = string.Empty;
			strCondition += " and TIp = @TIp";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatIp GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIp obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatIp> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatIp obj = null;
			string strSQL = "select top 1 * from StatIp where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatIp> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatIp> list = new List<StatIp>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatIp>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatIp> list = new List<StatIp>();
			string strSQL = "select * from StatIp where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatIp> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatIp> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatIp> list = new List<StatIp>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIp> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatIp> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatIp> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatIp> list = new List<StatIp>();
		...
		private static void GetParameters(StatIp entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatIp GetEntityFromrdr(NullableDataReader rdr)
		{
			StatIp info = new StatIp();
