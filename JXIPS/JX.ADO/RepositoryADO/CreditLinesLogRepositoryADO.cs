...
namespace JX.ADO
{
	...
	public partial class CreditLinesLogRepositoryADO : ICreditLinesLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CreditLinesLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CreditLinesLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CreditLinesLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CreditLinesLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CreditLinesLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CreditLinesLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CreditLinesLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CreditLinesLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CreditLinesLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CreditLinesLog GetEntity(System.Int32 logID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CreditLinesLog> GetEntityAsync(System.Int32 logID)
		{
			string strCondition = string.Empty;
			strCondition += " and LogID = @LogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CreditLinesLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CreditLinesLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CreditLinesLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CreditLinesLog obj = null;
			string strSQL = "select top 1 * from CreditLinesLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CreditLinesLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CreditLinesLog> list = new List<CreditLinesLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CreditLinesLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CreditLinesLog> list = new List<CreditLinesLog>();
			string strSQL = "select * from CreditLinesLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CreditLinesLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CreditLinesLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CreditLinesLog> list = new List<CreditLinesLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CreditLinesLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CreditLinesLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CreditLinesLog> list = new List<CreditLinesLog>();
		...
		private static void GetParameters(CreditLinesLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CreditLinesLog GetEntityFromrdr(NullableDataReader rdr)
		{
			CreditLinesLog info = new CreditLinesLog();
