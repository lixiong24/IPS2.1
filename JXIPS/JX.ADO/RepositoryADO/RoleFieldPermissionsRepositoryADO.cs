...
namespace JX.ADO
{
	...
	public partial class RoleFieldPermissionsRepositoryADO : IRoleFieldPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RoleFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleFieldPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleFieldPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleFieldPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleFieldPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleFieldPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleFieldPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleFieldPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RoleFieldPermissions GetEntity(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleFieldPermissions> GetEntityAsync(System.Int32 roleID, System.Int32 modelID, System.String fieldName, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and ModelID = @ModelID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleFieldPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleFieldPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleFieldPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleFieldPermissions obj = null;
			string strSQL = "select top 1 * from RoleFieldPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleFieldPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleFieldPermissions> list = new List<RoleFieldPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleFieldPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleFieldPermissions> list = new List<RoleFieldPermissions>();
			string strSQL = "select * from RoleFieldPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RoleFieldPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleFieldPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleFieldPermissions> list = new List<RoleFieldPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleFieldPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleFieldPermissions> list = new List<RoleFieldPermissions>();
		...
		private static void GetParameters(RoleFieldPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RoleFieldPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleFieldPermissions info = new RoleFieldPermissions();
