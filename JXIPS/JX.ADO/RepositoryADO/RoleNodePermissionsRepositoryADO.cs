...
namespace JX.ADO
{
	...
	public partial class RoleNodePermissionsRepositoryADO : IRoleNodePermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RoleNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RoleNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RoleNodePermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RoleNodePermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RoleNodePermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RoleNodePermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RoleNodePermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RoleNodePermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RoleNodePermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RoleNodePermissions GetEntity(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RoleNodePermissions> GetEntityAsync(System.Int32 roleID, System.Int32 nodeID, System.String operateCode)
		{
			string strCondition = string.Empty;
			strCondition += " and RoleID = @RoleID";
			strCondition += " and NodeID = @NodeID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RoleNodePermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleNodePermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RoleNodePermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RoleNodePermissions obj = null;
			string strSQL = "select top 1 * from RoleNodePermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RoleNodePermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RoleNodePermissions> list = new List<RoleNodePermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RoleNodePermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RoleNodePermissions> list = new List<RoleNodePermissions>();
			string strSQL = "select * from RoleNodePermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RoleNodePermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleNodePermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleNodePermissions> list = new List<RoleNodePermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RoleNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RoleNodePermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RoleNodePermissions> list = new List<RoleNodePermissions>();
		...
		private static void GetParameters(RoleNodePermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RoleNodePermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			RoleNodePermissions info = new RoleNodePermissions();
