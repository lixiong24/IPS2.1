...
namespace JX.ADO
{
	...
	public partial class GroupSpecialPermissionsRepositoryADO : IGroupSpecialPermissionsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(GroupSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(GroupSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(GroupSpecialPermissions entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(GroupSpecialPermissions entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(GroupSpecialPermissions entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(GroupSpecialPermissions entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(GroupSpecialPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(GroupSpecialPermissions entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update GroupSpecialPermissions SET "+
		...
		/// </summary>
		/// <returns></returns>
		public GroupSpecialPermissions GetEntity(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<GroupSpecialPermissions> GetEntityAsync(System.Int32 groupID, System.Int32 operateCode, System.Int32 specialID, System.Int32 iDType)
		{
			string strCondition = string.Empty;
			strCondition += " and GroupID = @GroupID";
			strCondition += " and OperateCode = @OperateCode";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual GroupSpecialPermissions GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialPermissions obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<GroupSpecialPermissions> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			GroupSpecialPermissions obj = null;
			string strSQL = "select top 1 * from GroupSpecialPermissions where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialPermissions> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialPermissions> list = new List<GroupSpecialPermissions>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<GroupSpecialPermissions>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<GroupSpecialPermissions> list = new List<GroupSpecialPermissions>();
			string strSQL = "select * from GroupSpecialPermissions where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<GroupSpecialPermissions> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialPermissions> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupSpecialPermissions> list = new List<GroupSpecialPermissions>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<GroupSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<GroupSpecialPermissions> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<GroupSpecialPermissions> list = new List<GroupSpecialPermissions>();
		...
		private static void GetParameters(GroupSpecialPermissions entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static GroupSpecialPermissions GetEntityFromrdr(NullableDataReader rdr)
		{
			GroupSpecialPermissions info = new GroupSpecialPermissions();
