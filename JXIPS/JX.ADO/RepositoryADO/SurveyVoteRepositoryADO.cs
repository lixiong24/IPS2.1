...
namespace JX.ADO
{
	...
	public partial class SurveyVoteRepositoryADO : ISurveyVoteRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(SurveyVote entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(SurveyVote entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(SurveyVote entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(SurveyVote entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(SurveyVote entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(SurveyVote entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(SurveyVote entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(SurveyVote entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update SurveyVote SET "+
		...
		/// </summary>
		/// <returns></returns>
		public SurveyVote GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<SurveyVote> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual SurveyVote GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyVote obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<SurveyVote> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			SurveyVote obj = null;
			string strSQL = "select top 1 * from SurveyVote where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<SurveyVote> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<SurveyVote> list = new List<SurveyVote>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<SurveyVote>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<SurveyVote> list = new List<SurveyVote>();
			string strSQL = "select * from SurveyVote where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<SurveyVote> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SurveyVote> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SurveyVote> list = new List<SurveyVote>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVote> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<SurveyVote> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<SurveyVote> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<SurveyVote> list = new List<SurveyVote>();
		...
		private static void GetParameters(SurveyVote entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static SurveyVote GetEntityFromrdr(NullableDataReader rdr)
		{
			SurveyVote info = new SurveyVote();
