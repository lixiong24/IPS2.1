...
namespace JX.ADO
{
	...
	public partial class ModelTemplatesRepositoryADO : IModelTemplatesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ModelTemplates entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ModelTemplates entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ModelTemplates entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ModelTemplates entity)
		{
			if(entity.TemplateID <= 0) entity.TemplateID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ModelTemplates entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ModelTemplates entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ModelTemplates entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ModelTemplates entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ModelTemplates SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ModelTemplates GetEntity(System.Int32 templateID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ModelTemplates> GetEntityAsync(System.Int32 templateID)
		{
			string strCondition = string.Empty;
			strCondition += " and TemplateID = @TemplateID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ModelTemplates GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelTemplates obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ModelTemplates> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ModelTemplates obj = null;
			string strSQL = "select top 1 * from ModelTemplates where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ModelTemplates> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ModelTemplates> list = new List<ModelTemplates>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ModelTemplates>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ModelTemplates> list = new List<ModelTemplates>();
			string strSQL = "select * from ModelTemplates where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ModelTemplates> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ModelTemplates> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ModelTemplates> list = new List<ModelTemplates>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplates> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ModelTemplates> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ModelTemplates> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ModelTemplates> list = new List<ModelTemplates>();
		...
		private static void GetParameters(ModelTemplates entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ModelTemplates GetEntityFromrdr(NullableDataReader rdr)
		{
			ModelTemplates info = new ModelTemplates();
