...
namespace JX.ADO
{
	...
	public partial class VoteRepositoryADO : IVoteRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(Vote entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(Vote entity)
		{
			if(entity.GeneralId <= 0) entity.GeneralId=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(Vote entity)
		{
			if(entity.GeneralId <= 0) entity.GeneralId=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(Vote entity)
		{
			if(entity.GeneralId <= 0) entity.GeneralId=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(Vote entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(Vote entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(Vote entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(Vote entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update Vote SET "+
		...
		/// </summary>
		/// <returns></returns>
		public Vote GetEntity(System.Int32 generalId)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<Vote> GetEntityAsync(System.Int32 generalId)
		{
			string strCondition = string.Empty;
			strCondition += " and GeneralId = @GeneralId";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual Vote GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			Vote obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<Vote> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			Vote obj = null;
			string strSQL = "select top 1 * from Vote where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<Vote> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<Vote> list = new List<Vote>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<Vote>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<Vote> list = new List<Vote>();
			string strSQL = "select * from Vote where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<Vote> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Vote> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Vote> list = new List<Vote>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Vote> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<Vote> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<Vote> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<Vote> list = new List<Vote>();
		...
		private static void GetParameters(Vote entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static Vote GetEntityFromrdr(NullableDataReader rdr)
		{
			Vote info = new Vote();
