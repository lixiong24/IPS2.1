...
namespace JX.ADO
{
	...
	public partial class CollectionHistoryRepositoryADO : ICollectionHistoryRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(CollectionHistory entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(CollectionHistory entity)
		{
			if(entity.HistoryID <= 0) entity.HistoryID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(CollectionHistory entity)
		{
			if(entity.HistoryID <= 0) entity.HistoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(CollectionHistory entity)
		{
			if(entity.HistoryID <= 0) entity.HistoryID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(CollectionHistory entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(CollectionHistory entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(CollectionHistory entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(CollectionHistory entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update CollectionHistory SET "+
		...
		/// </summary>
		/// <returns></returns>
		public CollectionHistory GetEntity(System.Int32 historyID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<CollectionHistory> GetEntityAsync(System.Int32 historyID)
		{
			string strCondition = string.Empty;
			strCondition += " and HistoryID = @HistoryID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual CollectionHistory GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionHistory obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<CollectionHistory> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			CollectionHistory obj = null;
			string strSQL = "select top 1 * from CollectionHistory where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<CollectionHistory> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<CollectionHistory> list = new List<CollectionHistory>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<CollectionHistory>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<CollectionHistory> list = new List<CollectionHistory>();
			string strSQL = "select * from CollectionHistory where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<CollectionHistory> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionHistory> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionHistory> list = new List<CollectionHistory>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistory> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<CollectionHistory> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<CollectionHistory> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<CollectionHistory> list = new List<CollectionHistory>();
		...
		private static void GetParameters(CollectionHistory entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static CollectionHistory GetEntityFromrdr(NullableDataReader rdr)
		{
			CollectionHistory info = new CollectionHistory();
