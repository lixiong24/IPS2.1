...
namespace JX.ADO
{
	...
	public partial class StatWeburlRepositoryADO : IStatWeburlRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatWeburl entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeburl entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeburl entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeburl entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeburl entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeburl entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeburl entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeburl entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeburl SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatWeburl GetEntity(System.String tWeburl)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeburl> GetEntityAsync(System.String tWeburl)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeburl = @TWeburl";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeburl GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeburl obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeburl> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeburl obj = null;
			string strSQL = "select top 1 * from StatWeburl where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeburl> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatWeburl> list = new List<StatWeburl>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeburl>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatWeburl> list = new List<StatWeburl>();
			string strSQL = "select * from StatWeburl where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatWeburl> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatWeburl> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatWeburl> list = new List<StatWeburl>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburl> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeburl> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatWeburl> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatWeburl> list = new List<StatWeburl>();
		...
		private static void GetParameters(StatWeburl entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatWeburl GetEntityFromrdr(NullableDataReader rdr)
		{
			StatWeburl info = new StatWeburl();
