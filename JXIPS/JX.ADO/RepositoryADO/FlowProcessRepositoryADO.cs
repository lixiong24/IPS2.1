...
namespace JX.ADO
{
	...
	public partial class FlowProcessRepositoryADO : IFlowProcessRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(FlowProcess entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(FlowProcess entity)
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(FlowProcess entity)
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(FlowProcess entity)
		{
			if(entity.ProcessID <= 0) entity.ProcessID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(FlowProcess entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(FlowProcess entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(FlowProcess entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(FlowProcess entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update FlowProcess SET "+
		...
		/// </summary>
		/// <returns></returns>
		public FlowProcess GetEntity(System.Int32 processID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<FlowProcess> GetEntityAsync(System.Int32 processID)
		{
			string strCondition = string.Empty;
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual FlowProcess GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			FlowProcess obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<FlowProcess> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			FlowProcess obj = null;
			string strSQL = "select top 1 * from FlowProcess where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<FlowProcess> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<FlowProcess> list = new List<FlowProcess>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<FlowProcess>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<FlowProcess> list = new List<FlowProcess>();
			string strSQL = "select * from FlowProcess where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<FlowProcess> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<FlowProcess> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<FlowProcess> list = new List<FlowProcess>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<FlowProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<FlowProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<FlowProcess> list = new List<FlowProcess>();
		...
		private static void GetParameters(FlowProcess entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static FlowProcess GetEntityFromrdr(NullableDataReader rdr)
		{
			FlowProcess info = new FlowProcess();
