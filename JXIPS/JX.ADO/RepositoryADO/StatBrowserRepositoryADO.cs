...
namespace JX.ADO
{
	...
	public partial class StatBrowserRepositoryADO : IStatBrowserRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatBrowser entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatBrowser entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatBrowser entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatBrowser entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatBrowser entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatBrowser entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatBrowser entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatBrowser entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatBrowser SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatBrowser GetEntity(System.String tBrowser)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatBrowser> GetEntityAsync(System.String tBrowser)
		{
			string strCondition = string.Empty;
			strCondition += " and TBrowser = @TBrowser";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatBrowser GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatBrowser obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatBrowser> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatBrowser obj = null;
			string strSQL = "select top 1 * from StatBrowser where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatBrowser> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatBrowser> list = new List<StatBrowser>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatBrowser>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatBrowser> list = new List<StatBrowser>();
			string strSQL = "select * from StatBrowser where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatBrowser> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatBrowser> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatBrowser> list = new List<StatBrowser>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowser> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatBrowser> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatBrowser> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatBrowser> list = new List<StatBrowser>();
		...
		private static void GetParameters(StatBrowser entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatBrowser GetEntityFromrdr(NullableDataReader rdr)
		{
			StatBrowser info = new StatBrowser();
