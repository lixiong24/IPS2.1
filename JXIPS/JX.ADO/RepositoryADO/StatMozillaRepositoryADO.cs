...
namespace JX.ADO
{
	...
	public partial class StatMozillaRepositoryADO : IStatMozillaRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatMozilla entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatMozilla entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatMozilla entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatMozilla entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatMozilla entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatMozilla entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatMozilla entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatMozilla entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatMozilla SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatMozilla GetEntity(System.String tMozilla)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatMozilla> GetEntityAsync(System.String tMozilla)
		{
			string strCondition = string.Empty;
			strCondition += " and TMozilla = @TMozilla";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatMozilla GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatMozilla obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatMozilla> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatMozilla obj = null;
			string strSQL = "select top 1 * from StatMozilla where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatMozilla> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatMozilla> list = new List<StatMozilla>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatMozilla>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatMozilla> list = new List<StatMozilla>();
			string strSQL = "select * from StatMozilla where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatMozilla> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatMozilla> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatMozilla> list = new List<StatMozilla>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozilla> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatMozilla> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatMozilla> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatMozilla> list = new List<StatMozilla>();
		...
		private static void GetParameters(StatMozilla entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatMozilla GetEntityFromrdr(NullableDataReader rdr)
		{
			StatMozilla info = new StatMozilla();
