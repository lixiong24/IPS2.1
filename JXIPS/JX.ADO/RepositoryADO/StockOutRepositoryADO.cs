...
namespace JX.ADO
{
	...
	public partial class StockOutRepositoryADO : IStockOutRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StockOut entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StockOut entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StockOut entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StockOut entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StockOut entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StockOut entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StockOut entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StockOut entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StockOut SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StockOut GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StockOut> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StockOut GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StockOut obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StockOut> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StockOut obj = null;
			string strSQL = "select top 1 * from StockOut where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StockOut> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StockOut> list = new List<StockOut>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StockOut>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StockOut> list = new List<StockOut>();
			string strSQL = "select * from StockOut where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StockOut> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StockOut> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StockOut> list = new List<StockOut>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOut> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StockOut> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StockOut> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StockOut> list = new List<StockOut>();
		...
		private static void GetParameters(StockOut entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StockOut GetEntityFromrdr(NullableDataReader rdr)
		{
			StockOut info = new StockOut();
