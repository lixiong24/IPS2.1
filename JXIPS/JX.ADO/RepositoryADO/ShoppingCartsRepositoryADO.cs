...
namespace JX.ADO
{
	...
	public partial class ShoppingCartsRepositoryADO : IShoppingCartsRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ShoppingCarts entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ShoppingCarts entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ShoppingCarts entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ShoppingCarts entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ShoppingCarts entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ShoppingCarts entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ShoppingCarts entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ShoppingCarts entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ShoppingCarts SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ShoppingCarts GetEntity(System.Int32 cartItemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ShoppingCarts> GetEntityAsync(System.Int32 cartItemID)
		{
			string strCondition = string.Empty;
			strCondition += " and CartItemID = @CartItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ShoppingCarts GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ShoppingCarts obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ShoppingCarts> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ShoppingCarts obj = null;
			string strSQL = "select top 1 * from ShoppingCarts where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ShoppingCarts> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ShoppingCarts> list = new List<ShoppingCarts>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ShoppingCarts>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ShoppingCarts> list = new List<ShoppingCarts>();
			string strSQL = "select * from ShoppingCarts where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ShoppingCarts> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ShoppingCarts> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ShoppingCarts> list = new List<ShoppingCarts>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCarts> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ShoppingCarts> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ShoppingCarts> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ShoppingCarts> list = new List<ShoppingCarts>();
		...
		private static void GetParameters(ShoppingCarts entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ShoppingCarts GetEntityFromrdr(NullableDataReader rdr)
		{
			ShoppingCarts info = new ShoppingCarts();
