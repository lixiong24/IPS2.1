...
namespace JX.ADO
{
	...
	public partial class ClientLogRepositoryADO : IClientLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ClientLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ClientLog entity)
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ClientLog entity)
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ClientLog entity)
		{
			if(entity.ClientLogID <= 0) entity.ClientLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ClientLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ClientLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ClientLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ClientLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ClientLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ClientLog GetEntity(System.Int32 clientLogID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ClientLog> GetEntityAsync(System.Int32 clientLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and ClientLogID = @ClientLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ClientLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ClientLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ClientLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ClientLog obj = null;
			string strSQL = "select top 1 * from ClientLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ClientLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ClientLog> list = new List<ClientLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ClientLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ClientLog> list = new List<ClientLog>();
			string strSQL = "select * from ClientLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ClientLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ClientLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ClientLog> list = new List<ClientLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ClientLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ClientLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ClientLog> list = new List<ClientLog>();
		...
		private static void GetParameters(ClientLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ClientLog GetEntityFromrdr(NullableDataReader rdr)
		{
			ClientLog info = new ClientLog();
