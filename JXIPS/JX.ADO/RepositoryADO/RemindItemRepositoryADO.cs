...
namespace JX.ADO
{
	...
	public partial class RemindItemRepositoryADO : IRemindItemRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RemindItem entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RemindItem entity)
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RemindItem entity)
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RemindItem entity)
		{
			if(entity.RemindID <= 0) entity.RemindID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RemindItem entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RemindItem entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RemindItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RemindItem entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RemindItem SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RemindItem GetEntity(System.Int32 remindID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RemindItem> GetEntityAsync(System.Int32 remindID)
		{
			string strCondition = string.Empty;
			strCondition += " and RemindID = @RemindID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RemindItem GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RemindItem obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RemindItem> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RemindItem obj = null;
			string strSQL = "select top 1 * from RemindItem where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RemindItem> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RemindItem> list = new List<RemindItem>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RemindItem>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RemindItem> list = new List<RemindItem>();
			string strSQL = "select * from RemindItem where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RemindItem> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RemindItem> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RemindItem> list = new List<RemindItem>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RemindItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RemindItem> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RemindItem> list = new List<RemindItem>();
		...
		private static void GetParameters(RemindItem entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RemindItem GetEntityFromrdr(NullableDataReader rdr)
		{
			RemindItem info = new RemindItem();
