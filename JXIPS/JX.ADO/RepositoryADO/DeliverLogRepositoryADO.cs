...
namespace JX.ADO
{
	...
	public partial class DeliverLogRepositoryADO : IDeliverLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(DeliverLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(DeliverLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(DeliverLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(DeliverLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(DeliverLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(DeliverLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(DeliverLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(DeliverLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update DeliverLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public DeliverLog GetEntity(System.Int32 deliverID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<DeliverLog> GetEntityAsync(System.Int32 deliverID)
		{
			string strCondition = string.Empty;
			strCondition += " and DeliverID = @DeliverID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual DeliverLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<DeliverLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			DeliverLog obj = null;
			string strSQL = "select top 1 * from DeliverLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<DeliverLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<DeliverLog> list = new List<DeliverLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<DeliverLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<DeliverLog> list = new List<DeliverLog>();
			string strSQL = "select * from DeliverLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<DeliverLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DeliverLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DeliverLog> list = new List<DeliverLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<DeliverLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<DeliverLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<DeliverLog> list = new List<DeliverLog>();
		...
		private static void GetParameters(DeliverLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static DeliverLog GetEntityFromrdr(NullableDataReader rdr)
		{
			DeliverLog info = new DeliverLog();
