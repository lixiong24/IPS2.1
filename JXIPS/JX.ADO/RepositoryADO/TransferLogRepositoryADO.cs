...
namespace JX.ADO
{
	...
	public partial class TransferLogRepositoryADO : ITransferLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(TransferLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(TransferLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(TransferLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(TransferLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(TransferLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(TransferLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(TransferLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(TransferLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update TransferLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public TransferLog GetEntity(System.Int32 transferLogID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<TransferLog> GetEntityAsync(System.Int32 transferLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and TransferLogID = @TransferLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual TransferLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			TransferLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<TransferLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			TransferLog obj = null;
			string strSQL = "select top 1 * from TransferLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<TransferLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<TransferLog> list = new List<TransferLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<TransferLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<TransferLog> list = new List<TransferLog>();
			string strSQL = "select * from TransferLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<TransferLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<TransferLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<TransferLog> list = new List<TransferLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<TransferLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<TransferLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<TransferLog> list = new List<TransferLog>();
		...
		private static void GetParameters(TransferLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static TransferLog GetEntityFromrdr(NullableDataReader rdr)
		{
			TransferLog info = new TransferLog();
