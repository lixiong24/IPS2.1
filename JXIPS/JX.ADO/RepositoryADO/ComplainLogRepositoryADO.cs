...
namespace JX.ADO
{
	...
	public partial class ComplainLogRepositoryADO : IComplainLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(ComplainLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(ComplainLog entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(ComplainLog entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(ComplainLog entity)
		{
			if(entity.ItemID <= 0) entity.ItemID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(ComplainLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(ComplainLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(ComplainLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(ComplainLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update ComplainLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public ComplainLog GetEntity(System.Int32 itemID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<ComplainLog> GetEntityAsync(System.Int32 itemID)
		{
			string strCondition = string.Empty;
			strCondition += " and ItemID = @ItemID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual ComplainLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplainLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<ComplainLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			ComplainLog obj = null;
			string strSQL = "select top 1 * from ComplainLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<ComplainLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<ComplainLog> list = new List<ComplainLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<ComplainLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<ComplainLog> list = new List<ComplainLog>();
			string strSQL = "select * from ComplainLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<ComplainLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplainLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplainLog> list = new List<ComplainLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplainLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<ComplainLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<ComplainLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<ComplainLog> list = new List<ComplainLog>();
		...
		private static void GetParameters(ComplainLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static ComplainLog GetEntityFromrdr(NullableDataReader rdr)
		{
			ComplainLog info = new ComplainLog();
