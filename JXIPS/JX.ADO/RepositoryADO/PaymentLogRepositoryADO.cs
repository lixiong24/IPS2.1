...
namespace JX.ADO
{
	...
	public partial class PaymentLogRepositoryADO : IPaymentLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(PaymentLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(PaymentLog entity)
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(PaymentLog entity)
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(PaymentLog entity)
		{
			if(entity.PaymentLogID <= 0) entity.PaymentLogID=GetNewID();			
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity,dict);
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(PaymentLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(PaymentLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(PaymentLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(PaymentLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update PaymentLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public PaymentLog GetEntity(System.Int32 paymentLogID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<PaymentLog> GetEntityAsync(System.Int32 paymentLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and PaymentLogID = @PaymentLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual PaymentLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			PaymentLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<PaymentLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			PaymentLog obj = null;
			string strSQL = "select top 1 * from PaymentLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<PaymentLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<PaymentLog> list = new List<PaymentLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<PaymentLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<PaymentLog> list = new List<PaymentLog>();
			string strSQL = "select * from PaymentLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<PaymentLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PaymentLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PaymentLog> list = new List<PaymentLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<PaymentLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<PaymentLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<PaymentLog> list = new List<PaymentLog>();
		...
		private static void GetParameters(PaymentLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static PaymentLog GetEntityFromrdr(NullableDataReader rdr)
		{
			PaymentLog info = new PaymentLog();
