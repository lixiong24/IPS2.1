...
namespace JX.ADO
{
	...
	public partial class StatReferRepositoryADO : IStatReferRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatRefer entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatRefer entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatRefer entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatRefer entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatRefer entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatRefer entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatRefer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatRefer entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatRefer SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatRefer GetEntity(System.String tRefer)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatRefer> GetEntityAsync(System.String tRefer)
		{
			string strCondition = string.Empty;
			strCondition += " and TRefer = @TRefer";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatRefer GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatRefer obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatRefer> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatRefer obj = null;
			string strSQL = "select top 1 * from StatRefer where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatRefer> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatRefer> list = new List<StatRefer>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatRefer>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatRefer> list = new List<StatRefer>();
			string strSQL = "select * from StatRefer where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatRefer> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatRefer> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatRefer> list = new List<StatRefer>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatRefer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatRefer> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatRefer> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatRefer> list = new List<StatRefer>();
		...
		private static void GetParameters(StatRefer entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatRefer GetEntityFromrdr(NullableDataReader rdr)
		{
			StatRefer info = new StatRefer();
