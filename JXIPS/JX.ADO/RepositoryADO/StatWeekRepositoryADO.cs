...
namespace JX.ADO
{
	...
	public partial class StatWeekRepositoryADO : IStatWeekRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(StatWeek entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(StatWeek entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(StatWeek entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(StatWeek entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(StatWeek entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(StatWeek entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(StatWeek entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(StatWeek entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update StatWeek SET "+
		...
		/// </summary>
		/// <returns></returns>
		public StatWeek GetEntity(System.String tWeek)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<StatWeek> GetEntityAsync(System.String tWeek)
		{
			string strCondition = string.Empty;
			strCondition += " and TWeek = @TWeek";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual StatWeek GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeek obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<StatWeek> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			StatWeek obj = null;
			string strSQL = "select top 1 * from StatWeek where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<StatWeek> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<StatWeek> list = new List<StatWeek>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<StatWeek>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<StatWeek> list = new List<StatWeek>();
			string strSQL = "select * from StatWeek where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<StatWeek> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatWeek> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatWeek> list = new List<StatWeek>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeek> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<StatWeek> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<StatWeek> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<StatWeek> list = new List<StatWeek>();
		...
		private static void GetParameters(StatWeek entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static StatWeek GetEntityFromrdr(NullableDataReader rdr)
		{
			StatWeek info = new StatWeek();
