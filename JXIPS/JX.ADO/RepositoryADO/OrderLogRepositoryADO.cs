...
namespace JX.ADO
{
	...
	public partial class OrderLogRepositoryADO : IOrderLogRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(OrderLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderLog entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderLog entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderLog entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderLog entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderLog entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update OrderLog SET "+
		...
		/// </summary>
		/// <returns></returns>
		public OrderLog GetEntity(System.Int32 orderLogID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderLog> GetEntityAsync(System.Int32 orderLogID)
		{
			string strCondition = string.Empty;
			strCondition += " and OrderLogID = @OrderLogID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderLog GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderLog obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderLog> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderLog obj = null;
			string strSQL = "select top 1 * from OrderLog where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderLog> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<OrderLog> list = new List<OrderLog>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderLog>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<OrderLog> list = new List<OrderLog>();
			string strSQL = "select * from OrderLog where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<OrderLog> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<OrderLog> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<OrderLog> list = new List<OrderLog>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<OrderLog> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<OrderLog> list = new List<OrderLog>();
		...
		private static void GetParameters(OrderLog entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static OrderLog GetEntityFromrdr(NullableDataReader rdr)
		{
