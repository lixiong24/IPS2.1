...
namespace JX.ADO
{
	...
	public partial class RolesProcessRepositoryADO : IRolesProcessRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(RolesProcess entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(RolesProcess entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(RolesProcess entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(RolesProcess entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(RolesProcess entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(RolesProcess entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(RolesProcess entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(RolesProcess entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update RolesProcess SET "+
		...
		/// </summary>
		/// <returns></returns>
		public RolesProcess GetEntity(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<RolesProcess> GetEntityAsync(System.Int32 flowID, System.Int32 processID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and FlowID = @FlowID";
			strCondition += " and ProcessID = @ProcessID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual RolesProcess GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesProcess obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<RolesProcess> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			RolesProcess obj = null;
			string strSQL = "select top 1 * from RolesProcess where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<RolesProcess> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<RolesProcess> list = new List<RolesProcess>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<RolesProcess>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<RolesProcess> list = new List<RolesProcess>();
			string strSQL = "select * from RolesProcess where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<RolesProcess> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RolesProcess> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RolesProcess> list = new List<RolesProcess>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<RolesProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<RolesProcess> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<RolesProcess> list = new List<RolesProcess>();
		...
		private static void GetParameters(RolesProcess entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static RolesProcess GetEntityFromrdr(NullableDataReader rdr)
		{
			RolesProcess info = new RolesProcess();
