...
namespace JX.ADO
{
	...
	public partial class AdminRolesRepositoryADO : IAdminRolesRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(AdminRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(AdminRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(AdminRoles entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(AdminRoles entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(AdminRoles entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(AdminRoles entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(AdminRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(AdminRoles entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update AdminRoles SET "+
		...
		/// </summary>
		/// <returns></returns>
		public AdminRoles GetEntity(System.Int32 adminID, System.Int32 roleID)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<AdminRoles> GetEntityAsync(System.Int32 adminID, System.Int32 roleID)
		{
			string strCondition = string.Empty;
			strCondition += " and AdminID = @AdminID";
			strCondition += " and RoleID = @RoleID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual AdminRoles GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			AdminRoles obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<AdminRoles> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			AdminRoles obj = null;
			string strSQL = "select top 1 * from AdminRoles where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<AdminRoles> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<AdminRoles> list = new List<AdminRoles>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<AdminRoles>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<AdminRoles> list = new List<AdminRoles>();
			string strSQL = "select * from AdminRoles where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<AdminRoles> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdminRoles> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdminRoles> list = new List<AdminRoles>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<AdminRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<AdminRoles> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<AdminRoles> list = new List<AdminRoles>();
		...
		private static void GetParameters(AdminRoles entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static AdminRoles GetEntityFromrdr(NullableDataReader rdr)
		{
			AdminRoles info = new AdminRoles();
