...
namespace JX.ADO
{
	...
	public partial class OrderFeedbackRepositoryADO : IOrderFeedbackRepositoryADO
	{
		...
		/// <returns></returns>
		public virtual bool Add(OrderFeedback entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> AddAsync(OrderFeedback entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual int Insert(OrderFeedback entity)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<int> InsertAsync(OrderFeedback entity)
		{
		...
		/// <returns></returns>
		public virtual bool AddOrUpdate(OrderFeedback entity, bool IsSave)
		{
		...
		/// <param name="IsSave">是否增加</param>
		/// <returns></returns>
		public virtual async Task<bool> AddOrUpdateAsync(OrderFeedback entity, bool IsSave)
		{
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual bool Update(OrderFeedback entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
		...
		/// <param name="entity">实体模型</param>
		/// <returns></returns>
		public virtual async Task<bool> UpdateAsync(OrderFeedback entity)
		{
			Dictionary<string, object> dict = new Dictionary<string, object>();
			GetParameters(entity, dict);
			string strSQL = "Update OrderFeedback SET "+
		...
		/// </summary>
		/// <returns></returns>
		public OrderFeedback GetEntity(System.Int32 id)
		{
		...
		/// </summary>
		/// <returns></returns>
		public async Task<OrderFeedback> GetEntityAsync(System.Int32 id)
		{
			string strCondition = string.Empty;
			strCondition += " and ID = @ID";
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual OrderFeedback GetEntity(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderFeedback obj = null;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<OrderFeedback> GetEntityAsync(string strWhere, Dictionary<string, object> dict = null)
		{
			OrderFeedback obj = null;
			string strSQL = "select top 1 * from OrderFeedback where 1=1 " + strWhere;
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual IList<OrderFeedback> GetEntityList(string strWhere="", Dictionary<string, object> dict = null)
		{
			IList<OrderFeedback> list = new List<OrderFeedback>();
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		public virtual async Task<IList<OrderFeedback>> GetEntityListAsync(string strWhere = "", Dictionary<string, object> dict = null)
		{
			IList<OrderFeedback> list = new List<OrderFeedback>();
			string strSQL = "select * from OrderFeedback where 1=1 ";
			if (!string.IsNullOrEmpty(strWhere))
		...
		/// <returns></returns>
		public IList<OrderFeedback> GetList(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<OrderFeedback> GetList(int startRowIndexId, int maxNumberRows, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<OrderFeedback> list = new List<OrderFeedback>();
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderFeedback> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public IList<OrderFeedback> GetListBySortColumn(int startRowIndexId, int maxNumberRows,string Sorts,string Filter, out int Total)
		{
			Total = 0;
		...
		/// <param name="Total">输出参数：查询总数</param>
		/// <returns></returns>
		public virtual IList<OrderFeedback> GetListBySortColumn(int startRowIndexId, int maxNumberRows, string PrimaryColumn, string SortColumnDbType, string SortColumn, string StrColumn, string Sorts, string Filter, string TableName, out int Total)
		{
			IList<OrderFeedback> list = new List<OrderFeedback>();
		...
		private static void GetParameters(OrderFeedback entity, Dictionary<string, object> dict)
		{
		...
		/// <returns></returns>
		private static OrderFeedback GetEntityFromrdr(NullableDataReader rdr)
		{
			OrderFeedback info = new OrderFeedback();
