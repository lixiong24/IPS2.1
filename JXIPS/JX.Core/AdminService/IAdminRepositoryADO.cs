...
namespace JX.Core
{
	...
	/// 数据库表：Admin 的仓储接口.
	/// </summary>
	public partial interface IAdminRepositoryADO : IRepositoryADO<Admin>
	{
		#region 是否存在
		/// <summary>
		/// 检查用户名是否存在
		...
		/// <returns></returns>
		Task<Admin> GetEntityByAdminNameAsync(string adminName);
		/// <summary>
		/// 通过用户名和密码返回第一条信息的实体类。
		/// </summary>
		/// <param name="adminName">用户名</param>
		...
		/// <returns></returns>
		Task<Admin> GetEntityAsync(string adminName, string adminPassword);
		#endregion
		...
		/// </summary>
		/// <returns></returns>
		Admin GetEntityFull(System.Int32 adminID);
		/// <summary>
		/// 通过主键返回第一条信息的实体类，包括扩展属性。
		/// </summary>
		/// <returns></returns>
		Task<Admin> GetEntityFullAsync(System.Int32 adminID);
		/// <summary>
		/// 获取实体，包括扩展属性
		/// </summary>
		...
		/// <returns></returns>
		Admin GetEntityFull(string strWhere, Dictionary<string, object> dict = null);
		/// <summary>
		/// 获取实体，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="strWhere">参数化查询条件(例如: and Name = @Name )</param>
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		Task<Admin> GetEntityFullAsync(string strWhere, Dictionary<string, object> dict = null);
		/// <summary>
		/// 为实体添加RoleIDs和RoleNames两个属性的值
		/// </summary>
		/// <param name="admin"></param>
		/// <returns></returns>
		Admin GetAdminFull(Admin admin);
		#endregion
		...
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		IList<Admin> GetEntityFullList(string strWhere = "", Dictionary<string, object> dict = null);
		/// <summary>
		/// 得到实体列表，包括扩展属性（异步方式）
		/// </summary>
		/// <param name="strWhere">参数化查询条件(例如: and Name = @Name )</param>
		/// <param name="dict">参数的名/值集合</param>
		/// <returns></returns>
		Task<IList<Admin>> GetEntityFullListAsync(string strWhere = "", Dictionary<string, object> dict = null);
		#endregion
