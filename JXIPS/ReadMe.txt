...
JX.Core											框架核心层，所有的接口、抽象类都放在这一层
	...
	NodesService									网站栏目相关服务类接口扩展文件夹
	AdminService									网站后台管理员相关服务类接口扩展文件夹
	UserService										网站前台会员相关服务类接口扩展文件夹

...
JX.Application									应用层，各个模块按文件夹分开
	DTOs											DTO对象，主要通过代码生成器生成
	JXMapper										Enity与Dto映射，主要通过代码生成器生成
	IServiceApp										应用层服务通用接口
	IServicesApp									应用层服务接口文件夹，主要通过代码生成器生成
	ServicesApp										应用层服务接口实现的文件夹，主要通过代码生成器生成
	IServiceAppADO									应用层服务通用接口(基于ADO.NET)
	IServicesAppADO									应用层服务接口文件夹，主要通过代码生成器生成(基于ADO.NET)
	ServicesAppADO									应用层服务接口实现的文件夹，主要通过代码生成器生成(基于ADO.NET)
...
JwtIssuer										Jwt发布者
JwtAudience										Jwt订阅者
参考：http://www.cnblogs.com/JacZhu/p/6837676.html， http://www.cnblogs.com/hzzxq/p/7373287.html

